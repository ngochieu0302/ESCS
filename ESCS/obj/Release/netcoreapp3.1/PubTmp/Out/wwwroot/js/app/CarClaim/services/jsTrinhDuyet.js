function TrinhDuyetService() {
    ...
    this.luuTrinhDuyet = function (obj) {
        return _service.postData("/carclaim/carinvestigation/luutrinhduyet", obj);
    }

    // xóa trình duyệt
    this.xoaTrinhDuyet = function (obj) {
        return _service.postData("/carclaim/carinvestigation/xoatrinhduyet", obj);
    }

    // liệt kê lịch sử trình duyệt
    this.lietKeTrinhDuyet = function (obj) {
        return _service.postData("/carclaim/carinvestigation/lietketrinhduyet", obj);
    }

    // lấy danh sách người duyệt 
    this.layDanhSachNguoiDuyet = function (obj) {
        return _service.postData("/carclaim/carinvestigation/laydanhsachnguoiduyet", obj);
    }
}
