#pragma checksum "D:\ESCS\ESCS\Areas\CarClaim\Views\CarCompensation\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "59e743f540d69e23acc201a8d87bd097497f4e39"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"59e743f540d69e23acc201a8d87bd097497f4e39", @"/Areas/CarClaim/Views/CarCompensation/_Template.cshtml")]
        ...
        <div class=""border rounded"">
            ...
            <table class=""table"">
                <tbody>
                    ...
                    <tr>
                        <td");
            WriteLiteral(@" style=""width:105px; color:#999999"">Số hợp đồng</td>
                        <td><%- ho_so.so_hd %></td>
                    </tr>
                        ...
                        <td style=""width:auto"">
                            ...
                            <span class=""float-right"">
                                <a href=""#"" onclick=""chonKhachHangVip(this)"">
                                    <%");
            BeginWriteAttribute("if(ho_so.nhom_kh_vip", " if(ho_so.nhom_kh_vip =", 3996, "", 4019, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
...
");
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 18212, "", 18216, 0);
            EndWriteAttribute();
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 19392, "", 19395, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 19403, "\"", 19417, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 19949, "", 19952, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 19960, "\"", 19976, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 20535, "", 20539, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 21235, "", 21238, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 21246, "\"", 21262, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 22239, "", 22242, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 22250, "\"", 22264, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 22796, "", 22799, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 22807, "\"", 22823, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 23376, "", 23380, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 24022, "", 24025, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 24033, "\"", 24049, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showDiaChi(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("!", " !=", 25085, "", 25088, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 25096, "\"", 25110, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 25642, "", 25645, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 25653, "\"", 25669, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 26221, "", 26225, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 26837, "", 26840, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 26848, "\"", 26864, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showDiaChi(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td class=""text-right"">
            ...
            BeginWriteAttribute("!", " !=", 27996, "", 27999, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 28007, "\"", 28021, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 28553, "", 28556, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 28564, "\"", 28580, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 29132, "", 29136, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 29758, "", 29761, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 29769, "\"", 29785, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showDiaChi(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td class=""text-right"">
            <%- ESUtil.");
            WriteLiteral("formatMoney(item.tien_tt) %>\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 30917, "", 30920, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 30928, "\"", 30942, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 31474, "", 31477, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 31485, "\"", 31501, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 32053, "", 32057, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
            ...
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 33564, "", 33581, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            ...
            BeginWriteAttribute("for", " for=\"", 33875, "\"", 33881, 0);
            EndWriteAttribute();
            WriteLiteral(@">&nbsp;</label>
            </div>
            <% }else{ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                ...
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 34191, "\"", 34197, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% } %>\r\n        </td>\r\n        <td style=\"text-align: center\">\r\n            <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 34339, "\'", 34344, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 34358, "", 34361, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n            <%- item.loai_ten %>\r\n            <% }else{ %>\r\n            Chưa bổ sung\r\n            <% } %>\r\n        </td>\r\n        <td style=\"text-align: center\">\r\n            <%");
            BeginWriteAttribute("if(item.gara_thu_ho", " if(item.gara_thu_ho =", 34550, "", 34572, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <div class=""custom-control custom-checkbox custom-control-inline"" style=""margin:unset;"">
                ...
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 34866, "\"", 34872, 0);
            EndWriteAttribute();
            WriteLiteral(@">&nbsp;</label>
            </div>
            <% }else{ %>
            <div class=""custom-control custom-checkbox custom-control-inline"" style=""margin:unset;"">
                ...
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 35182, "\"", 35188, 0);
            EndWriteAttribute();
            WriteLiteral(@">&nbsp;</label>
            </div>
            <% } %>
...
");
    ...
    <tr class=""hmChiTietItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten) %>"">
        ...
        <td>
            ...
            <%if(item.dgrr");
            BeginWriteAttribute("!", " !=", 37225, "", 37228, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.dgrr");
            BeginWriteAttribute("!", " !=", 37251, "", 37254, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dgrr");
            BeginWriteAttribute("!", " != \"", 37272, "\"", 37277, 0);
            EndWriteAttribute();
            WriteLiteral(" &&");
            BeginWriteAttribute("item.dgrr", " item.dgrr =", 37281, "", 37293, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""C""){%>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 38177, "", 38180, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " != \"", 38201, "\"", 38206, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 38717, "", 38732, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 39008, "", 39012, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""tblPhuongAnHANGHOATemplate"">
    ...
    <tr>
        ...
        <td class=""text-right"" style=""color:blue""><%- ESUtil.formatMoney(item.gia");
            ...
            BeginWriteAttribute("!", " !=", 40218, "", 40221, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 40759, "", 40774, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
...
");
            ...
            BeginWriteAttribute("!", " !=", 42401, "", 42404, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 42942, "", 42957, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
    ...
    <% if(pa_khac_phuc.length < 10){
    for(var");
            BeginWriteAttribute("i", " i =", 43234, "", 43238, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 10 - pa_khac_phuc.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 43389, "\"", 43397, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""tblPhuongAnTNDSNguoiTemplate"">
    ...
    <tr>
        ...
        <td cl");
            ...
            BeginWriteAttribute("!", " !=", 44570, "", 44573, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 45111, "", 45126, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
    ...
    <% if(pa_khac_phuc.length < 10){
    for(var");
            BeginWriteAttribute("i", " i =", 45403, "", 45407, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 10 - pa_khac_phuc.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 45558, "\"", 45566, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""tblPhuongAnTNDSTaiSanTemplate"">
    ...
    <tr>
        ...
        <td c");
            ...
            BeginWriteAttribute("!", " !=", 46740, "", 46743, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 47281, "", 47296, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
    ...
    <% if(pa_khac_phuc.length < 10){
    for(var");
            BeginWriteAttribute("i", " i =", 47573, "", 47577, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 10 - pa_khac_phuc.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 47728, "\"", 47736, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
    ...
    <tr data-ma-gara=""<%- bao_gia.gara %>"" data-so-id-doi-tuong=""<%- bao_gia.so_id_doi_tuong %>"" data-bt-gara=""<%- bao_gia.bt_gara %>"">
        ...
        <td class=""text-center"" style=""width:60px"">
            <%");
            BeginWriteAttribute("if(bao_gia.trang_thai", " if(bao_gia.trang_thai =", 50493, "", 50517, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 51230, "", 51234, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""gara_bg_ctiet"" data-search=""<%- ESUtil.xoaKhoangTrangText(bao_gia.ten_hang_muc) %>"">
        ...
        <%}else");
            BeginWriteAttribute("if(bao_gia.loai_hang_muc", " if(bao_gia.loai_hang_muc =", 54179, "", 54206, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""B""){%>
        <td>
            <input type=""hidden"" name=""loai_hang_muc"" value=""<%- bao_gia.loai_hang_muc %>"" />
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.thay_the_sc", " if(bao_gia.thay_the_sc=", 56938, "", 56962, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T"") {%>
        ...
        <td class=""text-center"">
            <% if(bao_gia.ghi_chu");
            BeginWriteAttribute("!", " !=", 59983, "", 59986, 0);
            EndWriteAttribute();
            WriteLiteral(" null && bao_gia.ghi_chu");
            BeginWriteAttribute("!", " != \"", 60010, "\"", 60015, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 60585, "", 60589, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td class=""text-center"">
           ...
           ");
            ...
            BeginWriteAttribute("i", " i =", 62966, "", 62970, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - chung_tu.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 63116, "\"", 63124, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
 ...
 ");
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 64909, "", 64913, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - thu_huong.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 65060, "\"", 65068, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""step4_tam_ung_template"">
    ...
    <tr onclick=""xemCtietTamUng('<%- item.so_id_tu %>')"">
        ...
        <td class=""text-center""><%- item.trang_tha");
            ...
            BeginWriteAttribute("i", " i =", 66177, "", 66181, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 4 - tam_ung.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 66326, "\"", 66334, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
        ...
        <td style=""text-align:center"">
            ...
            BeginWriteAttribute("!", " != \'", 67477, "\'", 67482, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.so_id_doi_tuong");
            BeginWriteAttribute("!", " !=", 67507, "", 67510, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 68444, "", 68462, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" disabled=""disabled"" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 68763, "\"", 68769, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% }else{ %>\r\n            <%");
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 68847, "", 68864, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"hop_le_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 69067, "\"", 69075, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 69446, "\"", 69454, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label"" for=""hop_le_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 69736, "", 69754, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            ...
            <a href=""#"" data-field=""loai"" data-val=""<%- item.loai %>"" onclick=""chonLoaiHSGT(this)"" id=""loai_hsgt_<%- item.ma_hs %>"">
                <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 70087, "\'", 70092, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 70106, "", 70109, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n                <%- item.loai_ten %>\r\n                <% }else{ %>\r\n                Chọn loại hồ sơ\r\n                <% } %>\r\n            </a>\r\n            <% } %>\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 70311, "", 70332, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""C"")
        {
        if(item.chon==1)
     ...
     ");
            ...
            BeginWriteAttribute("if(item.gara_thu_ho", " if(item.gara_thu_ho =", 72611, "", 72633, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"gara_thu_ho_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 72841, "\"", 72849, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 73235, "\"", 73243, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_gara_thu_ho"">
                <label class=""custom-control-label"" for=""gara_thu_ho_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            ...
            BeginWriteAttribute("required", " required=\"", 73596, "\"", 73607, 0);
            EndWriteAttribute();
...
");
    ...
    <tr>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("if(item.kq_nsd", " if(item.kq_nsd =", 74320, "", 74337, 0);
            EndWriteAttribute();
...
");
    ...
    <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 79631, "", 79646, 0);
            EndWriteAttribute();
    ...
    <div class=""pt-1"" id=""nhom_anh_<%- index %>"">
        <p class=""m-0 font-weight-bold"">
            ...
            BeginWriteAttribute("item.ten_doi_tuong!", " item.ten_doi_tuong!=\'", 79947, "\'", 79969, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
<script type=""text/html"" id=""templateItemViewImage"">
    <%");
            BeginWriteAttribute("if(data_info!", " if(data_info!=", 84317, "", 84332, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""modalThemTNDS_template"">
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten""");
            BeginWriteAttribute("required", " required=\"", 87563, "\"", 87574, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\"");
            BeginWriteAttribute("required", " required=\"", 87667, "\"", 87678, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number sl\"");
            BeginWriteAttribute("required", " required=\"", 87776, "\"", 87787, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <select class=\"select2 form-control custom-select tinh_trang\"");
            BeginWriteAttribute("required", " required=\"", 87895, "\"", 87906, 0);
            EndWriteAttribute();
            WriteLiteral(" style=\"width:100%;height:36px;\">\r\n                <option value=\"HONG\" selected=\"selected\">Hỏng</option>\r\n            </select>\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\"");
            BeginWriteAttribute("required", " required=\"", 88137, "\"", 88148, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien\"");
            BeginWriteAttribute("required", " required=\"", 88248, "\"", 88259, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
        <td>
...
<script type=""text/html"" id=""modalThemTNDSNguoi_template"">
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten""");
            BeginWriteAttribute("required", " required=\"", 88790, "\"", 88801, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- item.ten %>\" />\r\n            <input type=\"hidden\" class=\"floating-input number sl\"");
            BeginWriteAttribute("required", " required=\"", 88896, "\"", 88907, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.sl) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\"");
            BeginWriteAttribute("required", " required=\"", 89043, "\"", 89054, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- item.dchi %>\" />\r\n        </td>\r\n        <td>\r\n            <select class=\"select2 form-control custom-select tinh_trang\"");
            BeginWriteAttribute("required", " required=\"", 89187, "\"", 89198, 0);
            EndWriteAttribute();
            WriteLiteral(" style=\"width:100%;height:36px;\">\r\n                <option");
            BeginWriteAttribute("value", " value=\"", 89257, "\"", 89265, 0);
            EndWriteAttribute();
            WriteLiteral(">Chọn tình trạng</option>\r\n                <option value=\"CHET\" <%");
            BeginWriteAttribute("if(item.tinh_trang", " if(item.tinh_trang =", 89332, "", 89353, 0);
            EndWriteAttribute();
            WriteLiteral("=\'CHET\'){ %>selected=\"selected\"<% } %>>Chết</option>\r\n                <option value=\"THUONG\" <%");
            BeginWriteAttribute("if(item.tinh_trang", " if(item.tinh_trang =", 89448, "", 89469, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 90710, "\"", 90721, 0);
            EndWriteAttribute();
            BeginWriteAttribute("value", " value=\"", 90722, "\"", 90730, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\"");
            BeginWriteAttribute("required", " required=\"", 90836, "\"", 90847, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tthat) %>\" />\r\n        </td>\r\n\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien\"");
            BeginWriteAttribute("required", " required=\"", 91000, "\"", 91011, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- ESUtil.formatMoney(item.tien) %>"" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten""");
            BeginWriteAttribute("required", " required=\"", 91467, "\"", 91478, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" class=\"floating-input number sl\"");
            BeginWriteAttribute("required", " required=\"", 91549, "\"", 91560, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"1\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\"");
            BeginWriteAttribute("required", " required=\"", 91663, "\"", 91674, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n\r\n        <td>\r\n            <select class=\"select2 form-control custom-select tinh_trang\"");
            BeginWriteAttribute("required", " required=\"", 91784, "\"", 91795, 0);
            EndWriteAttribute();
            WriteLiteral(" style=\"width:100%;height:36px;\">\r\n                <option");
            BeginWriteAttribute("value", " value=\"", 91854, "\"", 91862, 0);
            EndWriteAttribute();
            WriteLiteral(@">Chọn tình trạng</option>
        ...
        <td>
            <input type=""text"" class=""floating-input number pttt""");
            BeginWriteAttribute("required", " required=\"", 92280, "\"", 92291, 0);
            EndWriteAttribute();
            BeginWriteAttribute("value", " value=\"", 92292, "\"", 92300, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\"");
            BeginWriteAttribute("required", " required=\"", 92406, "\"", 92417, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien\"");
            BeginWriteAttribute("required", " required=\"", 92519, "\"", 92530, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
        <td>
...
<script type=""text/html"" id=""tableThuHoiVatTu_template"">
    ...
    <% if(thu_hoi.length < 3){
    for(var");
            BeginWriteAttribute("i", " i =", 94011, "", 94015, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - thu_hoi.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 94160, "\"", 94168, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""tableDanhSachThuDoiNTBA_template"">
    ...
    <% if(ntba.length < 3){
    for(var");
            BeginWriteAttribute("i", " i =", 95563, "", 95567, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - ntba.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 95709, "\"", 95717, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""modalBaoGiaGara_lan_ct_template"">
    ...
    <tr class=""cursor-point");
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.thay_the_sc_gara", " if(item.thay_the_sc_gara =", 97006, "", 97033, 0);
            EndWriteAttribute();
            WriteLiteral("=\"T\"){%>\r\n            <span>Thay thế</span>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.thay_the_sc_gara", " if(item.thay_the_sc_gara =", 97111, "", 97138, 0);
            EndWriteAttribute();
            WriteLiteral("=\"S\"){%>\r\n            <span>Sửa chữa</span>\r\n            <%}%>\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <%");
            BeginWriteAttribute("if(item.chinh_hang_gara", " if(item.chinh_hang_gara =", 97265, "", 97291, 0);
            EndWriteAttribute();
            WriteLiteral("=\"C\"){%>\r\n            <i class=\"fas fa-check mr-2\" style=\"color:#28c690\"></i>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.chinh_hang_gara", " if(item.chinh_hang_gara =", 97403, "", 97429, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""K""){%>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 104567, "", 104570, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 104578, "\"", 104592, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 105124, "", 105127, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 105135, "\"", 105151, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 105703, "", 105707, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td cla");
            ...
            BeginWriteAttribute("!", " !=", 112396, "", 112399, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item_dt.mo_ta!", " item_dt.mo_ta!=\"", 112407, "\"", 112424, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item_dt.ghi_chu");
            BeginWriteAttribute("!", " !=", 112962, "", 112965, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item_dt.ghi_chu!", " item_dt.ghi_chu!=\"", 112973, "\"", 112992, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 116896, "", 116899, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 116907, "\"", 116921, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 117453, "", 117456, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 117464, "\"", 117480, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 118034, "", 118038, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 119725, "", 119749, 0);
            EndWriteAttribute();
        ...
        <td class=""text-ce");
            WriteLiteral("nter\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 120809, "", 120812, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 120820, "\"", 120834, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 121366, "", 121369, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 121377, "\"", 121393, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 121945, "", 121949, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 123565, "", 123589, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" data-field=""thuong_tat"" class=""thuong_tat combobox"">Chưa xác định</a>
        ...
        <td class=""tex");
            ...
            BeginWriteAttribute("!", " !=", 124653, "", 124656, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 124664, "\"", 124678, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 125210, "", 125213, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 125221, "\"", 125237, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 125789, "", 125793, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            ...
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 127377, "", 127401, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" data-field=""thuong_tat"" class=""thuong_tat combobox"">Chưa xác định</a>
        ...
        <td class=""tex");
            WriteLiteral("t-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 128465, "", 128468, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 128476, "\"", 128490, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 129022, "", 129025, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 129033, "\"", 129049, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 129601, "", 129605, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
        ...
        <td>
            ...
            <%if(tinh_toan.");
            WriteLiteral("dgrr");
            BeginWriteAttribute("!", " !=", 132994, "", 132997, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && tinh_toan.dgrr");
            BeginWriteAttribute("!", " !=", 133025, "", 133028, 0);
            EndWriteAttribute();
            WriteLiteral(" null && tinh_toan.dgrr");
            BeginWriteAttribute("!", " != \"", 133051, "\"", 133056, 0);
            EndWriteAttribute();
            WriteLiteral(" &&");
            BeginWriteAttribute("tinh_toan.dgrr", " tinh_toan.dgrr =", 133060, "", 133077, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""C""){%>
...
");
            ...
            BeginWriteAttribute("!", " !=", 135703, "", 135706, 0);
            EndWriteAttribute();
            WriteLiteral(" null && tinh_toan.nguyen_nhan");
            BeginWriteAttribute("!", " != \"", 135736, "\"", 135741, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("!", " !=", 136325, "", 136328, 0);
            EndWriteAttribute();
            WriteLiteral(" null && tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " != \"", 136354, "\"", 136359, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 136921, "", 136925, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""tblTinhToanHANGHOAItem"">
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("!", " !=", 139786, "", 139789, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 140382, "", 140385, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 141058, "", 141062, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""tblTinhToanNNTXItem"">
      ...
      ");
        ...
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 144041, "", 144070, 0);
            EndWriteAttribute();
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 145673, "", 145676, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 146269, "", 146272, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 146944, "", 146948, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
        ...
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 149876, "", 149905, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || tinh_toan.ds_thuong_tat == null || tinh_toan.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- tinh_toan.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- tinh_toan.bt %>', '<%- tinh_toan.vu_tt %>', '<%- tinh_toan.lh_nv %>', '<%- tinh_toan.hang_muc %>', '<%- tinh_toan.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 151508, "", 151511, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 152104, "", 152107, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 152779, "", 152783, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""tblTinhToanTNDS_NGUOIItem"">
        ...
        <td><%- tinh_toan.ten %></td>
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 155710, "", 155739, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || tinh_toan.ds_thuong_tat == null || tinh_toan.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- tinh_toan.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- tinh_toan.bt %>', '<%- tinh_toan.vu_tt %>', '<%- tinh_toan.lh_nv %>', '<%- tinh_toan.hang_muc %>', '<%- tinh_toan.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 157340, "", 157343, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 157936, "", 157939, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 158611, "", 158615, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""tblTinhToanTNDS_NGUOI_HKItem"">
        ...
        <td><%- tinh_toan.ten %></td>
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 161553, "", 161582, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || tinh_toan.ds_thuong_tat == null || tinh_toan.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- tinh_toan.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- tinh_toan.bt %>', '<%- tinh_toan.vu_tt %>', '<%- tinh_toan.lh_nv %>', '<%- tinh_toan.hang_muc %>', '<%- tinh_toan.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 163183, "", 163186, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 163779, "", 163782, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 164454, "", 164458, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 167224, "", 167227, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 167820, "", 167823, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 168495, "", 168499, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
<script type=""text/html"" id=""danhSachNV_template"">
    ...
    <tr class=""row-item"" row-val=""<%- item.ma %>"" row-vcx=""<%- item.vcx %>"">
        ...
        <td class=""text-right""><%- ESUtil.formatMoney(item.tien) %><");
            WriteLiteral("/td>\r\n        <%");
            BeginWriteAttribute("if(item.vcx", " if(item.vcx =", 170933, "", 170947, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VCX'){ %>
        <%if(item.ktru==""K""){%>
...
");
            ...
            BeginWriteAttribute("i", " i =", 175093, "", 175097, 0);
            EndWriteAttribute();
    ...
    <tr class=""tblKhauTruItem"">
        ...
        <td class=""text-center"">
            <% if(item.dkbs");
            BeginWriteAttribute("!", " !=", 176186, "", 176189, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 176754, "", 176758, 0);
            EndWriteAttribute();
...
");
            WriteLiteral("    </tr>\r\n    <% })}%>\r\n    <% if(danh_sach.length < 8){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 180110, "", 180114, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 8 - danh_sach.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:38.2px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n");
            WriteLiteral(@"    </tr>
    <% }} %>
...
<script type=""text/html"" id=""titleCarCompensat");
            ...
            BeginWriteAttribute("if(ho_so.so_hs!", " if(ho_so.so_hs!=", 183432, "", 183449, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("ho_so.so_hs.trim()!", " ho_so.so_hs.trim()!= \"", 183457, "\"", 183480, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
");
  ...
  ");
    ...
    <% if(data.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 189039, "", 189043, 0);
            EndWriteAttribute();
...
");
    ...
    <div class=""table-responsive"" style=""height: 355px;"">
        <table class=""table table-bordered fixed-header"">
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh VCXXE"">
                ...
                <%");
            BeginWriteAttribute("if(vcx.lh_tt_giam_gia", " if(vcx.lh_tt_giam_gia =", 190447, "", 190471, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T""){%>
   ...
   ");
            ...
            BeginWriteAttribute("if(vcx.lh_tt_giam_gia", " if(vcx.lh_tt_giam_gia =", 192747, "", 192771, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""S""){%>
...
");
            ...
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh TNDSTAI_SAN"">
                ...
                <%");
            BeginWriteAttribute("if(item.lh_tt_giam_gia", " if(item.lh_tt_giam_gia =", 199175, "", 199200, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T""){%>
                <tr class=""tblPhuongAnCTGiamGia_T"">
                    <td class=""text-center"">1</td>
         ...
         ");
            ...
            BeginWriteAttribute("if(item.lh_tt_giam_gia", " if(item.lh_tt_giam_gia =", 201419, "", 201444, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""S""){%>
                <tr class=""tblPhuongAnCTGiamGia_S"">
                    <td class=""text-center"">1</td>
