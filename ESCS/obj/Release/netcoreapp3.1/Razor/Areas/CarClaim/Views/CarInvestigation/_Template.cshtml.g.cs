#pragma checksum "D:\ESCS\ESCS\Areas\CarClaim\Views\CarInvestigation\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "73d89e2582051245c4553e912e6888bb3a5b6a9e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_CarClaim_Views_CarInvestigation__Template), @"mvc.1.0.view", @"/Areas/CarClaim/Views/CarInvestigation/_Template.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"73d89e2582051245c4553e912e6888bb3a5b6a9e", @"/Areas/CarClaim/Views/CarInvestigation/_Template.cshtml")]
    public class Areas_CarClaim_Views_CarInvestigation__Template : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
<script type=""text/html"" id=""modalCarSearchDsGCNTemplate"">
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 66819, "", 66823, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""danh_gia_hien_truong_template"">
    ...
    <%");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 67232, "", 67247, 0);
            EndWriteAttribute();
            WriteLiteral("= \'RADIO\'){ %>\r\n    <div class=\"col-6 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 67341, "", 67365, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <label class=\"_required\"><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 67554, "", 67570, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
            ...
            <% } else { %>
            <label");
            BeginWriteAttribute("class", " class=\"", 68116, "\"", 68124, 0);
            EndWriteAttribute();
            WriteLiteral("><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 68268, "", 68284, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
                <div class=""form-check form-check-inline ml-3"" style=""margin-right:unset"">
    ...
    <% }else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 68836, "", 68851, 0);
            EndWriteAttribute();
            WriteLiteral("= \'CHECKBOX\'){ %>\r\n    <div class=\"col-6 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 68948, "", 68972, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <label class=\"_required\"><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 69161, "", 69177, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 69714, "\"", 69722, 0);
            EndWriteAttribute();
            WriteLiteral("><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 69866, "", 69882, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
                <div class=""custom-control custom-checkbox ml-3"">
    ...
    <% }else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 70427, "", 70442, 0);
            EndWriteAttribute();
            WriteLiteral("= \'TEXTAREA\'){ %>\r\n    <%");
            BeginWriteAttribute("if(item.kieu_loai", " if(item.kieu_loai =", 70467, "", 70487, 0);
            EndWriteAttribute();
            WriteLiteral("= \'col4\'){ %>\r\n    <div class=\"col-4 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 70580, "", 70604, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
    ...
    <% } else");
            BeginWriteAttribute("if(item.kieu_loai", " if(item.kieu_loai =", 71303, "", 71323, 0);
            EndWriteAttribute();
            WriteLiteral("= \'col12\'){ %>\r\n    <div class=\"col-12 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 71418, "", 71442, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
    ...
    <% } %>
    <% } else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 72154, "", 72169, 0);
            EndWriteAttribute();
            WriteLiteral("= \'TEXT\'){ %>\r\n    <div class=\"col-4 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 72262, "", 72286, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 72643, "\"", 72651, 0);
            EndWriteAttribute();
            WriteLiteral(@"><%- item.ten_loai %></label>
            <div class=""input-group"">
    ...
    <% } else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 72972, "", 72987, 0);
            EndWriteAttribute();
            WriteLiteral("= \'NUMBER\'){ %>\r\n    <%");
            BeginWriteAttribute("if(item.an_hien", " if(item.an_hien =", 73010, "", 73028, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n    <div class=\"col-12 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 73117, "", 73141, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 73505, "\"", 73513, 0);
            EndWriteAttribute();
            WriteLiteral(@"><%- item.ten_loai %></label>
            <div class=""input-group"">
...
<script type=""text/html"" id=""danhSachNV_template"">
    ...
    _.forEach(lhnv, function(item,index) { %>");
            ...
            BeginWriteAttribute("if(item.vcx", " if(item.vcx =", 75813, "", 75827, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VCX'){ %>
        <%if(item.ktru==""K""){%>
...
<script type=""text/html"" id=""dsDoiTuongTTTemplate"">
    ...
    <tr class=""item_so_id_doi_tuong"" data-so-id-doi-tuong=""<%- item.so_id_doi_tuong %>""");
        ...
        <td class=""text-cente");
            WriteLiteral("r\">\r\n            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 79551, "", 79554, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " !=\'", 79575, "\'", 79579, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <% if(data.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 80378, "", 80382, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""titleUpdateContractTemplate"">
   ");
            WriteLiteral(" <%");
            BeginWriteAttribute("if(ho_so.so_hs!", " if(ho_so.so_hs!=", 81409, "", 81426, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("ho_so.so_hs.trim()!", " ho_so.so_hs.trim()!= \"", 81434, "\"", 81457, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
");
    ...
    <tr data-ma-gara=""<%- bao_gia.gara %>"" data-so-id-doi-tuong=""<%- bao_gia.so_id_doi_tuong %>"" data-bt-gara=""<%- bao_gia.bt_gara %>"">
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.so_id_pa", " if(bao_gia.so_id_pa =", 87396, "", 87418, 0);
            EndWriteAttribute();
            ...
            <%}else");
            BeginWriteAttribute("if(bao_gia.chon_pa_trinh", " if(bao_gia.chon_pa_trinh =", 88078, "", 88105, 0);
            EndWriteAttribute();
        ...
        <td class=""text-center"" style=""width:60px"">
            <%");
            BeginWriteAttribute("if(bao_gia.trang_thai", " if(bao_gia.trang_thai =", 90963, "", 90987, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 91700, "", 91704, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""garaBaoGiaCT_template"">
    ...
    <tr class=""gara_bg_ctiet"" data-search=""<%- ESUtil.xoaKhoangTrangText(bao_gia.ten_hang_muc) %>"">
        ...
        <%}else");
            BeginWriteAttribute("if(bao_gia.loai_hang_muc", " if(bao_gia.loai_hang_muc =", 94767, "", 94794, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""B""){%>
        <td>
            <input type=""hidden"" name=""loai_hang_muc"" value=""<%- bao_gia.loai_hang_muc %>"" />
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.thay_the_sc", " if(bao_gia.thay_the_sc=", 97494, "", 97518, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T"") {%>
        ...
        <td class=""text-center"">
            <% if(bao_gia.ghi_chu");
            BeginWriteAttribute("!", " !=", 100539, "", 100542, 0);
            EndWriteAttribute();
            WriteLiteral(" null && bao_gia.ghi_chu");
            BeginWriteAttribute("!", " != \"", 100566, "\"", 100571, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
