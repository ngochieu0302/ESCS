#pragma checksum "D:\ESCS\ESCS\Areas\CarClaim\Views\_CarClaimCompareData.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8f961e4e4a28bef48c6d4098fde5c3d10fbff8ce"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_CarClaim_Views__CarClaimCompareData), @"mvc.1.0.view", @"/Areas/CarClaim/Views/_CarClaimCompareData.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8f961e4e4a28bef48c6d4098fde5c3d10fbff8ce", @"/Areas/CarClaim/Views/_CarClaimCompareData.cshtml")]
    public class Areas_CarClaim_Views__CarClaimCompareData : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
<div class=""custom-modal"">
    <div id=""modalCarClaimCompareData"" class=""modal fade"" tabindex=""-1"" data-backdrop=""false"" data-keyboard=""false"" role=""dialog"" aria-hidden=""true"" style=""z-index: 1600;width:900px;top: 2%; left: 22%;"">
        <div class=""modal-dialog "" style=""width:100%;max-width:unset"">
                ...
                <div class=""modal-body"">
                    <div class=""row"">
                        <div class=""col col-12"">
                            <labe");
            WriteLiteral(@"l class=""font-weight-bold my-2 op-8"">THÔNG TIN ĐĂNG KÝ XE - OCR</label>
                        </div>
            ...
            WriteLiteral(@">
                        ...
                        <div class=""col col-12 table-responsive"" style=""max-height:300px"">
                      ");
            WriteLiteral("      <label class=\"font-weight-bold my-2 op-8\">THÔNG TIN ĐĂNG KIỂM - OCR</label>\r\n                            <table class=\"table table-so-sanh\"");
            BeginWriteAttribute("id", " id=\"", 2802, "\"", 2807, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                <thead>
                                    <tr class=""text-center"">
...
<div class=""custom-modal"">
   ...
   ");
            ...
            BeginWriteAttribute("id", " id=\"", 6035, "\"", 6040, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                    <thead>
                                        <tr class=""text-center"">
...
<script type=""text/html"" id=""modalCarClaimCompareDataTable_Template"">
 ...
 ");
        ...
        <tr>
            ...
            <td>
                <% if(ESUtil.compareText(data.gcn.bien_xe_tmp");
            WriteLiteral(@", data.ocr_dang_ky!=null? data.ocr_dang_ky.bien_xe_tmp:''))
                {
                %>
                <i class=""fas fa-check text-success""></i>
                <%
...
<script type=""text/html"" id=""modalCarClaimCompareData_GPLX_Template"">
    <%");
            BeginWriteAttribute("if(ocr_bang_lai!", " if(ocr_bang_lai!=", 17123, "", 17141, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td class=""text-center""><%");
            BeginWriteAttribute("if(item.han_su_dung", " if(item.han_su_dung =", 17630, "", 17652, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""modalCarClaimCompareData_DANGKIEM_Template"">
    <%");
            BeginWriteAttribute("if(ocr_dang_kiem!", " if(ocr_dang_kiem!=", 18127, "", 18146, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td class=""text-center""><%");
            BeginWriteAttribute("if(ocr_dang_kiem.han_su_dung", " if(ocr_dang_kiem.han_su_dung =", 18443, "", 18474, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1) { %> <i class=""fas fa-check text-success""></i> <%} else { %><i class=""fas fa-times text-danger""></i> <%}%></td>
...
<script type=""text/html"" id=""modalCarClaimCompareDataGPLX_SoSanh_Template"">
    <%");
            BeginWriteAttribute("if(data!", " if(data!=", 18962, "", 18972, 0);
            EndWriteAttribute();
...
");
            ...
            BeginWriteAttribute("if(data!", " if(data!=", 20230, "", 20240, 0);
            EndWriteAttribute();
            WriteLiteral(@"=undefined && data!==null && data.length > 0){
    _.forEach(data, function(item,index) {
    %>
