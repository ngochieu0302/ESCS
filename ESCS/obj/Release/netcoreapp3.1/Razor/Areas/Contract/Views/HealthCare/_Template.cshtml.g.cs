#pragma checksum "D:\ESCS\ESCS\Areas\Contract\Views\HealthCare\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "36f093d69ef578294c60da208c183372bf9a983c"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"36f093d69ef578294c60da208c183372bf9a983c", @"/Areas/Contract/Views/HealthCare/_Template.cshtml")]
...
<script type=""text/html"" id=""DongTai_template"">
  ...
  ");
            WriteLiteral("      </td>\r\n        <td class=\"text-center\">\r\n            <%- item.tl_tai_cd %>%\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <%- item.tl_tai_tt %>%\r\n        </td>\r\n    </tr>\r\n    <% })} %>\r\n\r\n    <% if(dk.length < 6){ %>\r\n    <% for(var");
            BeginWriteAttribute("i", " i =", 9232, "", 9236, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""SDBS_template"">
    <% var");
            BeginWriteAttribute("stt", " stt =", 9568, "", 9574, 0);
            EndWriteAttribute();
            WriteLiteral(@" 1 %>
    <% if(dk.length > 0){
    _.forEach(dk, function(item,index) { %>
...
<script type=""text/html"" id=""tblTongPhiTPA_template"">
    ...
    <% if(data.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 10926, "", 10930, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""lstImage_template"">
    ...
    <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 13675, "", 13690, 0);
            EndWriteAttribute();
...
<script type=""text/h");
            WriteLiteral(@"tml"" id=""modalGoiBHDanhSachTemplate"">
    ...
    <tr class=""dkbs"">
     ...
     ");
        ...
        <td class=""text-center"">");
            ...
            BeginWriteAttribute("i", " i =", 21784, "", 21788, 0);
            EndWriteAttribute();
