#pragma checksum "D:\ESCS\ESCS\Areas\Admin\Views\CarConfiguration\_ModalCHPheDuyetGiaTuDong.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8d74b082091a242444534b6e8129f6e35b37511f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_CarConfiguration__ModalCHPheDuyetGiaTuDong), @"mvc.1.0.view", @"/Areas/Admin/Views/CarConfiguration/_ModalCHPheDuyetGiaTuDong.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8d74b082091a242444534b6e8129f6e35b37511f", @"/Areas/Admin/Views/CarConfiguration/_ModalCHPheDuyetGiaTuDong.cshtml")]
    public class Areas_Admin_Views_CarConfiguration__ModalCHPheDuyetGiaTuDong : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
<div id=""modalCHPheDuyetGiaTuDong"" class=""modal fade"" data-backdrop=""static"" data-keyboard=""false"" tabindex=""-1"" role=""dialog"">
    <div class=""modal-dialog modal-lg"" style=""max-width:95%"">
        <div class=""modal-content"">
            <div clas");
            WriteLiteral(@"s=""modal-header py-1"">
            ...
            <div class=""modal-body"" style=""background-color:#54667a0a; padding:0px"">
                <div class=""row p-2"">
                    ...
                    <div class=""col-10"">
                        <div class=""row p-2"" style=""padding-top:0px !impor");
            WriteLiteral(@"tant"">
                            <div class=""col-12"" style=""padding-left:0px;"">
                                <div class=""d-flex justify-content-between"" style=""background-color:#f8f9fa"">
                                    <ul class=""nav nav-pills font-weight-bold"" role=""tablist"" id=""modalCHPheDuyetGiaTuDongTabList"">
                                        ...
                                        <li class=""nav-item"" style=""cursor:pointer"">
                                            <a class=""nav-link"" data-toggle=""tab"" role=""tab"" id=""tabCHHangMuc");
            WriteLiteral(@"MucDoGiaMenu"" onclick=""hienThiTabCHDuyetGia('tabCHHangMucMucDoGia')"" aria-controls=""profile"" aria-selected=""false"">
                 ...
                 ");
            WriteLiteral(@"                       <div style=""margin-top:15px; margin-bottom:15px;"" id=""modalCHPheDuyetGiaTuDongDviAD"">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            WriteLiteral(@"                </div>
                        ...
                        <div class=""row p-2 tabCHHangMucMucDoGia"" style=""padding-top:0px !important"">
                            <div class=""col-12 pl-0"" style=""margin-bottom:0");
            WriteLiteral(@".5rem;"">
                                <div class=""btn-group float-left tabCHHangMucMucDoGia_Nhap"">
                                    <a class=""btn btn-light rounded py-0"" onclick=""onClickCHDGChonHangHieuXe(this)"" data-toggle=""dropdown"" data-display=""static"" aria-haspopup=""true"" aria-expanded=""false"">
                                        <span style=""font-size:13px; color:#009efb""><i class=""fas fa-filter""></i> Bộ chọn hãng/hiệu xe</span>
                                    </a>
                                    <input type=""hidden"" id=""chdg_arr_hang_xe""");
            BeginWriteAttribute("value", " value=\"", 6717, "\"", 6725, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n                                    <input type=\"hidden\" id=\"chdg_arr_hieu_xe\"");
            ...
            WriteLiteral(@" />
                                ...
                                <div class=""btn-group float-left tabCHHangMucMucDoGia_Nhap"">
                                    <a class=""btn btn-light rounded py-0"" onclick=""onClickCHDGChonMDTT(this)"" data-toggle=""dropdown"" data-display=""static"" aria-haspopup=""true"" aria-expanded=""false"">
                                        <span style=""font-size:13px; color:#009efb""><i class=""fas fa-filter""></i> Bộ chọn mức độ tổn thất</span>
                                    </a>
                                    <input type=""hidden"" id=""chdg_arr_muc_do_tt""");
            ...
            WriteLiteral(@" />
                                ...
                                <div class=""btn-group float-left tabCHHangMucMucDoGia_Nhap"">
                                    <a class=""btn btn-light rounded py-0"" onclick=""onClickCHDGChonHangMuc(this)"" data-toggle=""dropdown"" data-display=""static"" aria-haspopup=""true"" aria-expanded=""false"">
                                        <span style=""font-size:13px; color:#009efb""><i class=""fas fa-filter""></i> Bộ chọn hạng mục xe</span>
                                    </a>
                                    <input type=""hidden"" id=""chdg_arr_hang_muc""");
            BeginWriteAttribute("value", " value=\"", 8039, "\"", 8047, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
                                </div>
            ...
            WriteLiteral(@"                           <tr class=""text-center uppercase"">
                                                    ...
                                                    <tr class=""text-center uppercase"">
                                                        <th style=""");
            WriteLiteral(@"width:100px"">Tiền thay thế</th>
                        ...
                        <div class=""row p-2 tabCHSoTienToiDa""");
            WriteLiteral(@" style=""padding-top:0px !important""></div>
                    </div>
                </div>
...
<div id=""modalCHPheDuyetGiaTuDongNhapNgayAD"" class=""modal fade"" data-backdrop=""static"" data-keyboard=""false"" tabindex=""-1"" role=""dialog"">
   ...
   ");
            WriteLiteral(@"                                     <span class=""input-group-text"" style=""padding: 0.1em 0.8em !important;""><span class=""ti-calendar""></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div id=""modalCHPheDuyetGiaChonHangHieuXe"" class=""modal-drag"" style=""width:300px; z-index:9999999;"">
    <div");
            WriteLiteral(@" class=""modal-drag-header border-bottom"">
...
<div id=""modalCHPheDuyetGiaChonMDTT"" class=""modal-drag"" style=""width:300px; z-index:9999999;"">
    ...
    <div class=""modal-drag-footer"" style=""border-top: 1px solid #e9ecef;"">
        <button type=""button"" class=""btn btn-primary btn-sm wd-90 float-right mb-");
            WriteLiteral(@"1"" id=""modalCHPheDuyetGiaChonMDTT_Chon"">
            <i class=""fas fa-mouse-pointer mr-2""></i> Chọn
        </button>
    </div>
</div>
...
<div id=""modalHangMucTonThat"" class=""modal-drag"" style=""width: 550px; z-index: 9999999; margin-top: -100px; margin-left: 200px;"">
    ...
    <div class=""modal-drag-content"" style=""padding-top:5px;"">
        <div class=""row"">
            ...
            BeginWriteAttribute("value", " value=\"", 17069, "\"", 17077, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
...
<script type=""text/html"" id=""modalC");
            WriteLiteral(@"HPheDuyetGiaChonMDTTContentTemplate"">
...
<script type=""text/html"" id=""modalCHPheDuyetGiaChonHangHieuXeContentTemplate"">
    ...
    <div class=""custom-control custom-checkbox modalCHPheDuyetGiaChonMDTTContentItem"" data-text="""">
        <input type=""checkbox"" data_hang_xe=""<%- item.hang_xe %>"" data_hieu_xe=""<%- it");
            WriteLiteral(@"em.hieu_xe %>"" id=""chdg_hang_hieu_xe_<%- item.hang_xe+'_'+item.hieu_xe %>"" value=""<%- item.hang_xe+'/'+item.hieu_xe %>"" class=""custom-control-input modalCHPheDuyetGiaChonHangHieuXeContentChon"">
...
<script type=""text/html"" id=""dsHangMucTemplate"">
    ...
    ");
            WriteLiteral(@"    <label class=""custom-control-label cursor-pointer"" for=""hang_muc_<%- item.ma %>""><%- item.ten %></label>
    </div>
    <% })}else{ %>
    <div class=""text-center"" style=""width:100%"">Chưa có dữ liệu</div>
    <% } %>
...
<script type=""text/html"" id=""modalCHPheDuyetGiaTuDongDviADTemplate"">
    ...
    <div>
        <div class=""width-dvi"">
            <div class=""custom-control custom-checkbox"">
                <input type=""checkbox"" onchange=""chonTatCaDviCHDuyetGia(this)"" id=""modalCHPheDuyetGiaTuDongDviADTatCa"" class=""custom-contro");
    ...
    <div class=""modalCHPheDuyetGiaTuDongDviADItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_tat) %>"">
        <div class=""width-dvi"">
            <div class=""custom-control custom-checkbox"">
                <%");
            BeginWriteAttribute("if(item.checked", " if(item.checked =", 21734, "", 21752, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){%>
...
<script type=""text/html"" id=""modalCHPheDuyetGiaTuDongGaraADTemplate"">
    ...
    <div class=""modalCHPheDuyetGiaTuDongGaraItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten) %>"">
        <div class=""custom-control custom-checkbox"">
            <");
            WriteLiteral("%");
            BeginWriteAttribute("if(item.checked", " if(item.checked =", 23801, "", 23819, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){%>
...
<script type=""text/html"" id=""modalCHPheDuyetGiaTuDongHangHieuXeADTemplate"">
    ...
    <div style=""height:21px;"">
        <div style=""width:50%; float:left;"">
            <div class=""custom-control custom-checkbox"">
                ...
                <label class=""custom-control-label font-weig");
            WriteLiteral(@"ht-bold"" for=""modalCHPheDuyetGiaTuDongHangHieuXeADTatCa"">Áp dụng cho tất cả</label>
            </div>
        </div>
        <div style=""width:50%; float:left; text-align:right"">
            <div class=""custom-control custom-switch"">
    ...
    <div class=""modalCHPheDuyetGiaTuDongHangHieuXeItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.hang_xe+'/'+item.ma) %>"">
        <div class=""custom-control custom-checkbox"">
            <%");
            BeginWriteAttribute("if(item.checked", " if(item.checked =", 25645, "", 25663, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){%>
...
<script type=""text/html"" id=""tableHangMucGiaTuDongBodyTemplate"">
    ...
    <tr class=""tableHangMucGiaTuDongBodyRow"">
        <td>
            ...
            <input type=""hidden"" data-field=""hang_xe"" value=");
            WriteLiteral(@"""<%- item.hang_xe %>"" />
        ...
        <td>
            <input type=""tex");
            WriteLiteral(@"t"" data-field=""tien_sua_chua_k"" class=""number floating-input"" value=""<%- ESUtil.formatMoney(item.tien_sua_chua_k) %>"">
        </td>
    </tr>
    <% })}else{ %>
    <tr>
