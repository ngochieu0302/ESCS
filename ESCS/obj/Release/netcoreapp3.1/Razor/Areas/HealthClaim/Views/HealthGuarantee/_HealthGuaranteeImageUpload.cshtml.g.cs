#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\HealthGuarantee\_HealthGuaranteeImageUpload.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fc076cb3628094b172057df648d39d33ada25b64"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_HealthClaim_Views_HealthGuarantee__HealthGuaranteeImageUpload), @"mvc.1.0.view", @"/Areas/HealthClaim/Views/HealthGuarantee/_HealthGuaranteeImageUpload.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fc076cb3628094b172057df648d39d33ada25b64", @"/Areas/HealthClaim/Views/HealthGuarantee/_HealthGuaranteeImageUpload.cshtml")]
    public class Areas_HealthClaim_Views_HealthGuarantee__HealthGuaranteeImageUpload : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    ");
            ...
            <div class=""modal-footer"">
                <button type=""button"" class=""btn btn-primary btn-sm mg-t-22"" id=""btnUploadAllFile"">
                    <i class=""fas fa-cloud-upload-alt mr-2""></i>Tải lên tất cả
                </button>
                <button type=""button"" class=""btn btn-primary btn-sm mg-t-22"" id=""btnUploadAllFileAndClose"">
                    <i class=""fas fa-cloud-upload-alt mr-2""></i>Tải lên tất cả và đóng
                </button>
                <button type=""butto");
            WriteLiteral(@"n"" class=""btn-outline-primary btn-sm wd-90 mg-t-22"" data-dismiss=""modal"" id=""btnCancelUpload"">
                    <i class=""fas fa-window-close mr-2""></i>Hủy
                </button>
            </div>
        </div>
    </div>
...
<div id=""modalEscsUploadFileAttachment"" class=""modal fade"" tabindex=""-1"" data-backdrop=""static"" data-keyboard=""false"" role=""dialog"" aria-hidden=""true"" style=""z-index: 1600;"">
    <div class=""modal-dialog modal-md"">
        <div class=""modal-content"">
            <div class=""modal-header py-1"">
            ...
            <div class=""modal-body"">
                <form id=""frmEmailFileDinhKem"" name=""frmEmailFileDinhKem"" method=""post"">
                    <div class=""row"">
                        <div class=""col-12"">
                            <div class=""dropzone-multi"" id=""uploadFileEsc");
            WriteLiteral(@"sDropzoneAttachment"">
                                <div class=""dropzone-panel mb-lg-0 mb-2"">
                                    <a class=""dropzone-select btn btn-sm btn-primary font-weight-bold text-white"">
                                        <i class=""fa fa-plus""></i> Thêm file đính kèm
                                    </a>
                                </div>
                                <div class=""dropzone-items scrollable"" style=""height:40vh"">
                                    <div class=""dropzone-item"" style=""display:none"">
                               ...
                               ");
            WriteLiteral(@"             <div class=""dropzone-error"" data-dz-errormessage></div>
                                        </div>
                                        <div class=""dropzone-progress"">
                                            <div class=""progress"">
                                                <div class=""progress-bar bg-primary"" role=""progressbar"" aria-valuemin=""0"" aria-valuemax=""100"" aria-valuenow=""0"" data-dz-uploadprogress></div>
    ...
    ");
            WriteLiteral(@"                                        </span>
                            ...
                            <span class=""form-text text-muted"">Kích thước lớn nhất là <span id=""uploadConfigFileSizeAttachment""></span>MB và tải lên tối đa <span id=""uploadConfigFileAttachment""></span> file</span>
                        </div>
                    </div>
                </form>
            </div>
            <div class=""modal-footer"">
                <button type=""button"" class=""btn btn-primary btn-sm mg-t-22"" id=""btnUploadAllFileAttachment"">
                    <i class=""fas fa-cloud-upload-alt mr-2""></i>Tải lên tất cả
                </button>
       ");
            WriteLiteral(@"         <button type=""button"" class=""btn btn-primary btn-sm mg-t-22"" id=""btnUploadAllFileAttachmentAndClose"">
                    <i class=""fas fa-cloud-upload-alt mr-2""></i>Tải lên tất cả và đóng
                </button>
...
<style>
    .dropzone-multi {
        ...
        .dropzone-multi .dropzone-item {
            ...
            .dropzone-multi .dropzone-item .dropzone-file {
                -webkit-box-flex: 1;
                -ms-flex-positive: 1");
            WriteLiteral(@";
                flex-grow: 1;
   ...
   ");
            WriteLiteral("             .dropzone-multi .dropzone-item .dropzone-progress .progress {\r\n                    height: 5px;\r\n                    -webkit-transition: all 0.2s ease-in-out;\r\n                    transition: all 0.2s ease-in-out;\r\n                }\r\n\r\n    ");
