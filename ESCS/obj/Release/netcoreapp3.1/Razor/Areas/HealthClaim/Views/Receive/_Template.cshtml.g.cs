#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\Receive\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "93a1783195fcc1153b77c8bd97ea6f7489803502"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_HealthClaim_Views_Receive__Template), @"mvc.1.0.view", @"/Areas/HealthClaim/Views/Receive/_Template.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"93a1783195fcc1153b77c8bd97ea6f7489803502", @"/Areas/HealthClaim/Views/Receive/_Template.cshtml")]
    public class Areas_HealthClaim_Views_Receive__Template : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <div class=""card-body p-1"">
        <div class=""border mb-2 rounded"">
            ...
            <table class=""table"" id=""HealthGuaranteeCommon"">
                ...
                <tr>
               ");
            WriteLiteral(@"     <td>Gói bảo hiểm</td>
                    <td>
                        <%- ho_so.ten_goi_bh %>
                    </td>
                </tr>
        ...
        <div class=""border mb-2 rounded"">
            ...
            <table class=""table"" id=""HealthGuaranteeCustomer"">
                <tr>
                    ...
                    <td>
                        <%");
            BeginWriteAttribute("if(ho_so.nhom_kh_vip", " if(ho_so.nhom_kh_vip =", 2711, "", 2734, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VIP'){ %>
                        ...
                        <span class=""float-right"">
                            <a href=""#"" onclick=""chonKhachHangVip(this)"">
                                <%");
            BeginWriteAttribute("if(ho_so.nhom_kh_vip", " if(ho_so.nhom_kh_vip =", 3144, "", 3167, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VIP'){ %>
...
");
   ...
   ");
    ...
    ");
            WriteLiteral("    </div>\r\n    </div>\r\n</script>\r\n\r\n");
            WriteLiteral(@"<script type=""text/html"" id=""tabLichSuTonThat_template"">
    <div class=""row mg-t-10"">
            ...
            <div class=""table-responsive"" style=""max-height:173px"">
                ...
                <table class=""table table-bordered fixed-header"">
                    ...
                    <tbody>
                        ...
                        _.forEach(lan_kham, functi");
            WriteLiteral(@"on(item,index) { %>
                        <tr>
                            <td><%- item.so_hs %></td>
        ...
        <div class=""col-12"">
            <div class=");
            WriteLiteral(@"""table-responsive"" style=""max-height:200px"">
                <!-- Chứng từ hóa đơn, thanh toán -->
                <table class=""table table-bordered fixed-header"">
                    <thead class=""font-weight-bold card-title-bg-primary"">
                        <tr class=""text-center uppercase"">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td cla");
            WriteLiteral(@"ss=""text-right""><%- ESUtil.formatMoney(item.tien_nam) %></td>
...
");
    ...
    <% if(data.length < 5){
    for(var");
            BeginWriteAttribute("i", " i =", 15749, "", 15753, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("thu_tu_cha_con", " thu_tu_cha_con =", 16122, "", 16139, 0);
            EndWriteAttribute();
            WriteLiteral(" item.lh_nv.split(\'.\').length - 1 %>\r\n    <%");
            BeginWriteAttribute("if(thu_tu_cha_con", " if(thu_tu_cha_con =", 16183, "", 16203, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
    <tr>
        ...
        <td style=""font-");
            ...
            BeginWriteAttribute("pd", " pd =", 17351, "", 17356, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""dsGhiChuKhac_template"">
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 18974, "", 18978, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""dsDieuKhoanBoSung_template"">
    <% _.forEach(data, function(item,index) { %>
    <% var");
            BeginWriteAttribute("thu_tu_cha_con", " thu_tu_cha_con =", 19245, "", 19262, 0);
            EndWriteAttribute();
            WriteLiteral(" item.lh_nv.split(\'.\').length - 1 %>\r\n    <%");
            BeginWriteAttribute("if(thu_tu_cha_con", " if(thu_tu_cha_con =", 19306, "", 19326, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
    <tr>
        <td class=""text-left"" style=""font-weight: bold"">
    ...
    <% } else{ %>
    <% var");
            BeginWriteAttribute("pd", " pd =", 20020, "", 20025, 0);
            EndWriteAttribute();
            WriteLiteral(@" thu_tu_cha_con * 15 %>
    <tr>
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 20802, "", 20806, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 14 - data.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n");
    ...
    <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 21562, "", 21577, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td style=""text-align: center"">
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 25030, "", 25051, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
                ...
                <% }else");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 25348, "", 25369, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'D'){ %>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 25775, "", 25793, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" disabled=""disabled"" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 26094, "\"", 26100, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% }else{ %>\r\n            <%");
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 26178, "", 26195, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"hop_le_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 26398, "\"", 26406, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 26777, "\"", 26785, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label"" for=""hop_le_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 27067, "", 27085, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            ...
            <a href=""#"" data-field=""loai"" data-val=""<%- item.loai %>"" onclick=""chonLoaiHSGT(this)"" id=""loai_hsgt_<%- item.ma_hs %>"">
                <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 27418, "\'", 27423, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 27437, "", 27440, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n                <%- item.loai_ten %>\r\n                <% }else{ %>\r\n                Chọn loại hồ sơ\r\n                <% } %>\r\n            </a>\r\n            <% } %>\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 27642, "", 27663, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""C"")
        {
        if(item.chon==1)
        ...
        <td style=""text-align: center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 30084, "", 30087, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 30108, "", 30111, 0);
            EndWriteAttribute();
...
");
            ...
            BeginWriteAttribute("if(index", " if(index =", 31491, "", 31502, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
...
");
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 36525, "", 36529, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 2 - thu_huong.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 36676, "\"", 36684, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
    ...
    <tr class=""khoanChiItem"">
        <td>
            ...
            <a href=""#"" onclick=""xemChiTietChiPhi('<%- item.loai_ct %>','<%- item.loai %>', '<%- item.tien_yc %>')"" data-field=""loai_ct"" data-val=""<%- item.loai_ct %>""><%- item.ten_loai_chi_phi %></a>
        </td>
        <td class=""text-center"">
            <%- item.so_luong %>
        </td>
        <td class=""text-right"">
            <input type=""text"" data-field=""so_ct"" autocomplete=""off"" class=""floating-input"" value=""<%- item.so_ct %>"" />
        </td>
        <td class=""text-right"">
            <input type=""text"" data-field=""tien_yc"" autocomplete=""off"" class=""floating-input number"" onchange=""tinhTongChiPhi(this)"" value=""<%- ESUtil.formatMoney(item.tien_yc) %>"" />
        </td>
        <td class=""text-center"">
            <% if");
            WriteLiteral("(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 38118, "", 38121, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 38129, "\"", 38145, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 38865, "", 38869, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 39309, "\"", 39317, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"don_gia\"");
            BeginWriteAttribute("value", " value=\"", 39376, "\"", 39384, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"dvi_tinh\"");
            BeginWriteAttribute("value", " value=\"", 39444, "\"", 39452, 0);
            EndWriteAttribute();
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 40331, "", 40334, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 40361, "", 40364, 0);
            EndWriteAttribute();
        ...
        <td>
            <input type=""text"" class=""floating-input text-center"" data-field=""dvi_tinh"" value=""<%- item.dvi_tinh_ten %>"" />
        </td>
        <td style=""text-align:right"">
   ...
   ");
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 43462, "", 43465, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 43492, "", 43495, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 44715, "", 44719, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - data.length;i++ ){
    %>
    <tr>
...
");
            ...
            BeginWriteAttribute("value", " value=\"", 45181, "\"", 45189, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"don_gia\"");
            BeginWriteAttribute("value", " value=\"", 45248, "\"", 45256, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"dvi_tinh\"");
            BeginWriteAttribute("value", " value=\"", 45316, "\"", 45324, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma"" value=""<%- item.ma %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma_ct"" value=""<%- item.ma_ct %>"" />
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 46016, "", 46019, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 46570, "", 46573, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 46600, "", 46603, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 47822, "", 47826, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - data.length;i++ ){
    %>
    <tr>
...
<script type=""text/html"" id=""modalHealthSearchDsGCNTemplate"">
    <% if(data.length > 0){
    _.forEach(data, function(item,index) { %>
    <tr class=""tkiem_gcn"" data_ma_doi_tac=""<%- item.ma_doi_tac %>"" data_ma_doi_tac_ql=""<%- item.ma_doi_tac_ql %>"" data_ma_chi_nhanh=""<%- item.ma_chi_nhanh_ql %>"" data_so_id_hd_d=""<%- item.so_id_hd_d %>"" data_so_id_hd=""<%- item.so_id_hd %>"" data_so_id_gcn=""<%- item.so_id_dt %>"" data_goi_bh=""<%- item.goi_bh %>"" data_so_hd=""<%- item.so_hd %>"" data_hd_cu=""<%- item.hd_cu %>"" data_ten_ndbh=""<%- item.ten_khach %>"" data_ngay_sinh=""<%- item.ngay_sinh %>"" data_gioi_tinh=""<%- item.gioi_tinh %>"" style=""cursor: pointer"" id=""tkiem_gcn_<%- item.so_id_hd %>_<%- item.so_id_dt %>"" onclick=""onChonGCN('<%- item.so_id_hd %>','<%- item.so_id_dt %>','<%- item.gioi_tinh %>','<%- item.ngay_sinh %>");
            WriteLiteral(@"','<%- item.ngay_hl_text %>', '<%- item.ten.trim() %>')"">
        ...
        <td class=""text-center""><%- item.ten_dvi_cap_don %></td>");
            WriteLiteral("\n    </tr>\r\n    <%})}%>\r\n    <% if(data.length < 5){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 49939, "", 49943, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 5 - data.length;i++ ){ %>
...
");
    ...
    <tr class=""text-center lichSuTonThat"" id=""lichSuTonThat_<%- item.so_id %>_<%- item.lhnv %>"">
        ...
        <td>
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 50658, "", 50673, 0);
            EndWriteAttribute();
            WriteLiteral("= \'HSTT\'){ %>\r\n            <a href=\"#\" onclick=\"TransReceiveDisplay(\'<%- item.ma_doi_tac%>\',\'<%- item.so_id%>\')\"><%- item.so_hs %></a>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 50842, "", 50857, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'BLVP'){ %>
        ...
        <td class=""text-center"">
            <% if(item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 51759, "", 51762, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.nguyen_nhan");
            BeginWriteAttribute("!", " != \'", 51787, "\'", 51792, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 51813, "", 51816, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 52419, "", 52422, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " != \'", 52443, "\'", 52448, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 52465, "", 52468, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 53038, "", 53042, 0);
            EndWriteAttribute();
