#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\HealthGuarantee\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c3c82ade242d5cda788524c85af48b37aa8f2ceb"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c3c82ade242d5cda788524c85af48b37aa8f2ceb", @"/Areas/HealthClaim/Views/HealthGuarantee/_Template.cshtml")]
...
<script type=""text/html"" id=""dsDieuKhoanBoSung_template"">
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 31542, "", 31546, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 14 - data.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n");
    ...
    <tr>
        ...
        <td style=""text-align: center"">
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 32751, "", 32772, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
                ...
                <% }else");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 33069, "", 33090, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'D'){ %>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 33496, "", 33514, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" disabled=""disabled"" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 33815, "\"", 33821, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% }else{ %>\r\n            <%");
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 33899, "", 33916, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"hop_le_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 34119, "\"", 34127, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 34498, "\"", 34506, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label"" for=""hop_le_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 34788, "", 34806, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            ...
            <a href=""#"" data-field=""loai"" data-val=""<%- item.loai %>"" onclick=""chonLoaiHSGT(this)"" id=""loai_hsgt_<%- item.ma_hs %>"">
                <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 35139, "\'", 35144, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 35158, "", 35161, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n                <%- item.loai_ten %>\r\n                <% }else{ %>\r\n                Chọn loại hồ sơ\r\n                <% } %>\r\n            </a>\r\n            <% } %>\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 35363, "", 35384, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""C"")
        {
        if(item.chon==1)
        ...
        <td style=""text-align: center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 37805, "", 37808, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 37829, "", 37832, 0);
            EndWriteAttribute();
...
");
            ...
            BeginWriteAttribute("if(index", " if(index =", 39208, "", 39219, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
...
");
            ...
            BeginWriteAttribute("value", " value=\"", 41266, "\"", 41274, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"don_gia\"");
            BeginWriteAttribute("value", " value=\"", 41333, "\"", 41341, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"dvi_tinh\"");
            BeginWriteAttribute("value", " value=\"", 41401, "\"", 41409, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"ghi_chu\"");
            BeginWriteAttribute("value", " value=\"", 41468, "\"", 41476, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 42288, "", 42291, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 42318, "", 42321, 0);
            EndWriteAttribute();
       ...
       ");
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 45415, "", 45418, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 45445, "", 45448, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 46668, "", 46672, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - data.length;i++ ){
    %>
    <tr>
...
");
            ...
            BeginWriteAttribute("value", " value=\"", 47134, "\"", 47142, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"don_gia\"");
            BeginWriteAttribute("value", " value=\"", 47201, "\"", 47209, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"dvi_tinh\"");
            BeginWriteAttribute("value", " value=\"", 47269, "\"", 47277, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma"" value=""<%- item.ma %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma_ct"" value=""<%- item.ma_ct %>"" />
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 47969, "", 47972, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 48523, "", 48526, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 48553, "", 48556, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 49775, "", 49779, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 7 - data.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n\r\n");
    ...
    <% if(data.length < 5){
    for(var");
            BeginWriteAttribute("i", " i =", 51904, "", 51908, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""text-center lichSuTonThat"" id=""lichSuTonThat_<%- item.so_id %>_<%- item.lhnv %>"">
        ...
        <td>
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 52623, "", 52638, 0);
            EndWriteAttribute();
            WriteLiteral("= \'HSTT\'){ %>\r\n            <a href=\"#\" onclick=\"TransReceiveDisplay(\'<%- item.ma_doi_tac%>\',\'<%- item.so_id%>\')\"><%- item.so_hs %></a>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 52807, "", 52822, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'BLVP'){ %>
        ...
        <td class=""text-center"">
            <% if(item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 53724, "", 53727, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.nguyen_nhan");
            BeginWriteAttribute("!", " != \'", 53752, "\'", 53757, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 53778, "", 53781, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 54384, "", 54387, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " != \'", 54408, "\'", 54413, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 54430, "", 54433, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 55003, "", 55007, 0);
            EndWriteAttribute();
