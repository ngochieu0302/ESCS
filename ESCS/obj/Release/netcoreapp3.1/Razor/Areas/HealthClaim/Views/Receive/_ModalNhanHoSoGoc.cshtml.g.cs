#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\Receive\_ModalNhanHoSoGoc.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4829f8be197382a39c08be1ddfa61e43a6f2c8cd"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4829f8be197382a39c08be1ddfa61e43a6f2c8cd", @"/Areas/HealthClaim/Views/Receive/_ModalNhanHoSoGoc.cshtml")]
...
<div class=""modal fade bs-example-modal-sm"" id=""modalThemLanNhanHSGoc"" tabindex=""-1"" data-backdrop=""static"" data-keyboard=""false"" role=""dialog"" aria-labelledby=""myLargeModalLabel"">
    <div class=""modal-dialog modal-lg"" role=""document"" style=""max-width: 25%;"">
        <div class=""modal-content"">
            ...
            BeginWriteAttribute("required", " required=\"", 6009, "\"", 6020, 0);
            EndWriteAttribute();
...
");
    ...
    <tr style=""cursor: pointer; text-align:center"" data-lan=""<%- item.lan %>"" id=""bt_<%- item.lan %>"" onclick=""getDetailNgayNhanHSGoc('<%- item.lan %>')"" class=""item-ngay-nhan-hs-goc"">
        ...
        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 7841, "", 7862, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'D'){ %>
        <td>
            <span>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 8392, "", 8396, 0);
            EndWriteAttribute();
