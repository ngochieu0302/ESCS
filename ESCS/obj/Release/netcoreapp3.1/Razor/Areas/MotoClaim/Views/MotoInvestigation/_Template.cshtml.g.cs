#pragma checksum "D:\ESCS\ESCS\Areas\MotoClaim\Views\MotoInvestigation\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "091817988fe7f7267c9233fff3e5b57bc543f086"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_MotoClaim_Views_MotoInvestigation__Template), @"mvc.1.0.view", @"/Areas/MotoClaim/Views/MotoInvestigation/_Template.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"091817988fe7f7267c9233fff3e5b57bc543f086", @"/Areas/MotoClaim/Views/MotoInvestigation/_Template.cshtml")]
    public class Areas_MotoClaim_Views_MotoInvestigation__Template : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
<script type=""text/html"" id=""templateDsHoSoGiayTo"">
    ...
    <tr>
        ...
        <td style=""text-align: center"">
            ...
            BeginWriteAttribute("for", " for=\"", 3510, "\"", 3516, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% }else{ %>\r\n            <%");
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 3594, "", 3611, 0);
            EndWriteAttribute();
        ...
        <td style=""text-align: center"">
            <a href=""#"" data-field=""loai"" data-val=""<%- item.loai %>"" onclick=""chonLoaiHSGT(this)"" id=""loai_hsgt_<%- item.ma_hs %>"">
                <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 4634, "\'", 4639, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 4653, "", 4656, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n                <%- item.loai_ten %>\r\n                <% }else{ %>\r\n                Chọn loại hồ sơ\r\n                <% } %>\r\n            </a>\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 4837, "", 4858, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""C""){
        if(item.chon==1){
        ...
        <td style=""tex");
            ...
            BeginWriteAttribute("if(item.gara_thu_ho", " if(item.gara_thu_ho =", 6939, "", 6961, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 7553, "\"", 7561, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_gara_thu_ho"">
                <label class=""custom-control-label"" for=""gara_thu_ho_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
...
<script type=""text/html"" id=""bodyHoSoGiayToLoi_template"">
    ...
    <tr>
        ...
        <td class=""text-center"">");
            ...
            BeginWriteAttribute("if(item.kq_nsd", " if(item.kq_nsd =", 8667, "", 8684, 0);
            EndWriteAttribute();
...
");
    ...
    <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 9708, "", 9723, 0);
            EndWriteAttribute();
    ...
    <div class=""pt-1"" id=""nhom_anh_<%- index %>"">
        <p class=""m-0 font-weight-bold"">
            ...
            BeginWriteAttribute("item.ten_doi_tuong!", " item.ten_doi_tuong!=\'", 10024, "\'", 10046, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
<script type=""text/html"" id=""templateDsGiamDinhVienTheoDiaBan"">
    ...
    <tr style=""cursor:pointer"" onclick=""chonGiamDinhVien('<%- index + 1 %>','<%- item.ma_doi_tac %>','<%- item.ma_chi_nhanh %>','<%- item.gdv %>')"">
      ...
      ");
            WriteLiteral(@"  <td style=""vertical-align: middle; text-align: center;""><%- item.ten %></td>
...
<script type=""text/html"" id=""templateDropdownGDVHT"">
    <%");
            BeginWriteAttribute("if(ds_ket_noi!", " if(ds_ket_noi!=", 13877, "", 13893, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""templateItemViewImage"">
    <%");
            BeginWriteAttribute("if(data_info!", " if(data_info!=", 14862, "", 14877, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""hmChiTietItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc)%>"">
        ...
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""thu_hoi_ten"" value=""<%- item.");
            WriteLiteral(@"thu_hoi_ten %>"" />
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""so_id_doi_tuong"" value=""<%- item.so_id_d");
            WriteLiteral("oi_tuong %>\" />\r\n            <a href=\"#\" onclick=\"openModalImages(\'<%- item.ten_hang_muc %>\')\"><%- item.ten_hang_muc %></a>\r\n            <%if(item.dgrr");
            BeginWriteAttribute("!", " !=", 17422, "", 17425, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.dgrr");
            BeginWriteAttribute("!", " !=", 17448, "", 17451, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dgrr");
            BeginWriteAttribute("!", " != \"", 17469, "\"", 17474, 0);
            EndWriteAttribute();
            WriteLiteral(" &&");
            BeginWriteAttribute("item.dgrr", " item.dgrr =", 17478, "", 17490, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""C""){%>
        ...
        <td class=""text-center"">
  ");
            WriteLiteral(@"          <a href=""#""><i class=""fas fa-trash-alt"" title=""Sửa thông tin"" onclick=""xoaHMTT('<%- item.vu_tt%>', '<%- item.hang_muc%>', '<%- item.so_id%>', '<%- item.ma_chi_nhanh%>', '<%- item.ma_doi_tac%>')""></i></a>
        </td>
    </tr>
    <% })}%>
    <% if(danh_sach.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 18814, "", 18818, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            <input type=""hidden"" class=""floating-input"" modalChiTietTonThatHANGHOATemplatedata-field=""bt"" value=""<%- item.bt %>"" />
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""nhom"" value=""<%- item.nhom %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""hang_muc"" value=""<%- item.hang_muc %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""lh_nv"" value=""<%- item.lh_nv %>"" />
     ");
            WriteLiteral("       <input type=\"hidden\" class=\"floating-input\" data-field=\"cmnd\" value=\"<%- item.cmnd %>\" />\r\n            <input type=\"hidden\" class=\"floating-input\" data-field=\"ten\" placeholder=\"Tên đối tượng\"");
            BeginWriteAttribute("required", " required=\"", 20347, "\"", 20358, 0);
            EndWriteAttribute();
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 20625, "", 20628, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 20649, "\"", 20653, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 21321, "\"", 21332, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 21643, "\"", 21654, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 21943, "\"", 21954, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 22184, "\"", 22195, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.so_luong_tt) %>\" />\r\n        </td>\r\n\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" onchange=\"tinhTongTienTNDSTaiSan()\" data-field=\"tien_vtu\" placeholder=\"Tiền vật tư\"");
            BeginWriteAttribute("required", " required=\"", 22428, "\"", 22439, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_vtu) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" onchange=\"tinhTongTienTNDSTaiSan()\" data-field=\"tien_nhan_cong\" placeholder=\"Tiền tiền nhân công\"");
            BeginWriteAttribute("required", " required=\"", 22681, "\"", 22692, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_nhan_cong) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" disabled=\"disabled\" data-field=\"tien_tt\" placeholder=\"Tiền tổn thất\"");
            BeginWriteAttribute("required", " required=\"", 22911, "\"", 22922, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 23124, "\"", 23135, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_thoa_thuan) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 23274, "", 23277, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 23285, "\"", 23299, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 23831, "", 23834, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 23842, "\"", 23858, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <a href=""#"" onclick=""xoaHangMucChiTiet(this, 'HANG_HOA')""><i class=""fas fa-trash-alt"" title=""Xóa thông tin""></i></a>
        </td>
    </tr>
    <%
    })}%>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 24596, "", 24600, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""lh_nv"" value=""<%- item.lh_nv %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""cmnd""");
            BeginWriteAttribute("value", " value=\"", 25906, "\"", 25914, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
            <input type=""hidden"" class=""floating-input"" data-field=""tien_khac"" value=""<%- item.tien_khac %>"" />
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 26218, "", 26221, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 26242, "\"", 26246, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            <input type=""text"" class=""floating-input combobox"" data-field=""muc_do"" data-val=""<%- item.muc_do %>"" onclick=""chonMucDoChiTietTonThat(this)"" readonly=""readonly""");
            BeginWriteAttribute("required", " required=\"", 26914, "\"", 26925, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" value=""<%- item.muc_do_ten %>"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td>
            <input type=""text"" class=""floating-input combobox"" data-field=""dvi_tinh"" data-val=""<%- item.dvi_tinh %>"" onclick=""chonDViTinhChiTietTonThat(this)"" readonly=""readonly""");
            BeginWriteAttribute("required", " required=\"", 27236, "\"", 27247, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"Click chọn\" value=\"<%- item.dvi_tinh_ten %>\" style=\"text-align:center; cursor:pointer\" />\r\n        </td>\r\n        <td>\r\n");
            WriteLiteral("            <input type=\"text\" class=\"floating-input number\" data-field=\"gia\" placeholder=\"Giá trị\"");
            BeginWriteAttribute("required", " required=\"", 27532, "\"", 27543, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.gia) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"so_luong_tt\" placeholder=\"Số lượng tổn thất\"");
            BeginWriteAttribute("required", " required=\"", 27739, "\"", 27750, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.so_luong_tt) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" onchange=\"onChangeTinhTongTaiSanHHoa(this)\" data-field=\"tien_vtu\" placeholder=\"Tiền vật tư\"");
            BeginWriteAttribute("required", " required=\"", 27989, "\"", 28000, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_vtu) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" onchange=\"onChangeTinhTongTaiSanHHoa(this)\" data-field=\"tien_nhan_cong\" placeholder=\"Tiền tiền nhân công\"");
            BeginWriteAttribute("required", " required=\"", 28250, "\"", 28261, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_nhan_cong) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" disabled=\"disabled\" data-field=\"tien_tt\" placeholder=\"Tiền tổn thất\"");
            BeginWriteAttribute("required", " required=\"", 28480, "\"", 28491, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"tien_thoa_thuan\" placeholder=\"Tiền thỏa thuận\"");
            BeginWriteAttribute("required", " required=\"", 28693, "\"", 28704, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_thoa_thuan) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 28843, "", 28846, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 28854, "\"", 28868, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 29400, "", 29403, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 29411, "\"", 29427, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 30158, "", 30162, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 32033, "", 32036, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 32057, "\"", 32061, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            <input type=""text"" class=""floating-input"" data-field=""cmnd""");
            BeginWriteAttribute("required", " required=\"", 32628, "\"", 32639, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"CMT/CCCD\" value=\"<%- item.cmnd %>\" />\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 32718, "", 32742, 0);
            EndWriteAttribute();
        ...
        <td>
            <input type=""text"" class=""floating-input number"" readonly=""readonly"" onchange=""tinhTongTienNguoi()"" data-field=""tien_tt"" placeholder=""Tiền tổn thất""");
            BeginWriteAttribute("required", " required=\"", 33703, "\"", 33714, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"tien_thoa_thuan\" placeholder=\"Tiền thỏa thuận\"");
            BeginWriteAttribute("required", " required=\"", 33916, "\"", 33927, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_thoa_thuan) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 34066, "", 34069, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 34077, "\"", 34091, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 34623, "", 34626, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 34634, "\"", 34650, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 35378, "", 35382, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""so_id_doi_tuong_cha"" value=""<%- item.so_id_doi_tuong_cha %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 36245, "\"", 36256, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- item.ten %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""hang_muc"" value=""<%- item.hang_muc %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 37185, "", 37188, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 37209, "\"", 37213, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            <input type=""text"" class=""floating-input"" data-field=""cmnd""");
            BeginWriteAttribute("required", " required=\"", 37780, "\"", 37791, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"CMT/CCCD\" value=\"<%- item.cmnd %>\" />\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 37870, "", 37894, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- item.bt %>', '<%- item.vu_tt %>', '<%- item.lh_nv %>', '<%- item.hang_muc %>', '<%- item.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td>
            <input type=""text"" class=""floating-input number"" readonly=""readonly"" onchange=""tinhTongTienNguoi()"" data-field=""tien_tt"" placeholder=""Tiền tổn thất""");
            BeginWriteAttribute("required", " required=\"", 38853, "\"", 38864, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"tien_thoa_thuan\" placeholder=\"Tiền thỏa thuận\"");
            BeginWriteAttribute("required", " required=\"", 39066, "\"", 39077, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_thoa_thuan) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 39216, "", 39219, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 39227, "\"", 39241, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 39773, "", 39776, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 39784, "\"", 39800, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 40528, "", 40532, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
            WriteLiteral(@"<script type=""text/html"" id=""modalChiTietTonThatTNDSNGUOI_HKTemplate"">
    <% if(danh_sach.length > 0){
    _.forEach(danh_sach, function(item,index) { %>
    <tr class=""hmChiTietItem"">
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""so_id_doi_tuong_cha"" value=""<%- item.so_id_doi_tuong_cha %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 41405, "\"", 41416, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- item.ten %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""hang_muc"" value=""<%- item.hang_muc %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 42345, "", 42348, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 42369, "\"", 42373, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            <input type=""text"" class=""floating-input"" data-field=""cmnd""");
            BeginWriteAttribute("required", " required=\"", 42940, "\"", 42951, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"CMT/CCCD\" value=\"<%- item.cmnd %>\" />\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 43030, "", 43054, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- item.bt %>', '<%- item.vu_tt %>', '<%- item.lh_nv %>', '<%- item.hang_muc %>', '<%- item.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td>
            <input type=""text"" class=""floating-input number"" readonly=""readonly"" onchange=""tinhTongTienNguoi()"" data-field=""tien_tt"" placeholder=""Tiền tổn thất""");
            BeginWriteAttribute("required", " required=\"", 44013, "\"", 44024, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"tien_thoa_thuan\" placeholder=\"Tiền thỏa thuận\"");
            BeginWriteAttribute("required", " required=\"", 44226, "\"", 44237, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_thoa_thuan) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 44376, "", 44379, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 44387, "\"", 44401, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 44933, "", 44936, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 44944, "\"", 44960, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 45688, "", 45692, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
            WriteLiteral(@"<script type=""text/html"" id=""modalChiTietTonThatLPHU_XETemplate"">
    <% if(danh_sach.length > 0){
    _.forEach(danh_sach, function(item,index) { %>
    <tr class=""hmChiTietItem"">
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""so_id_doi_tuong_cha"" value=""<%- item.so_id_doi_tuong_cha %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 46552, "\"", 46563, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- item.ten %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""hang_muc"" value=""<%- item.hang_muc %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 47492, "", 47495, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 47516, "\"", 47520, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            <input type=""text"" class=""floating-input"" data-field=""cmnd""");
            BeginWriteAttribute("required", " required=\"", 48087, "\"", 48098, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"CMT/CCCD\" value=\"<%- item.cmnd %>\" />\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 48177, "", 48201, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- item.bt %>', '<%- item.vu_tt %>', '<%- item.lh_nv %>', '<%- item.hang_muc %>', '<%- item.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td>
            <input type=""text"" class=""floating-input number"" readonly=""readonly"" onchange=""tinhTongTienNguoi()"" data-field=""tien_tt"" placeholder=""Tiền tổn thất""");
            BeginWriteAttribute("required", " required=\"", 49162, "\"", 49173, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"tien_thoa_thuan\" placeholder=\"Tiền thỏa thuận\"");
            BeginWriteAttribute("required", " required=\"", 49375, "\"", 49386, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_thoa_thuan) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 49525, "", 49528, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 49536, "\"", 49550, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 50082, "", 50085, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 50093, "\"", 50109, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 50837, "", 50841, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
<script type=""text/html"" id=""modalThemTNDS_template"">
    ...
    <tr>
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 51901, "\"", 51912, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 52148, "\"", 52159, 0);
            EndWriteAttribute();
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 52671, "\"", 52682, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\" placeholder=\"Tên địa chỉ\"");
            BeginWriteAttribute("required", " required=\"", 52801, "\"", 52812, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number sl\" placeholder=\"Số lượng\"");
            BeginWriteAttribute("required", " required=\"", 52933, "\"", 52944, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input tinh_trang\" onclick=\"chonTinhTrangTNDS(this, \'TAI_SAN\')\" readonly=\"readonly\"");
            BeginWriteAttribute("required", " required=\"", 53108, "\"", 53119, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"Click chọn\" style=\"text-align:center; cursor:pointer\" />\r\n");
            WriteLiteral("        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\" placeholder=\"Tiền tổn thất\"");
            BeginWriteAttribute("required", " required=\"", 53547, "\"", 53558, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
        <td>
...
<script type=""text/html"" id=""modalThemTNDSNguoi_template"">
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 54137, "\"", 54148, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- item.ten %>\" />\r\n            <input type=\"hidden\" class=\"floating-input number sl\"");
            BeginWriteAttribute("required", " required=\"", 54243, "\"", 54254, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.sl) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\" placeholder=\"Địa chỉ\"");
            BeginWriteAttribute("required", " required=\"", 54412, "\"", 54423, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 54610, "\"", 54621, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" value=""<%- item.tinh_trang_ten %>"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" class=""thuong_tat"" onclick=""danhGiaThuongTat(this)"">
                Đánh giá thương tật (<%-");
            BeginWriteAttribute("item.thuong_tat", " item.thuong_tat=", 54930, "", 54947, 0);
            EndWriteAttribute();
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 55666, "\"", 55677, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" class=\"floating-input number sl\" value=\"1\"");
            BeginWriteAttribute("required", " required=\"", 55758, "\"", 55769, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\" placeholder=\"Địa chỉ\"");
            BeginWriteAttribute("required", " required=\"", 55884, "\"", 55895, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input tinh_trang\" onclick=\"chonTinhTrangTNDS(this, \'NGUOI\')\" readonly=\"readonly\"");
            BeginWriteAttribute("required", " required=\"", 56057, "\"", 56068, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td class=""text-center"">
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 56436, "\"", 56447, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
...
<script type=""text/html"" id=""dsBenThamGiaGiamDinhTemplate"">
    ...
    <% if(danh_sach.l");
            ...
            BeginWriteAttribute("i", " i =", 57496, "", 57500, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""divP");
    ...
    <div class=""custom-control custom-checkbox mt-1 div-plhm-mucdo-item"" plhm-div-ma=""<%- item.ma %>"" plhm-mucdo-nv=""<%- item.nv %>"" plhm-mucdo-nhom=""<%- item.nhom %>"">
        ...
        <label class=""custom-control-l");
            ...
            BeginWriteAttribute("!", " !=", 59681, "", 59684, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.children");
            BeginWriteAttribute("!", " !=", 59711, "", 59714, 0);
            EndWriteAttribute();
    ...
    <div>
        ...
        <div class=""divAnhPhanLoai"" data-ma-file=""<%- item.ma_file %>"" data-bt=""<%- image.bt %>"" id=""divAnhPhanLoai_<%- image.bt %>"" onclick=""plhmChonAnh('<%- image.bt %>', '<%- item.ma_file %>')"" ondblclick=""plhmDblChonAnh('<%- image.bt %>')"">
            ...
            <img data-original="""" location-x=""<%- image.x %>"" location-y=""<%- image.y %>"" data-id=""<%- image.so_id %>"" data-bt=""<%- image.bt %>"" data-ma-file=""<%- image.ma_file %>"" data-pm=""<%- image.pm %>"" data-cnhanh=""<%- image.ma_chi_nhanh %>"" src=""/images/xml.png"" alt=""<%- image.ten_file %>"">
            <% } else if(_.includes(["".xlsx"", "".xls""], image.extension)){%>
            <img data-original="""" location-x=""<%- image.x %>"" location-y=""<%- image.y %>"" data-id=""<%- image.so_id %>"" data-bt=""<%- image.b");
            WriteLiteral(@"t %>"" data-ma-file=""<%- image.ma_file %>"" data-pm=""<%- image.pm %>"" data-cnhanh=""<%- image.ma_chi_nhanh %>"" src=""/images/excel-logo.jpg"" alt=""<%- image.ten_file %>"">
            <% } %>
...
<script type=""text/html"" id=""tblDanhSachVuTonThatTemplate"">
    ...
    <tr style=""cursor: pointer"" id=""ds_vu_ton_that_<%- item.vu_tt %>"" class=""ds_vu_ton_that"" onclick=""xemChiTietVuTonThat('<%- item.vu_tt %>')"">
        <td>
            <%");
            BeginWriteAttribute("if(item.pham_vi", " if(item.pham_vi =", 64986, "", 65004, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""0""){
            %>
...
<script type=""text/html"" id=""modalMotoSearchDsGCNTemplate"">
    <% if(data_info.length > 0){
    _.forEach(data_info, function(item,index) { %>
    <tr style=""cursor: pointer"" data_ma_chi_nhanh=""<%- item.ma_chi_nhanh %>"" data_so_id=""<%- item.so_id_hdong %>"" data_so_id_dt=""<%- item.so_id_gcn %>"" data_loai=""<%- item.loai_gcn %>"" class=""tkiem_kh"" id=""tkiem_kh_<%- item.so_id_hdong %>_<%- item.so_id_gcn %>_<%- item.loai_gcn %>"" onclick=""onChonKhachHang('<%- item.so_id_hdong %>','<%- item.so_id_gcn %>','<%- item.loai_gcn %>')"">
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 66820, "", 66824, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""danh_gia_hien_truong_template"">
    ...
    <%");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 67233, "", 67248, 0);
            EndWriteAttribute();
            WriteLiteral("= \'RADIO\'){ %>\r\n    <div class=\"col-6 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 67342, "", 67366, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <label class=\"_required\"><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 67555, "", 67571, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
            ...
            <% } else { %>
            <label");
            BeginWriteAttribute("class", " class=\"", 68117, "\"", 68125, 0);
            EndWriteAttribute();
            WriteLiteral("><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 68269, "", 68285, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
                <div class=""form-check form-check-inline ml-3"" style=""margin-right:unset"">
    ...
    <% }else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 68837, "", 68852, 0);
            EndWriteAttribute();
            WriteLiteral("= \'CHECKBOX\'){ %>\r\n    <div class=\"col-6 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 68949, "", 68973, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <label class=\"_required\"><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 69162, "", 69178, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 69715, "\"", 69723, 0);
            EndWriteAttribute();
            WriteLiteral("><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 69867, "", 69883, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
                <div class=""custom-control custom-checkbox ml-3"">
    ...
    <% }else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 70428, "", 70443, 0);
            EndWriteAttribute();
            WriteLiteral("= \'TEXTAREA\'){ %>\r\n    <%");
            BeginWriteAttribute("if(item.kieu_loai", " if(item.kieu_loai =", 70468, "", 70488, 0);
            EndWriteAttribute();
            WriteLiteral("= \'col4\'){ %>\r\n    <div class=\"col-4 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 70581, "", 70605, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
    ...
    <% } else");
            BeginWriteAttribute("if(item.kieu_loai", " if(item.kieu_loai =", 71304, "", 71324, 0);
            EndWriteAttribute();
            WriteLiteral("= \'col12\'){ %>\r\n    <div class=\"col-12 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 71419, "", 71443, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
    ...
    <% } %>
    <% } else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 72155, "", 72170, 0);
            EndWriteAttribute();
            WriteLiteral("= \'TEXT\'){ %>\r\n    <div class=\"col-4 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 72263, "", 72287, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 72644, "\"", 72652, 0);
            EndWriteAttribute();
            WriteLiteral(@"><%- item.ten_loai %></label>
            <div class=""input-group"">
    ...
    <% } else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 72973, "", 72988, 0);
            EndWriteAttribute();
            WriteLiteral("= \'NUMBER\'){ %>\r\n    <%");
            BeginWriteAttribute("if(item.an_hien", " if(item.an_hien =", 73011, "", 73029, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n    <div class=\"col-12 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 73118, "", 73142, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 73506, "\"", 73514, 0);
            EndWriteAttribute();
            WriteLiteral(@"><%- item.ten_loai %></label>
            <div class=""input-group"">
...
<script type=""text/html"" id=""dsHinhAnhHangMucTemplate"">
    ...
    <% _.forEach(danh_sach, function(item,index) { %>
    <div class");
            WriteLiteral(@"=""imagesCategory"" style=""display: table-row"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.nhom)%>"">
...
<script type=""text/html"" id=""danhSachNV_template"">
    ...
    _.forEach(lhnv, function(item,index) { %>");
            ...
            BeginWriteAttribute("if(item.vcx", " if(item.vcx =", 75814, "", 75828, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VCX'){ %>
        <%if(item.ktru==""K""){%>
...
<script type=""text/html"" id=""dsDoiTuongTTTemplate"">
    ...
    <tr class=""item_so_id_doi_tuong"" data-so-id-doi-tuong=""<%- item.so_id_doi_tuong %>""");
        ...
        <td onclick=""chonDoiTuongTT('<%- item.so_id_doi_tuong %>',)"" id=""ds_doi_tuong_tt_<%- item.so_id_doi_tuong %>"" class=""ds_doi_tuong_tt text-center""><%- item.ten_doi_tuong %></td>
        ...
        <td class=""text-center"">
            <a href=""#"" onclick=""suaDoiTuongTT('<%- item.so_id_d");
            WriteLiteral("oi_tuong %>\')\"><i class=\"fa fa-edit\"></i></a>\r\n        </td>\r\n    </tr>\r\n    <%})}%>\r\n    <% if(data.length < 5){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 78002, "", 78006, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 5 - data.length;i++ ){ %>\r\n    <tr style=\"cursor: pointer\">\r\n        <td style=\"height:34.6px\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <%}}%>\r\n</script>\r\n");
            WriteLiteral("<script type=\"text/html\" id=\"danhSachChiPhiGDLanTemplate\">\r\n    <% if(data.length > 0) {\r\n    _.forEach(data, function(item, index) {%>\r\n    <tr class=\"row-item\">\r\n        <td class=\"text-center cursor-pointer\">\r\n            <%if(item.ma_cp");
            BeginWriteAttribute("!", " !=", 78502, "", 78505, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null &&  item.ma_cp !== ''){%>
        ...
        <td class=""text-cente");
            WriteLiteral("r\">\r\n            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 79564, "", 79567, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " !=\'", 79588, "\'", 79592, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <% if(data.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 80391, "", 80395, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""titleUpdateContractTemplate"">
   ");
            WriteLiteral(" <%");
            BeginWriteAttribute("if(ho_so.so_hs!", " if(ho_so.so_hs!=", 81422, "", 81439, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("ho_so.so_hs.trim()!", " ho_so.so_hs.trim()!= \"", 81447, "\"", 81470, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
<script type=""text/html"" id=""danhSachCanhBaoTemplate"">
    ...
    <d");
            WriteLiteral(@"iv class=""esmodal-title d-flex justify-content-between"">
            ...
            <li class=""nav-item dropdown"">
                ...
                <div class=""dropdown-menu mailbox dropdown-menu-left scale-up pt-0""
                    ...
                    <ul class=""list-style-none"">
                        <li>
");
            WriteLiteral(@"                            <div class=""border-bottom rounded-top p-2 text-center"" style=""background-color: #edeff0 "">
...
");
    ...
    <tr data-ma-gara=""<%- bao_gia.gara %>"" data-so-id-doi-tuong=""<%- bao_gia.so_id_doi_tuong %>"" data-bt-gara=""<%- bao_gia.bt_gara %>"">
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.so_id_pa", " if(bao_gia.so_id_pa =", 87409, "", 87431, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || bao_gia.so_id_pa == null || bao_gia.so_id_pa == """" || bao_gia.so_id_pa == ""0""){
            %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
            ...
            <%}else");
            BeginWriteAttribute("if(bao_gia.chon_pa_trinh", " if(bao_gia.chon_pa_trinh =", 88091, "", 88118, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || bao_gia.chon_pa_trinh == null || bao_gia.chon_pa_trinh == """" || bao_gia.chon_pa_trinh == ""C""){%>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" ");
            WriteLiteral(@" id=""garaBaoGiaChon_<%- bao_gia.gara %>_<%- bao_gia.so_id_doi_tuong %>"" data-so_id_doi_tuong=""<%- bao_gia.so_id_doi_tuong %>"" value=""<%- bao_gia.gara %>"" class=""custom-control-input garaBaoGiaChonItem"">
                <label class=""custom-control-label"" for=""garaBaoGiaChon_<%- bao_gia.gara %>_<%- bao_gia.so_id_doi_tuong %>"">&nbsp;</label>
            </div>
            <%}else{%>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" ");
            WriteLiteral(@" checked=""checked"" id=""garaBaoGiaChon_<%- bao_gia.gara %>_<%- bao_gia.so_id_doi_tuong %>"" data-so_id_doi_tuong=""<%- bao_gia.so_id_doi_tuong %>"" value=""<%- bao_gia.gara %>"" class=""custom-control-input garaBaoGiaChonItem"">
                <label class=""custom-control-label"" for=""garaBaoGiaChon_<%- bao_gia.gara %>_<%- bao_gia.so_id_doi_tuong %>"">&nbsp;</label>
            </div>
            <%} %>
        </td>
        ...
        <td class=""text-center"">
            ...
            if(bao_gia.t");
            WriteLiteral(@"rang_thai_bg == null){%>
        ...
        <td class=""text-center"" style=""width:60px"">
            <%");
            BeginWriteAttribute("if(bao_gia.trang_thai", " if(bao_gia.trang_thai =", 90976, "", 91000, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 91713, "", 91717, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""garaBaoGiaCT_template"">
    ...
    <tr class=""gara_bg_ctiet"" data-search=""<%- ESUtil.xoaKhoangTrangText(bao_gia.ten_hang_muc) %>"">
        ...
        <td>
            <input type=""h");
            WriteLiteral(@"idden"" name=""gia_giam_dinh"" value=""<%- bao_gia.gia_giam_dinh %>"" />
            ...
            <input type=""hidden"" name=""tien_nhan_cong_duyet"" class=""number wd-80-f floating-input"" v");
            WriteLiteral(@"alue=""<%- ESUtil.formatMoney(bao_gia.tien_nhan_cong_duyet) %>"" />
            ...
            <a data-field=""ten_hang_muc"" data-val=""<%- bao_gia.ten_hang_muc %>"" onclick=""capNhatThongTinHangMuc(this, 'G')""><%- bao_gia.ten_hang_muc %></a>
        </td>
        <td class=""text-center"">
        ...
        <%}else");
            BeginWriteAttribute("if(bao_gia.loai_hang_muc", " if(bao_gia.loai_hang_muc =", 94780, "", 94807, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""B""){%>
        <td>
            <input type=""hidden"" name=""loai_hang_muc"" value=""<%- bao_gia.loai_hang_muc %>"" />
        ...
        <td class=""text-center"">
            <%if(bao_gia.hang_muc_bo_sung_moi == ""M""){%>
            <a href=""#"" data-field=""muc_do_ten"" data-val=""<%- bao_gia.muc_do_ten %>"" class=""text-danger"" onclick=""capNhatThongTinHangMuc(this, 'B')""><%- bao_gia.muc_do_ten %></a>
            <%}else{%>
            <a href=""#"" data-field=""muc_do_ten"" data-val=""<%- bao_gia.muc_do_ten %>"" onclick=""capNhatThongTinHangMuc(this, 'B')");
            WriteLiteral(@"""><%- bao_gia.muc_do_ten %></a>
            <%}%>
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.thay_the_sc", " if(bao_gia.thay_the_sc=", 97507, "", 97531, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T"") {%>
        ...
        <td class=""text-center"">
            <% if(bao_gia.ghi_chu");
            BeginWriteAttribute("!", " !=", 100552, "", 100555, 0);
            EndWriteAttribute();
            WriteLiteral(" null && bao_gia.ghi_chu");
            BeginWriteAttribute("!", " != \"", 100579, "\"", 100584, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
...
<script type=""text/html"" id=""divGaraHopTac_template"">
    ...
    <% })");
            ...
            WriteLiteral(@"<script type=""text/html"" id=""navPhuongAnNghiepVuTemplate"">
    <% if(danh_sach.length > 0){
    _.forEach(danh_sach, function(item,index) { %>
...
<script type=""text/html"" id=""divNguyenNhanTemplate"">
    ...
    <% })}else{ %>
    <div class=""text-center"" style=""width:100%"">Chưa có dữ liệu</");
            WriteLiteral(@"div>
    <% } %>
</script>
