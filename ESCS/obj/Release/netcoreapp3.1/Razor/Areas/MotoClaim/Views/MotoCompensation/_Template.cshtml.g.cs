#pragma checksum "D:\ESCS\ESCS\Areas\MotoClaim\Views\MotoCompensation\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "11634496bff84c6d3ac5de417acad54fa7080d20"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_MotoClaim_Views_MotoCompensation__Template), @"mvc.1.0.view", @"/Areas/MotoClaim/Views/MotoCompensation/_Template.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"11634496bff84c6d3ac5de417acad54fa7080d20", @"/Areas/MotoClaim/Views/MotoCompensation/_Template.cshtml")]
    public class Areas_MotoClaim_Views_MotoCompensation__Template : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span><%- ho_so.gcn %></span>
                            <span class=""float-right"">
                                <a href=""#"" onclick=""xemThongTinGiayChungNhanMotoCompensation()"">
                    ...
                    <tr>
                        <t");
            WriteLiteral(@"d style=""width:105px; color:#999999"">Số hợp đồng</td>
                        <td><%- ho_so.so_hd %></td>
                    </tr>
                        ...
                        <td style=""width:auto"">
                            ...
                            <span class=""float-right"">
                                <a href=""#"" onclick=""chonKhachHangVip(this)"">
                                    <%");
            BeginWriteAttribute("if(ho_so.nhom_kh_vip", " if(ho_so.nhom_kh_vip =", 3997, "", 4020, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
...
");
            WriteLiteral(@"<script type=""text/html"" id=""MotoCompensationContentStep1Table2_template"">
    <table class=""table"">
        <tr>
...
<script type=""text/html"" id=""MotoCompensationContentStep1Table2_template_none"">
    <table class=""table"">
        <tr>
            <td style=""width:130px; color:#999999"">Ngày xảy ra</td>
            <td colspan=""5""></td>
...
");
            WriteLiteral(@"<script type=""text/html"" id=""MotoCompensationContentStep1Table3_template"">
    <table class=""table"">
        <tbody>
            <tr>
...
<script type=""text/html"" id=""MotoCompensationContentStep1Table3_template_none"">
    <table class=""table"">
        <tbody>
            <tr>
                <td style=""width:130px; color:#999999"">Ngày Giám định</td>
            ...
            <tr>
                ...
                <td></td>
                <td st");
            WriteLiteral(@"yle=""width:130px; color:#999999"">Điện thoại</td>
                <td></td>
                <td style=""width:130px; color:#999999"">Email</td>
                <td></td>
            </tr>
...
");
            WriteLiteral(@"<script type=""text/html"" id=""MotoCompensationContentStep1Table4_template"">
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 19398, "", 19401, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 19409, "\"", 19423, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 19955, "", 19958, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 19966, "\"", 19982, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 20541, "", 20545, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 21241, "", 21244, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 21252, "\"", 21268, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 22245, "", 22248, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 22256, "\"", 22270, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 22802, "", 22805, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 22813, "\"", 22829, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 23382, "", 23386, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 24028, "", 24031, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 24039, "\"", 24055, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showDiaChi(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td class=""text-center"">
            <% if");
            WriteLiteral("(item.mo_ta");
            BeginWriteAttribute("!", " !=", 25091, "", 25094, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 25102, "\"", 25116, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 25648, "", 25651, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 25659, "\"", 25675, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 26227, "", 26231, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 26843, "", 26846, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 26854, "\"", 26870, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showDiaChi(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td class=""text-right"">
            <%- ESUtil.");
            WriteLiteral("formatMoney(item.tien_tt) %>\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 28002, "", 28005, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 28013, "\"", 28027, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 28559, "", 28562, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 28570, "\"", 28586, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 29138, "", 29142, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 29764, "", 29767, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.dia_chi!", " item.dia_chi!=\"", 29775, "\"", 29791, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showDiaChi(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td class=""text-right"">
            <%- ESUtil.");
            WriteLiteral("formatMoney(item.tien_tt) %>\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 30923, "", 30926, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 30934, "\"", 30948, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 31480, "", 31483, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 31491, "\"", 31507, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 32059, "", 32063, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 6 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
            ...
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 33570, "", 33587, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            ...
            BeginWriteAttribute("for", " for=\"", 33881, "\"", 33887, 0);
            EndWriteAttribute();
            WriteLiteral(@">&nbsp;</label>
            </div>
            <% }else{ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                ...
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 34197, "\"", 34203, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% } %>\r\n        </td>\r\n        <td style=\"text-align: center\">\r\n            <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 34345, "\'", 34350, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 34364, "", 34367, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n            <%- item.loai_ten %>\r\n            <% }else{ %>\r\n            Chưa bổ sung\r\n            <% } %>\r\n        </td>\r\n        <td style=\"text-align: center\">\r\n            <%");
            BeginWriteAttribute("if(item.gara_thu_ho", " if(item.gara_thu_ho =", 34556, "", 34578, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <div class=""custom-control custom-checkbox custom-control-inline"" style=""margin:unset;"">
                ...
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 34872, "\"", 34878, 0);
            EndWriteAttribute();
            WriteLiteral(@">&nbsp;</label>
            </div>
            <% }else{ %>
            <div class=""custom-control custom-checkbox custom-control-inline"" style=""margin:unset;"">
                ...
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 35188, "\"", 35194, 0);
            EndWriteAttribute();
            WriteLiteral(@">&nbsp;</label>
            </div>
            <% } %>
...
");
    ...
    <tr class=""hmChiTietItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten) %>"">
        ...
        <td>
            ...
            <%if(item.dgrr");
            BeginWriteAttribute("!", " !=", 37231, "", 37234, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.dgrr");
            BeginWriteAttribute("!", " !=", 37257, "", 37260, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dgrr");
            BeginWriteAttribute("!", " != \"", 37278, "\"", 37283, 0);
            EndWriteAttribute();
            WriteLiteral(" &&");
            BeginWriteAttribute("item.dgrr", " item.dgrr =", 37287, "", 37299, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""C""){%>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 38183, "", 38186, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " != \"", 38207, "\"", 38212, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 38723, "", 38738, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 39014, "", 39018, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""tblPhuongAnHANGHOATemplate"">
    ...
    <tr>
        ...
        <td class=""text-right"" style=""color:blue""><%- ESUtil.formatMoney(item.gia");
            ...
            BeginWriteAttribute("!", " !=", 40224, "", 40227, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 40765, "", 40780, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
...
");
            ...
            BeginWriteAttribute("!", " !=", 42407, "", 42410, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 42948, "", 42963, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
    ...
    <% if(pa_khac_phuc.length < 10){
    for(var");
            BeginWriteAttribute("i", " i =", 43240, "", 43244, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 10 - pa_khac_phuc.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 43395, "\"", 43403, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""tblPhuongAnTNDSNguoiTemplate"">
    ...
    <tr>
        ...
        <td cl");
            ...
            BeginWriteAttribute("!", " !=", 44576, "", 44579, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 45117, "", 45132, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
    ...
    <% if(pa_khac_phuc.length < 10){
    for(var");
            BeginWriteAttribute("i", " i =", 45409, "", 45413, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 10 - pa_khac_phuc.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 45564, "\"", 45572, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""tblPhuongAnTNDSTaiSanTemplate"">
    ...
    <tr>
        ...
        <td c");
            ...
            BeginWriteAttribute("!", " !=", 46746, "", 46749, 0);
            EndWriteAttribute();
            WriteLiteral(@"= null && item.ghi_chu != """"){ %>
            <p class=""m-0"" data-toggle=""tooltip"" title=""<%- item.ghi_chu %>"">
                <a href=""#"">
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 47287, "", 47302, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'PHU'){ %>
            <a href=""#"" class=""xoaHangMucTonThat"">
                <i class=""fas fa-trash-alt"" title=""Xóa hạng mục bồi thường""></i>
    ...
    <% if(pa_khac_phuc.length < 10){
    for(var");
            BeginWriteAttribute("i", " i =", 47579, "", 47583, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 10 - pa_khac_phuc.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 47734, "\"", 47742, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
    ...
    <tr data-ma-gara=""<%- bao_gia.gara %>"" data-so-id-doi-tuong=""<%- bao_gia.so_id_doi_tuong %>"" data-bt-gara=""<%- bao_gia.bt_gara %>"">
        ...
        <td class=""text-center"" style=""width:60px"">
            <%");
            BeginWriteAttribute("if(bao_gia.trang_thai", " if(bao_gia.trang_thai =", 50499, "", 50523, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 51236, "", 51240, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""gara_bg_ctiet"" data-search=""<%- ESUtil.xoaKhoangTrangText(bao_gia.ten_hang_muc) %>"">
        ...
        <%}else");
            BeginWriteAttribute("if(bao_gia.loai_hang_muc", " if(bao_gia.loai_hang_muc =", 54185, "", 54212, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""B""){%>
        <td>
            <input type=""hidden"" name=""loai_hang_muc"" value=""<%- bao_gia.loai_hang_muc %>"" />
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.thay_the_sc", " if(bao_gia.thay_the_sc=", 56944, "", 56968, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T"") {%>
        ...
        <td class=""text-center"">
            <% if(bao_gia.ghi_chu");
            BeginWriteAttribute("!", " !=", 59989, "", 59992, 0);
            EndWriteAttribute();
            WriteLiteral(" null && bao_gia.ghi_chu");
            BeginWriteAttribute("!", " != \"", 60016, "\"", 60021, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 60591, "", 60595, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td class=""text-center"">
           ...
           ");
            ...
            BeginWriteAttribute("i", " i =", 62972, "", 62976, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - chung_tu.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 63122, "\"", 63130, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
 ...
 ");
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 64915, "", 64919, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - thu_huong.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 65066, "\"", 65074, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""step4_tam_ung_template"">
    ...
    <tr onclick=""xemCtietTamUng('<%- item.so_id_tu %>')"">
        ...
        <td class=""text-center""><%- item.trang_tha");
            ...
            BeginWriteAttribute("i", " i =", 66183, "", 66187, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 4 - tam_ung.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 66332, "\"", 66340, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
        ...
        <td style=""text-align:center"">
            ...
            BeginWriteAttribute("!", " != \'", 67483, "\'", 67488, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.so_id_doi_tuong");
            BeginWriteAttribute("!", " !=", 67513, "", 67516, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 68450, "", 68468, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" disabled=""disabled"" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 68769, "\"", 68775, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% }else{ %>\r\n            <%");
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 68853, "", 68870, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"hop_le_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 69073, "\"", 69081, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 69452, "\"", 69460, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label"" for=""hop_le_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 69742, "", 69760, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            ...
            <a href=""#"" data-field=""loai"" data-val=""<%- item.loai %>"" onclick=""chonLoaiHSGT(this)"" id=""loai_hsgt_<%- item.ma_hs %>"">
                <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 70093, "\'", 70098, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 70112, "", 70115, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n                <%- item.loai_ten %>\r\n                <% }else{ %>\r\n                Chọn loại hồ sơ\r\n                <% } %>\r\n            </a>\r\n            <% } %>\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 70317, "", 70338, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""C"")
        {
        if(item.chon==1)
     ...
     ");
            ...
            BeginWriteAttribute("if(item.gara_thu_ho", " if(item.gara_thu_ho =", 72617, "", 72639, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"gara_thu_ho_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 72847, "\"", 72855, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 73241, "\"", 73249, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_gara_thu_ho"">
                <label class=""custom-control-label"" for=""gara_thu_ho_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            ...
            BeginWriteAttribute("required", " required=\"", 73602, "\"", 73613, 0);
            EndWriteAttribute();
...
");
    ...
    <tr>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("if(item.kq_nsd", " if(item.kq_nsd =", 74326, "", 74343, 0);
            EndWriteAttribute();
...
");
    ...
    <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 79637, "", 79652, 0);
            EndWriteAttribute();
    ...
    <div class=""pt-1"" id=""nhom_anh_<%- index %>"">
        <p class=""m-0 font-weight-bold"">
            ...
            BeginWriteAttribute("item.ten_doi_tuong!", " item.ten_doi_tuong!=\'", 79953, "\'", 79975, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
<script type=""text/html"" id=""templateItemViewImage"">
    <%");
            BeginWriteAttribute("if(data_info!", " if(data_info!=", 84323, "", 84338, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""modalThemTNDS_template"">
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten""");
            BeginWriteAttribute("required", " required=\"", 87569, "\"", 87580, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\"");
            BeginWriteAttribute("required", " required=\"", 87673, "\"", 87684, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number sl\"");
            BeginWriteAttribute("required", " required=\"", 87782, "\"", 87793, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <select class=\"select2 form-control custom-select tinh_trang\"");
            BeginWriteAttribute("required", " required=\"", 87901, "\"", 87912, 0);
            EndWriteAttribute();
            WriteLiteral(" style=\"width:100%;height:36px;\">\r\n                <option value=\"HONG\" selected=\"selected\">Hỏng</option>\r\n            </select>\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\"");
            BeginWriteAttribute("required", " required=\"", 88143, "\"", 88154, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien\"");
            BeginWriteAttribute("required", " required=\"", 88254, "\"", 88265, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
        <td>
...
<script type=""text/html"" id=""modalThemTNDSNguoi_template"">
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten""");
            BeginWriteAttribute("required", " required=\"", 88796, "\"", 88807, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- item.ten %>\" />\r\n            <input type=\"hidden\" class=\"floating-input number sl\"");
            BeginWriteAttribute("required", " required=\"", 88902, "\"", 88913, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.sl) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\"");
            BeginWriteAttribute("required", " required=\"", 89049, "\"", 89060, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- item.dchi %>\" />\r\n        </td>\r\n        <td>\r\n            <select class=\"select2 form-control custom-select tinh_trang\"");
            BeginWriteAttribute("required", " required=\"", 89193, "\"", 89204, 0);
            EndWriteAttribute();
            WriteLiteral(" style=\"width:100%;height:36px;\">\r\n                <option");
            BeginWriteAttribute("value", " value=\"", 89263, "\"", 89271, 0);
            EndWriteAttribute();
            WriteLiteral(">Chọn tình trạng</option>\r\n                <option value=\"CHET\" <%");
            BeginWriteAttribute("if(item.tinh_trang", " if(item.tinh_trang =", 89338, "", 89359, 0);
            EndWriteAttribute();
            WriteLiteral("=\'CHET\'){ %>selected=\"selected\"<% } %>>Chết</option>\r\n                <option value=\"THUONG\" <%");
            BeginWriteAttribute("if(item.tinh_trang", " if(item.tinh_trang =", 89454, "", 89475, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 90716, "\"", 90727, 0);
            EndWriteAttribute();
            BeginWriteAttribute("value", " value=\"", 90728, "\"", 90736, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\"");
            BeginWriteAttribute("required", " required=\"", 90842, "\"", 90853, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tthat) %>\" />\r\n        </td>\r\n\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien\"");
            BeginWriteAttribute("required", " required=\"", 91006, "\"", 91017, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- ESUtil.formatMoney(item.tien) %>"" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten""");
            BeginWriteAttribute("required", " required=\"", 91473, "\"", 91484, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" class=\"floating-input number sl\"");
            BeginWriteAttribute("required", " required=\"", 91555, "\"", 91566, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"1\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\"");
            BeginWriteAttribute("required", " required=\"", 91669, "\"", 91680, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n\r\n        <td>\r\n            <select class=\"select2 form-control custom-select tinh_trang\"");
            BeginWriteAttribute("required", " required=\"", 91790, "\"", 91801, 0);
            EndWriteAttribute();
            WriteLiteral(" style=\"width:100%;height:36px;\">\r\n                <option");
            BeginWriteAttribute("value", " value=\"", 91860, "\"", 91868, 0);
            EndWriteAttribute();
            WriteLiteral(@">Chọn tình trạng</option>
        ...
        <td>
            <input type=""text"" class=""floating-input number pttt""");
            BeginWriteAttribute("required", " required=\"", 92286, "\"", 92297, 0);
            EndWriteAttribute();
            BeginWriteAttribute("value", " value=\"", 92298, "\"", 92306, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\"");
            BeginWriteAttribute("required", " required=\"", 92412, "\"", 92423, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien\"");
            BeginWriteAttribute("required", " required=\"", 92525, "\"", 92536, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
        <td>
...
<script type=""text/html"" id=""tableThuHoiVatTu_template"">
    ...
    <% if(thu_hoi.length < 3){
    for(var");
            BeginWriteAttribute("i", " i =", 94017, "", 94021, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - thu_hoi.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 94166, "\"", 94174, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""tableDanhSachThuDoiNTBA_template"">
    ...
    <% if(ntba.length < 3){
    for(var");
            BeginWriteAttribute("i", " i =", 95569, "", 95573, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 3 - ntba.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 95715, "\"", 95723, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
<script type=""text/html"" id=""modalBaoGiaGara_lan_ct_template"">
    ...
    <tr class=""cursor-point");
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.thay_the_sc_gara", " if(item.thay_the_sc_gara =", 97012, "", 97039, 0);
            EndWriteAttribute();
            WriteLiteral("=\"T\"){%>\r\n            <span>Thay thế</span>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.thay_the_sc_gara", " if(item.thay_the_sc_gara =", 97117, "", 97144, 0);
            EndWriteAttribute();
            WriteLiteral("=\"S\"){%>\r\n            <span>Sửa chữa</span>\r\n            <%}%>\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <%");
            BeginWriteAttribute("if(item.chinh_hang_gara", " if(item.chinh_hang_gara =", 97271, "", 97297, 0);
            EndWriteAttribute();
            WriteLiteral("=\"C\"){%>\r\n            <i class=\"fas fa-check mr-2\" style=\"color:#28c690\"></i>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.chinh_hang_gara", " if(item.chinh_hang_gara =", 97409, "", 97435, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""K""){%>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 104573, "", 104576, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 104584, "\"", 104598, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 105130, "", 105133, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 105141, "\"", 105157, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 105709, "", 105713, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td cla");
            ...
            BeginWriteAttribute("!", " !=", 112402, "", 112405, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item_dt.mo_ta!", " item_dt.mo_ta!=\"", 112413, "\"", 112430, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item_dt.ghi_chu");
            BeginWriteAttribute("!", " !=", 112968, "", 112971, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item_dt.ghi_chu!", " item_dt.ghi_chu!=\"", 112979, "\"", 112998, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 116902, "", 116905, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 116913, "\"", 116927, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 117459, "", 117462, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 117470, "\"", 117486, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 118040, "", 118044, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 119731, "", 119755, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
        ...
        <td class=""text-ce");
            WriteLiteral("nter\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 120815, "", 120818, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 120826, "\"", 120840, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 121372, "", 121375, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 121383, "\"", 121399, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 121951, "", 121955, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <%");
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 123571, "", 123595, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" data-field=""thuong_tat"" class=""thuong_tat combobox"">Chưa xác định</a>
        ...
        <td class=""tex");
            ...
            BeginWriteAttribute("!", " !=", 124659, "", 124662, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 124670, "\"", 124684, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 125216, "", 125219, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 125227, "\"", 125243, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 125795, "", 125799, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            ...
            BeginWriteAttribute("if(item.ds_thuong_tat", " if(item.ds_thuong_tat =", 127383, "", 127407, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || item.ds_thuong_tat == null || item.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" data-field=""thuong_tat"" class=""thuong_tat combobox"">Chưa xác định</a>
        ...
        <td class=""tex");
            WriteLiteral("t-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 128471, "", 128474, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 128482, "\"", 128496, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 129028, "", 129031, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 129039, "\"", 129055, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 9){
    for(var");
            BeginWriteAttribute("i", " i =", 129607, "", 129611, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 9 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
        ...
        <td>
            ...
            <%if(tinh_toan.");
            WriteLiteral("dgrr");
            BeginWriteAttribute("!", " !=", 133000, "", 133003, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && tinh_toan.dgrr");
            BeginWriteAttribute("!", " !=", 133031, "", 133034, 0);
            EndWriteAttribute();
            WriteLiteral(" null && tinh_toan.dgrr");
            BeginWriteAttribute("!", " != \"", 133057, "\"", 133062, 0);
            EndWriteAttribute();
            WriteLiteral(" &&");
            BeginWriteAttribute("tinh_toan.dgrr", " tinh_toan.dgrr =", 133066, "", 133083, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""C""){%>
        ...
        <td class=""text-right tblTinhToanVCX_T"">
            <a class=""combobox""><%- ESUtil.format");
            WriteLiteral(@"Money(tinh_toan.giam_gia) %></a>
        </td>
        ...
        <td class=""text-right"">
            <a class=""combobox"" data-field");
            WriteLiteral(@"=""tien_ktru_tien_bh"" data-val=""<%- tinh_toan.tien_ktru_tien_bh %>""><%- ESUtil.formatMoney(tinh_toan.tien_ktru_tien_bh) %></a>
        </td>
        <td class=""text-right"">
            <a class=""combobox"" data-field=""tien_thue"" data-val=""<%- tinh_toan.tien_thue %>""><%- ESUtil.formatMoney(tinh_toan.tien_thue) %></a>
");
            WriteLiteral("        </td>\r\n        <td class=\"text-center\">\r\n            <% if(tinh_toan.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 135709, "", 135712, 0);
            EndWriteAttribute();
            WriteLiteral(" null && tinh_toan.nguyen_nhan");
            BeginWriteAttribute("!", " != \"", 135742, "\"", 135747, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("!", " !=", 136331, "", 136334, 0);
            EndWriteAttribute();
            WriteLiteral(" null && tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " != \"", 136360, "\"", 136365, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 136927, "", 136931, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""tblTinhToanHANGHOAItem"">
        ...
        <td><%- tinh_toan.ten %></td>
        <td class=""text-right"">
            <a class=""combobox"" data-field=""gia_vtu_duyet"" data-val=""<%- tinh_toan.tien_vtu_duyet_pa %>""><%- ESUtil.formatMoney(tinh_toan.tien_vtu_duyet_pa) %><");
            WriteLiteral(@"/a>
        </td>
        <td class=""text-right"">
        ...
        <td class=""text-right wd-110-f"">
            <input type=""text"" data-field=""pt_giam_tru"" class=""dec");
            WriteLiteral(@"imal floating-input"" value=""<%- ESUtil.formatMoney(tinh_toan.pt_giam_tru) %>"" onchange=""tinhToan(this)"" />
        </td>
        <td class=""text-right wd-110-f"">
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("!", " !=", 139792, "", 139795, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 140388, "", 140391, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 141064, "", 141068, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""tblTinhToanNNTXItem"">
      ...
      ");
            WriteLiteral(@"      <input type=""hidden"" data-field=""gia_khac_duyet"" value=""<%- tinh_toan.gia_khac_duyet %>"" />
            <input type=""hidden"" data-field=""tl_giam_gia_vtu"" value=""<%- tinh_toan.tl_giam_gia_vtu %>"" />
            ...
            <input type=""hidden"" data-field=""tl_thue_nhan_cong"" value=""<%- tinh_toan.tl_thue_nhan_cong %>"" />
            <input type=""hidden"" ");
            WriteLiteral(@"data-field=""tl_thue_khac"" value=""<%- tinh_toan.tl_thue_khac %>"" />
            <input type=""hidden"" data-field=""tl_ktru_tien_bh"" value=""<%- tinh_toan.tl_ktru_tien_bh %>"" />
            <input type=""hidden"" data-field=""lh_giam_gia"" value=""<%- tinh_toan.lh_giam_gia %>"" />
            <input type=""hidden"" data-field=""lh_tt_giam_gia"" value=""<%- tinh_toan.lh_tt_giam_gia %>"" />
        ...
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 144047, "", 144076, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || tinh_toan.ds_thuong_tat == null || tinh_toan.ds_thuong_tat == ''){%>
        <td class=""text-center"">
        ...
        <td class=""text-right"">
            <a class=""combobox"" data-field=""gia_duyet"" data-val=""<%- tinh_toan.tien_duyet_pa %>""><%- ESUtil.formatMoney(tinh_toan");
            WriteLiteral(@".tien_duyet_pa) %></a>
        </td>
        <td class=""text-right wd-110-f"">
            <input type=""text"" data-field=""pt_bao_hiem"" class=""decimal floating-input"" value=""<%- ESUtil.formatMoney(tinh_toan.pt_bao_hiem) %>"" onchange=""tinhToan(this)"" />
        </td>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 145679, "", 145682, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 146275, "", 146278, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 146950, "", 146954, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
            WriteLiteral(@"<script type=""text/html"" id=""tblTinhToanLPHU_XETemplate"">
    <% if(tinh_toan_bt.length > 0){
    _.forEach(tinh_toan_bt, function(tinh_toan, index) { %>
...
");
            ...
            <input type=""hidden"" data-field=""tl_thue_nhan_cong"" value=""<%- tinh_toan.tl_thue_nhan_cong %>"" />
            <input type=""hi");
            WriteLiteral(@"dden"" data-field=""tl_thue_khac"" value=""<%- tinh_toan.tl_thue_khac %>"" />
            <input type=""hidden"" data-field=""tl_ktru_tien_bh"" value=""<%- tinh_toan.tl_ktru_tien_bh %>"" />
            <input type=""hidden"" data-field=""lh_giam_gia"" value=""<%- tinh_toan.lh_giam_gia %>"" />
            <input type=""hidden"" data-field=""lh_tt_giam_gia"" value=""<%- tinh_toan.lh_tt_giam_gia %>"" />
            <input type=""hidden"" data-field=""cmnd"" value=""<%- tinh_toan.cmnd %>"" />
        ...
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 149882, "", 149911, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || tinh_toan.ds_thuong_tat == null || tinh_toan.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- tinh_toan.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- tinh_toan.bt %>', '<%- tinh_toan.vu_tt %>', '<%- tinh_toan.lh_nv %>', '<%- tinh_toan.hang_muc %>', '<%- tinh_toan.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 151514, "", 151517, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 152110, "", 152113, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 152785, "", 152789, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""tblTinhToanTNDS_NGUOIItem"">
        <td class=""text-center"">
            ...
            <input type=""hidden"" data-field=""tl_thue_nhan_cong"" value=""<%- tinh_toan.tl_thue_nhan_cong %>"" />
            <input ty");
            WriteLiteral(@"pe=""hidden"" data-field=""tl_thue_khac"" value=""<%- tinh_toan.tl_thue_khac %>"" />
            <input type=""hidden"" data-field=""tl_ktru_tien_bh"" value=""<%- tinh_toan.tl_ktru_tien_bh %>"" />
            <input type=""hidden"" data-field=""lh_giam_gia"" value=""<%- tinh_toan.lh_giam_gia %>"" />
            <input type=""hidden"" data-field=""lh_tt_giam_gia"" value=""<%- tinh_toan.lh_tt_giam_gia %>"" />
            <input type=""hidden"" data-field=""cmnd"" value=""<%- tinh_toan.cmnd %>"" />
        ...
        <td><%- tinh_toan.ten %></td>
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 155716, "", 155745, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || tinh_toan.ds_thuong_tat == null || tinh_toan.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- tinh_toan.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- tinh_toan.bt %>', '<%- tinh_toan.vu_tt %>', '<%- tinh_toan.lh_nv %>', '<%- tinh_toan.hang_muc %>', '<%- tinh_toan.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <%}%>
        <td class=""text-right"">
            <a class=""combobox"" data-field=""gia_duyet"" data-val=""<%- tinh_toan.tien_duyet_pa %>""><%- ESUtil.formatMoney(tinh_toan.t");
            WriteLiteral(@"ien_duyet_pa) %></a>
        </td>
        <td class=""text-right wd-110-f"">
            <input type=""text"" data-field=""pt_bao_hiem"" class=""decimal floating-input"" value=""<%- ESUtil.formatMoney(tinh_toan.pt_bao_hiem) %>"" onchange=""tinhToan(this)"" />
        </td>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 157346, "", 157349, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 157942, "", 157945, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 158617, "", 158621, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""tblTinhToanTNDS_NGUOI_HKItem"">
        <td class=""text-center"">
            ...
            <input type=""hidden"" data-field=""vu_tt"" value=""<%- tinh_toan.vu_tt %>"" />
            <input type=""hidden"" data-field=""gia_vtu_duyet"" value=""<%- tinh_toan.gia_vtu_duyet %>"" />
            <input type=""hidden"" data-field=""gia_nhan_cong_duyet"" value=""<%- tinh_toan.gia_nhan_cong_du");
            WriteLiteral(@"yet %>"" />
            <input type=""hidden"" data-field=""gia_khac_duyet"" value=""<%- tinh_toan.gia_khac_duyet %>"" />
            <input type=""hidden"" data-field=""tl_giam_gia_vtu"" value=""<%- tinh_toan.tl_giam_gia_vtu %>"" />
            <input type=""hidden"" data-field=""tl_giam_gia_nhan_cong"" value=""<%- tinh_toan.tl_giam_gia_nhan_cong %>"" />
            ...
            <input type=""hidden"" data-field=""tl_thue_nhan_cong"" value=""<%- tinh_toan.tl_thue_nhan_cong %>"" />
            <in");
            WriteLiteral(@"put type=""hidden"" data-field=""tl_thue_khac"" value=""<%- tinh_toan.tl_thue_khac %>"" />
            <input type=""hidden"" data-field=""tl_ktru_tien_bh"" value=""<%- tinh_toan.tl_ktru_tien_bh %>"" />
            <input type=""hidden"" data-field=""lh_giam_gia"" value=""<%- tinh_toan.lh_giam_gia %>"" />
            <input type=""hidden"" data-field=""lh_tt_giam_gia"" value=""<%- tinh_toan.lh_tt_giam_gia %>"" />
            <input type=""hidden"" data-field=""cmnd"" value=""<%- tinh_toan.cmnd %>"" />
        ...
        <td><%- tinh_toan.ten %></td>
        <%");
            BeginWriteAttribute("if(tinh_toan.ds_thuong_tat", " if(tinh_toan.ds_thuong_tat =", 161559, "", 161588, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined || tinh_toan.ds_thuong_tat == null || tinh_toan.ds_thuong_tat == ''){%>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- tinh_toan.thuong_tat %>"" data-field=""thuong_tat"" onclick=""nhapThuongTat('<%- tinh_toan.bt %>', '<%- tinh_toan.vu_tt %>', '<%- tinh_toan.lh_nv %>', '<%- tinh_toan.hang_muc %>', '<%- tinh_toan.so_id_doi_tuong %>')"" class=""thuong_tat combobox"">Đánh giá thương tật</a>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 163189, "", 163192, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 163785, "", 163788, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 164460, "", 164464, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
");
        ...
        <td class=""text-right wd-110-f"">
            <input type=""text"" data-field=""pt_giam_tru"" class=""decimal fl");
            WriteLiteral(@"oating-input"" value=""<%- ESUtil.formatMoney(tinh_toan.pt_giam_tru) %>"" onchange=""tinhToan(this)"" />
        </td>
        <td class=""text-right wd-110-f"">
            <input type=""text"" data-field=""tl_thue"" class=""decimal floating-input"" value=""<%- ESUtil.formatMoney(tinh_toan.tl_thue) %>"" onchange=""tinhToan(this)"" />
        </td>
        <td class=""text-center"">
            <% if(tinh_toan.nguyen_nhan_giam");
            BeginWriteAttribute("!", " !=", 167230, "", 167233, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- tinh_toan.nguyen_nhan_giam %>"" onclick=""showNguyenNhan(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Nguyên nhân""></i>
        ...
        <td class=""text-center"">
            <% if(tinh_toan.ghi_chu");
            BeginWriteAttribute("!", " !=", 167826, "", 167829, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- tinh_toan.ghi_chu %>"" onclick=""showGhiChu(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(tinh_toan_bt.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 168501, "", 168505, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 4 - tinh_toan_bt.length;i++ ){
    %>
    <tr>
...
<script type=""text/html"" id=""danhSachNV_template"">
    ...
    <tr class=""row-item"" row-val=""<%- item.ma %>"" row-vcx=""<%- item.vcx %>"">
        ...
        <td class=""text-right""><%- ESUtil.formatMoney(item.tien) %><");
            WriteLiteral("/td>\r\n        <%");
            BeginWriteAttribute("if(item.vcx", " if(item.vcx =", 170939, "", 170953, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VCX'){ %>
        <%if(item.ktru==""K""){%>
...
");
            ...
            BeginWriteAttribute("i", " i =", 175099, "", 175103, 0);
            EndWriteAttribute();
    ...
    <tr class=""tblKhauTruItem"">
        ...
        <td class=""text-center"">
            <% if(item.dkbs");
            BeginWriteAttribute("!", " !=", 176192, "", 176195, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 176760, "", 176764, 0);
            EndWriteAttribute();
...
");
            WriteLiteral("    </tr>\r\n    <% })}%>\r\n    <% if(danh_sach.length < 8){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 180116, "", 180120, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 8 - danh_sach.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:38.2px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n");
            WriteLiteral(@"    </tr>
    <% }} %>
...
<script type=""text/html"" id=""titleMotoCompensa");
            WriteLiteral("tionTemplate\">\r\n    <%");
            BeginWriteAttribute("if(ho_so.so_hs!", " if(ho_so.so_hs!=", 183439, "", 183456, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("ho_so.so_hs.trim()!", " ho_so.so_hs.trim()!= \"", 183464, "\"", 183487, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
");
  ...
  ");
    ...
    <% if(data.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 189046, "", 189050, 0);
            EndWriteAttribute();
...
");
    ...
    <div class=""table-responsive"" style=""height: 355px;"">
        <table class=""table table-bordered fixed-header"">
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh VCXXE"">
                ...
                <%");
            BeginWriteAttribute("if(vcx.lh_tt_giam_gia", " if(vcx.lh_tt_giam_gia =", 190454, "", 190478, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T""){%>
   ...
   ");
            ...
            BeginWriteAttribute("if(vcx.lh_tt_giam_gia", " if(vcx.lh_tt_giam_gia =", 192754, "", 192778, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""S""){%>
            ...
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh TNDSTAI_SAN"">
                ...
                <tr>
                    ...
                    <td class=""te");
            WriteLiteral(@"xt-right font-weight-bold tinhToanNVPATNDS_TSTienTT text-danger""><%- ESUtil.formatMoney(tnds_tsan_khac.gia_duyet_dx) %></td>
                </tr>
                <tr>
                    <td class=""text-center"">1</td>
...
");
            ...
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh TNDSTAI_SAN"">
                ...
                <%");
            BeginWriteAttribute("if(item.lh_tt_giam_gia", " if(item.lh_tt_giam_gia =", 199182, "", 199207, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T""){%>
                <tr class=""tblPhuongAnCTGiamGia_T"">
                    <td class=""text-center"">1</td>
         ...
         ");
            ...
            BeginWriteAttribute("if(item.lh_tt_giam_gia", " if(item.lh_tt_giam_gia =", 201426, "", 201451, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""S""){%>
                <tr class=""tblPhuongAnCTGiamGia_S"">
                    <td class=""text-center"">1</td>
            ...
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh HHHANG_HOA"">
                ...
                <tr>
                    ...
                    <td colspan=""2"" class=""font-weight-bold"">TỔNG TIỀN TỔN THẤT (CHƯA VAT)</td>
   ");
            WriteLiteral(@"                 <td class=""text-right font-weight-bold tinhToanNVPAHHTienTT text-danger""><%- ESUtil.formatMoney(hhoa.gia_duyet_dx) %></td>
                </tr>
                <tr>
                    <td class=""text-center"">1</td>
                    <td colspan=""2"">Số tiền khấu hao</td>
      ...
      ");
            ...
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh NNTXNGUOI"">
                ...
                <tr>
                    <td class=""text-center font-weight-bold"">I</td>
                    <td colspan=""2"" class=""font-weight-bold"">TỔNG TIỀN TỔN T");
            WriteLiteral(@"HẤT (CHƯA VAT)</td>
                ...
                <tr>
                    <td colspan=""3"" class=""font-weight-bold"">TỔNG KHẤU HAO, GIẢM TRỪ</td>
                    <td class=""text-right font-weight-bold tinhToanNVPANNTXTienBoiThuong text-danger""><%- ESUtil.formatMoney(nntx.tong_giam)");
            WriteLiteral(@" %></td>
                </tr>
            </tbody>
            ...
            <tbody class=""table-bang-gia pa_nghiep_vu_bang_tinh TNDSNGUOI_HK"">
                ...
                <tr>
                    ...
                    <td colspan=""2"" class=""font-weight-bold"">TỔNG TIỀN TỔN THẤT (CHƯA VAT)</td>
                    <td class=""text-r");
            WriteLiteral(@"ight font-weight-bold tinhToanNVPATNDS_NGTienTT text-danger""><%- ESUtil.formatMoney(tnds_nguoi_hk.gia_duyet_dx) %></td>
                </tr>
                <tr>
                    <td class=""text-center"">1</td>
                    <td colspan=""2"">Giảm trừ theo tỷ lệ giá trị tham gia</td>
    ...
    <div class=""table-responsive "" style=""height: 113px; bottom: 0px;"">
        <table class=""table table-bordered fixed-header table-bang-gia"">
            <tbody>
                ...
                <tr>
                    <td colspan=""3"" class=""font-weight-bo");
            WriteLiteral(@"ld"">CTYBH CHI TRẢ (BAO GỒM THUẾ)</td>
...
<script type=""text/html"" id=""modalVideoDanhSachDGRRHDTemplate"">
    ...
    <%} else {%>
    <a class=""nav-link rounded videoLinkDGRRHD"" href=""javascript:void(0);"" da");
            WriteLiteral("ta-bt=\"<%- item.bt %>\" onclick=\"xemVideoDGRRHD(\'<%- item.bt %>\')\"><%- item.ten %></a>\r\n    <%}})}%>\r\n</script>\r\n");
        }
