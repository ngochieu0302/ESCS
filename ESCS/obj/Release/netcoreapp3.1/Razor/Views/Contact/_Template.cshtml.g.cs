#pragma checksum "D:\ESCS\ESCS\Views\Contact\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c1dcc752c04f0922b1c7790b6e304aa2847b51e3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c1dcc752c04f0922b1c7790b6e304aa2847b51e3", @"/Views/Contact/_Template.cshtml")]
                        ...
                        <td style=""width:auto"">
                            ...
                            <span class=""float-right"">
                                <a href=""#"" onclick=""chonKhachHangVip(this)"">
                                    <%");
            BeginWriteAttribute("if(ho_so.nhom_kh_vip", " if(ho_so.nhom_kh_vip =", 2994, "", 3017, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
...
<script type=""text/html"" id=""modalCarSearchDsGCNTemplate"">
    ...
    <tr style=""cursor: pointer"" data_ma_chi_nhanh=""<%- item.ma_chi_nhanh %>"" data_so_hdong=""<%- item.so_hdong %>"" data_so_id=""<%- item.so_id_hdong %>"" data_so_id_dt=""<%- item.so_id_gcn %>"" data_loai=""<%- item.loai_gcn %>"" class=""tkiem_kh"" id=""tkiem_kh_<%- item.so_id_hdong %>_<%- item.so_id_gcn %>_<%- item.loai_gcn %>"" onclick=""onChonKhachHang('<%- item.so_id");
            WriteLiteral(@"_hdong %>','<%- item.so_id_gcn %>','<%- item.loai_gcn %>')"">
        <td class=""text-center""><%- item.so_hdong %></td>
        <td class=""text-center""><%- item.bien_so_xe %></td>
        <td class=""text-center"">
            <a href=""#"" onclick=""xemThongTinGiayChungNhan('<%- item.ma_chi_nhanh %>', '<%- item.so_id_hdong %>', '<%- item.so_id_gcn %>', '<%- item.nv %>')""><%- item.so_gcn %></a>
        </td>
        <td class=""text-center"">
            <%if(item.loai_gcn==""TN""){%>
            <span>Tự nguyện</span>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 13885, "", 13889, 0);
            EndWriteAttribute();
