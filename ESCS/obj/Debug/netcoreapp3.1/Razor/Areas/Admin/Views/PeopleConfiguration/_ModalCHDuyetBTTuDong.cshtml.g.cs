#pragma checksum "D:\ESCS\ESCS\Areas\Admin\Views\PeopleConfiguration\_ModalCHDuyetBTTuDong.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6852c6df987dd9b27964cb0797c2b47088daf349"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_PeopleConfiguration__ModalCHDuyetBTTuDong), @"mvc.1.0.view", @"/Areas/Admin/Views/PeopleConfiguration/_ModalCHDuyetBTTuDong.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6852c6df987dd9b27964cb0797c2b47088daf349", @"/Areas/Admin/Views/PeopleConfiguration/_ModalCHDuyetBTTuDong.cshtml")]
    public class Areas_Admin_Views_PeopleConfiguration__ModalCHDuyetBTTuDong : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
<div id=""modalCHDuyetBTTuDong"" class=""modal fade"" data-backdrop=""static"" data-keyboard=""false"" tabindex=""-1"" role=""dialog"">
    <div class=""modal-dialog modal-lg"" style=""max-width:100%"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"" style=""background-color:#54667a0a; padding:0px"">
                <div class=""row p-2"">
                    <div class=""col-2"" style=""padding-right:0px;"">
                        <div cla");
            WriteLiteral(@"ss=""card border mb-0"">
                    ...
                    ");
            WriteLiteral(@"                        <a class=""nav-link active"" data-toggle=""tab"" id=""tabCHDonViBenhVienHSGTMenu"" onclick=""hienThiTabCHDuyetBoiThuong('tabCHDonViBenhVienHSGT')"" role=""tab"" aria-controls=""home"" aria-selected=""true"">
          ...
          ");
            WriteLiteral(@"              <div class=""row p-2 tabCHDonViBenhVienHSGT"" style=""padding-top:0px !important"">
                            ...
                            <div class=""col-5 pl-0"">
                                <div class=""card border mb-0"">
                           ");
            WriteLiteral(@"         <div class=""card-body p-2"" style=""height: 67.5vh;overflow-y: auto;"">
                                        <div>
                        ...
                        <div class=""row p-2 tabCHQuyenLoi"" style=""padding-top:0px !important"">
                            <div class=""col-6 pl-0"">
                                <div class=""card border mb-0"">
                                    <div class=""card-body p-2"" style=""height: 67.5vh;overflow-y: auto;"">
                                ");
            WriteLiteral(@"        <form name=""frmQuyenLoi"" method=""post"">
                                            <div class=""row m-0"">
                                                <div class=""col-8"">
                                        ...
                                        <div sty");
            WriteLiteral(@"le=""margin-top:15px; margin-bottom:15px;"" id=""modalCHPheDuyetBoiThuongTuDongQuyenLoiAD"">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div id=""modal");
            WriteLiteral(@"CHPheDuyetBoiThuongTuDongNhapNgayAD"" class=""modal fade"" data-backdrop=""static"" data-keyboard=""false"" tabindex=""-1"" role=""dialog"">
                        ...
                        <div class=""col col-12"">
                            <div class=""form-group"">
                                ...
                                <div class=""input-group"">
                                    <input type=""text"" class=""form-control datepicker"" autocomplete=""off"" name=""ngay_ad"" disp");
            WriteLiteral(@"lay-format=""date"" value-format=""number"" placeholder=""dd/mm/yyyy"">
  ...
  ");
    ...
    <div class=""modalCHPheDuyetBoiThuongTuDongDviADItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_tat) %>"">
        <div class=""width-dvi"">
            <div class=""custom-control custom-checkbox"">
                <%");
            BeginWriteAttribute("if(item.checked", " if(item.checked =", 12877, "", 12895, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){%>
        ...
        <div class=""width-loai"">
            <div class=""form-group"">
                <select class=""select2 form-control custom-select"" data_ma_dvi=""<%- item.ma %>"" name=""loai"" style=""width:100%; height:20px"">
                    <option");
            BeginWriteAttribute("value", " value=\"", 13716, "\"", 13724, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""modalCHPheDuyetBoiThuongTuDongBVADTemplate"">
    ...
    ");
            ...
            BeginWriteAttribute("if(item.checked", " if(item.checked =", 16011, "", 16029, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){%>
        ...
        <div class=""col-3"">
            <div class=""form-group"">
                <select class=""select2 form-control custom-select"" data_ma_bv=""<%- item.ma %>"" name=""loai_hinh"" style=""width:100%; height:20px"">
                    <option");
            BeginWriteAttribute("value", " value=\"", 16794, "\"", 16802, 0);
            EndWriteAttribute();
            WriteLiteral(@" selected>Chọn loại</option>
...
");
    ...
    <div class=""modalCHPheDuyetBoiThuongTuDongQuyenLoiADItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten) %>"">
        <div class=""width-quyen-loi"">
            <div class=""custom-control custom-checkbox"">
                <%");
            BeginWriteAttribute("if(item.checked", " if(item.checked =", 18146, "", 18164, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){%>
        ...
        <div class=""width-ngay-qloi"">
            <input type=""text"" data_quyen_loi=""<%- item.ma %>"" name=""so_ngay_yc"" style=""height:20px"" class=""number form-");
            WriteLiteral(@"control"" value=""<%- item.so_ngay_yc %>"" placeholder=""Số ngày tối đa"" />
        </div>
    </div>
    <% })}%>
</script>
...
<script type=""text/html"" id=""modalCHPheDuyetBoiThuongTuDongHSGTADTemplate"">
    ...
    <div style=""height:21px;"">
        ...
        <div style=""width:50%; float:left; text-align:right"">
            ...
            WriteLiteral(@"=""chkHienThiHSGTAD"">Đang áp dụng</label>
            </div>
        </div>
    </div>
    <%
    ...
    <div class=""row m-0 modalCHPheDuyetBoiThuongTuDongHSGTItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten) %>"">
        <div class=""col-9 custom-control custom-checkbox"">
            <%");
            BeginWriteAttribute("if(item.checked", " if(item.checked =", 20554, "", 20572, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){%>
        ...
        <div class=""col-3"">
            <div class=""form-group"">
                <select class=""select2 form-control custom-select"" data_hsgt=""<%- item.ma %>"" name=""loai_hinh"" style=""width:100%; height:20px"">
                    <option");
            BeginWriteAttribute("value", " value=\"", 21340, "\"", 21348, 0);
            EndWriteAttribute();
            WriteLiteral(@" selected>Chọn loại</option>
                    <option value=""N"">Nội trú</option>
                    <option value=""G"">Ngoại trú</option>
