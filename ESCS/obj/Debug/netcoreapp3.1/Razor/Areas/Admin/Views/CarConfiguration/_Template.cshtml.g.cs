#pragma checksum "D:\ESCS\ESCS\Areas\Admin\Views\CarConfiguration\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "703fd3c4c2a4dbc81600f5d319f6155c524dd5ce"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"703fd3c4c2a4dbc81600f5d319f6155c524dd5ce", @"/Areas/Admin/Views/CarConfiguration/_Template.cshtml")]
...
");
    ...
    <tr>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("i", " i =", 6673, "", 6677, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""row_item"">
        ...
        <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 8086, "", 8101, 0);
            EndWriteAttribute();
            WriteLiteral("== \'HS\') { %>\r\n        <td style=\"text-align: center;\">\r\n            <div class=\"col-sm-12\">\r\n                <%");
            BeginWriteAttribute("if(item.value", " if(item.value =", 8213, "", 8229, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
        ...
        <% }else");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 9023, "", 9038, 0);
            EndWriteAttribute();
            WriteLiteral("= \'TT\'){ %>\r\n        <td>\r\n            <div>\r\n                <%");
            BeginWriteAttribute("if(item.value", " if(item.value =", 9102, "", 9118, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'T') { %>
        ...
        <% }else");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 10916, "", 10931, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'TL'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 11279, "", 11283, 0);
            EndWriteAttribute();
    ...
    <% if(ds_ngay_ad.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 11950, "", 11954, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 8 - ds_ngay_ad.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:38.2px;\"></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n\r\n");
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 12590, "", 12594, 0);
            EndWriteAttribute();
    ...
    <% if(ds_tien.length < 6){
    for(var");
            BeginWriteAttribute("i", " i =", 13238, "", 13242, 0);
            EndWriteAttribute();
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 14253, "", 14257, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td style=""font-weight: bold; vertical-align: middle;"">
            ...
            Giám định
            <% } else if");
            BeginWriteAttribute("(item.quy_trinh", " (item.quy_trinh =", 14855, "", 14873, 0);
            EndWriteAttribute();
            WriteLiteral("= \'CCCT\'){ %>\r\n            Contact Center\r\n            <% } else if");
            BeginWriteAttribute("(item.quy_trinh", " (item.quy_trinh =", 14940, "", 14958, 0);
            EndWriteAttribute();
            WriteLiteral("= \'CHUNG\'){ %>\r\n            Chung\r\n            <% } else if");
            BeginWriteAttribute("(item.quy_trinh", " (item.quy_trinh =", 15017, "", 15035, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'BT'){ %>
            Bồi thường
            <% } %>
        ...
        <%");
            BeginWriteAttribute("if(item.ma", " if(item.ma =", 15894, "", 15907, 0);
            EndWriteAttribute();
        ...
        <% }
            ...
            BeginWriteAttribute("if(item.ma", " if(item.ma =", 16357, "", 16370, 0);
            EndWriteAttribute();
        ...
        <%}
            ...
            BeginWriteAttribute("if(item.ma", " if(item.ma =", 16716, "", 16729, 0);
            EndWriteAttribute();
            WriteLiteral("= \'PP_TINH_BOI_THUONG\') {%>\r\n        <td style=\"text-align: center;\">\r\n            <div class=\"col-sm-12\">\r\n                <%");
            BeginWriteAttribute("if(item.gia_tri", " if(item.gia_tri =", 16855, "", 16873, 0);
            EndWriteAttribute();
            WriteLiteral(@"== 'T') { %>
                <div class=""form-check"" style=""margin-right:unset"">
        ...
        <td style=""text-align: center; vertical-align: middle;"">
            <div class=""col-sm-12"">
                <%");
            BeginWriteAttribute("if(item.gia_tri", " if(item.gia_tri =", 18841, "", 18859, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
                <div class=""custom-control custom-switch"">
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 19822, "", 19826, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""row_item"">
        ...
        <td style=""text-align: center;"" onclick=""chonHSBatBuoc(this)"">
            <div class=""col-sm-12"">
                <%");
            BeginWriteAttribute("if(item.bat_buoc", " if(item.bat_buoc =", 21273, "", 21292, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
        ...
        <td class=""text-center cursor-pointer"">
            <%if(item.loai");
            BeginWriteAttribute("!", " !=", 22249, "", 22252, 0);
            EndWriteAttribute();
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 22691, "", 22695, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""row_item"">
        ...
        <td style=""text-align: center;"">
            <div class=""col-sm-12"">
                <%");
            BeginWriteAttribute("if(item.tgian_hanh_chinh", " if(item.tgian_hanh_chinh =", 26467, "", 26494, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
                <div class=""custom-control custom-switch"">
    ...
    <% if(data.length < 11){
    for(var");
            BeginWriteAttribute("i", " i =", 27855, "", 27859, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""tblDsNgayCauHinhSLA_template"">
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 28639, "", 28643, 0);
            EndWriteAttribute();
    ...
    <div class=""custom-control custom-checkbox divItemTinhThanh"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_tinh) %>"">
        <% if(item.chon");
            BeginWriteAttribute("!", " !=", 29418, "", 29421, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""modalCHDanhSachQuanHuyenTemplate"">
    ...
    <div class=""custom-co");
            ...
            BeginWriteAttribute("!", " !=", 30572, "", 30575, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined && item.chon) {%>
...
<script type=""text/html"" id=""modalCHDanhSachDonViXuLyTemplate"">
    ...
    <div class=""custom-control custom-checkbox divItemDonViXuLy"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_quan) %>"">
        <% if(item.chon");
            BeginWriteAttribute("!", " !=", 31535, "", 31538, 0);
            EndWriteAttribute();
            WriteLiteral(@"= undefined && item.chon) {%>
...
<script type=""text/html"" id=""tblCauHinhPhanCongTemplate"">
    ...
    <tr>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("i", " i =", 33777, "", 33781, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""tblDanhSachCauHinhPhanCong_template"">
   ...
   ");
            ...
            <a href=""#"" onclick=""suaThongTinCauHinh('<%- item.ma_doi_tac%>','<%- item.ma_tinh%>')"">
                <i class=""fas fa-edit"" title=""Sửa thông tin""></i>
            </a>
        </td>
        <td class=""text-center"">
            <a href=""#"" onclick=""xoaThongTinCauHinh('<%- item.ma_doi_tac%>','<%- item.ma_tinh%>')"">
    ...
    <% if(data.length < 13){
    for(var");
            BeginWriteAttribute("i", " i =", 36370, "", 36374, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""tblCHBenGDMD_template"">
    ...
    <tr>
        ...
        <td class=""text-center cursor-pointer"">
            <a href=""#"" onclick=""openModalGDMD_MQH('<%- item.doi_tuong %>', '<%- item.mac_dinh %>', '<%- item.ma_moi_qhe %>')""><%- item.ma_moi_qhe_ten %></a>
        </td>
        <td style=""text-align: center;"">
            <div class=""col-sm-12"">
                <%");
            BeginWriteAttribute("if(item.mac_dinh", " if(item.mac_dinh =", 37194, "", 37213, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
                <div class=""custom-control custom-switch"">
                    <input type=""checkbox"" checked=""checked"" onchange=""onChangeCHBenGDMD('<%- item.doi_tuong%>','<%- item.ma_moi_qhe%>')"" data-field=""mac_dinh"" name=""mac_dinh"" class=""custom-control-input checkbox"" id=""checkbox_bt_<%- item.doi_tuong%>"">
                    <label class=""custom-control-label"" for=""checkbox_bt_<%- item.doi_tuong%>""></label>
                </div>
                <% } else { %>
                <div class=""custom-control custom-switch"">
                    <input type=""checkbox"" data-field=""mac_dinh"" onchange=""onChangeCHBenGDMD('<%- item.doi_tuong%>','<%- item.ma_moi_qhe%>')"" name=""mac_dinh"" class=""custom-control-input checkbox"" id=""checkbox_bt_<%- item.doi_tuong%>"">
                    <label class=""custom-control-label"" for=""checkbox_bt_<%- item.doi_tuong%>""></label>
                </div>
                <% } %>
            </div>
    ...
    <% if(data.length < ");
            WriteLiteral("8){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 38253, "", 38257, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""modalCauHinhXuLyBoiThuongTemplate"">
    <% if(danh_sach.length > 0){ %>
    <% _.forEach(danh_sach, function(item,index) { %>
    <tr class=""row_item cauHinhXuLyBT"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_tim) %>"">
        <td class=""text-center font-weight-bold"">
            <%- index + 1%>
            <input type=""hidden"" data-field=""ma"" data-val=""<%- item.ma%>"" />
        </td>
        <td class=""text-left font-weight-bold"">
            <%- item.ten %> - <span class=""font-12 font-ita");
            WriteLiteral("lic\">(<%- item.ma%>)</span>\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <div class=\"custom-control custom-switch\">\r\n                <%");
            BeginWriteAttribute("if(item.gdvht", " if(item.gdvht =", 39702, "", 39718, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""C"") {%>
                <input type=""checkbox"" data-field=""gdvht_gdvtt"" id=""gdvht_<%- index %>_<%- item.gdvht%>"" value=""<%- item.gdvht %>"" class=""custom-control-input checkbox gdvht"" checked=""checked"" onchange=""onChonGDVHT(this)"">
                <%}else{%>
                <input type=""checkbox"" data-field=""gdvht_gdvtt"" id=""gdvht_<%- index %>_<%- item.gdvht%>"" value=""<%- item.gdvht %>"" class=""custom-control-input checkbox gdvht"" onchange=""onChonGDVHT(this)"">
                <%}%>
        ...
        <td class=""text-center"">
            <div class=""custom-control custom-switch"">
                <%");
            BeginWriteAttribute("if(item.gdvtt", " if(item.gdvtt =", 40482, "", 40498, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""C"") {%>
                <input type=""checkbox"" data-field=""gdvtt_btv"" id=""gdvtt_<%- index %>_<%- item.gdvtt%>"" value=""<%- item.gdvtt %>"" class=""custom-control-input checkbox gdvtt"" checked=""checked"" onchange=""onChonGDVTT(this)"">
                <%}else{%>
                <input type=""checkbox"" data-field=""gdvtt_btv"" id=""gdvtt_<%- index %>_<%- item.gdvtt%>"" value=""<%- item.gdvtt %>"" class=""custom-control-input checkbox gdvtt"" onchange=""onChonGDVTT(this)"">
                <%}%>
