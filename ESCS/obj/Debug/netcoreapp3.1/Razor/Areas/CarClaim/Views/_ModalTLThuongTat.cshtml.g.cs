#pragma checksum "D:\ESCS\ESCS\Areas\CarClaim\Views\_ModalTLThuongTat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8c2171741d98db474226f87e197373eb12080f4e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_CarClaim_Views__ModalTLThuongTat), @"mvc.1.0.view", @"/Areas/CarClaim/Views/_ModalTLThuongTat.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8c2171741d98db474226f87e197373eb12080f4e", @"/Areas/CarClaim/Views/_ModalTLThuongTat.cshtml")]
    public class Areas_CarClaim_Views__ModalTLThuongTat : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <div class=""modal-dialog modal-lg"" role=""document"" style=""max-width: 85%; margin-top:15px;"">
    ...
    ");
            ...
            WriteLiteral(@" name=""ghi_chu"" autocomplete=""off"" placeholder=""Ghi chú"" class=""form-control"">
                        ...
                        <div class=""col-2"">
                            <button type=""button"" class=""btn btn-primary btn-sm wd-85 float-right"" style=""margin-top:20px"" data-dismiss=""modal"">
                                <i class=""fas fa-window-close mr-1""></i>Đóng
                            </button>
                            <button type=""button"" class=""btn btn-primary btn-sm wd-85 float-right mr-3"" style=""margin-top:20px"" id=""btnLuuTLThuongTat"">
...
<script type=""text/html"" id=""tableTLThuongTatTemplate"">
    ...
    <tr style=""cursor:pointer"">
        ...
        <td>
            <a href=""#"" onclick=""xemTLThuongTat('<%- item.ma_thuong_tat %>', '<%- item.ten_thuong_tat %>', '<%- item.pttt %>', '<%- item.tien_ht %>', '<%- item.ghi_chu %>')""><%- item.ten_thuong_tat %></a>
        </td>
        <td class=""text-center""><%- item.pttt %></td>
        <td class=""text-right""><%- item.tien_ht %></td>
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 5797, "", 5800, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " !=\"", 5821, "\"", 5825, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <% if(data.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 6666, "", 6670, 0);
            EndWriteAttribute();
