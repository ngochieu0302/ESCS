#pragma checksum "D:\ESCS\ESCS\Areas\CarClaim\Views\CarInvestigation\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9aed1101259121dced93df27df4778c39e8d907f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9aed1101259121dced93df27df4778c39e8d907f", @"/Areas/CarClaim/Views/CarInvestigation/_Template.cshtml")]
...
");
    ...
    <tr class=""hmChiTietItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc)%>"">
        ...
        <td class=""text-center"">
            <a href=""#""><i class=""fas fa-trash-alt"" title=""Sửa thông tin"" onclick=""xoaHMTT('<%- item.vu_tt%>', '<%- item.hang_muc%>', '<%- item.so");
            WriteLiteral("_id%>\', \'<%- item.ma_chi_nhanh%>\', \'<%- item.ma_doi_tac%>\')\"></i></a>\r\n        </td>\r\n    </tr>\r\n    <% })}%>\r\n    <% if(danh_sach.length < 8){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 18451, "", 18455, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""hmChiTietItem"">
     ...
     ");
            ...
            BeginWriteAttribute("required", " required=\"", 19984, "\"", 19995, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 20271, "\"", 20282, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 20529, "\"", 20540, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 20802, "\"", 20813, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 21102, "\"", 21113, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 21585, "\"", 21596, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 21727, "", 21730, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 21738, "\"", 21752, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 22284, "", 22287, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 22295, "\"", 22311, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <% if(danh_sach.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 23049, "", 23053, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 8 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        ...
        <td class=""text-center"">
            <% if(");
            WriteLiteral("item.dia_chi");
            BeginWriteAttribute("!", " !=", 24414, "", 24417, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 24438, "\"", 24442, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
        ...
        <td>
            <input type=""text"" class=""floating-input combobox"" data-field=""muc_do"" data-val=""<%- item.muc_do %>"" onclick=""chonMucDoChiTietTonThat(this)"" readonly=""readonly""");
            BeginWriteAttribute("required", " required=\"", 25110, "\"", 25121, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"Click chọn\" value=\"<%- item.muc_do_ten %>\" style=\"text-align:center; cursor:pointer\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"so_luong\" placeholder=\"Số lượng hàng hóa\"");
            BeginWriteAttribute("required", " required=\"", 25368, "\"", 25379, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- ESUtil.formatMoney(item.so_luong) %>"" />
        </td>
        <td>
            <input type=""text"" class=""floating-input combobox"" data-field=""dvi_tinh"" data-val=""<%- item.dvi_tinh %>"" onclick=""chonDViTinhChiTietTonThat(this)"" readonly=""readonly""");
            BeginWriteAttribute("required", " required=\"", 25641, "\"", 25652, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" value=""<%- item.dvi_tinh_ten %>"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td>
            <input type=""text"" class=""floating-input number"" data-field=""gia"" onchange=""onChangeTinhTong(this)"" placeholder=""GT hàng hóa theo đơn vị tính""");
            BeginWriteAttribute("required", " required=\"", 25941, "\"", 25952, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.gia) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number\" data-field=\"so_luong_tt\" onchange=\"onChangeTinhTong(this)\" placeholder=\"Số lượng tổn thất\"");
            BeginWriteAttribute("required", " required=\"", 26182, "\"", 26193, 0);
            EndWriteAttribute();
            ...
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 26567, "", 26570, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 26578, "\"", 26592, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 27124, "", 27127, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 27135, "\"", 27151, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 27882, "", 27886, 0);
            EndWriteAttribute();
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""so_id_doi_tuong_cha"" value=""<%- item.so_id_doi_tuong_cha %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 28779, "\"", 28790, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- item.ten %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""hang_muc"" value=""<%- item.hang_muc %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 29265, "", 29268, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 29289, "\"", 29293, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 29860, "\"", 29871, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 30096, "\"", 30107, 0);
            EndWriteAttribute();
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 30753, "\"", 30764, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 30895, "", 30898, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 30906, "\"", 30920, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 31452, "", 31455, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 31463, "\"", 31479, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 32207, "", 32211, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""so_id_doi_tuong_cha"" value=""<%- item.so_id_doi_tuong_cha %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 33074, "\"", 33085, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- item.ten %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""hang_muc"" value=""<%- item.hang_muc %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 33560, "", 33563, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 33584, "\"", 33588, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            <input type=""text"" class=""floating-input"" data-field=""cmnd""");
            BeginWriteAttribute("required", " required=\"", 34155, "\"", 34166, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"CMT/CCCD\" value=\"<%- item.cmnd %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input combobox\" data-field=\"muc_do\" onclick=\"chonMucDoChiTietTonThat(this)\" readonly=\"readonly\"");
            BeginWriteAttribute("required", " required=\"", 34391, "\"", 34402, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" data-val=""<%- item.muc_do %>"" value=""<%- item.muc_do_ten %>"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td class=""text-center"">
        ...
        <td>
            <input type=""text"" class=""floating-input number"" readonly=""readonly"" onchange=""tinhTongTienNguoi()"" data-field=""tien_tt"" placeholder=""Tiền tổn thất""");
            BeginWriteAttribute("required", " required=\"", 35048, "\"", 35059, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 35190, "", 35193, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 35201, "\"", 35215, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 35747, "", 35750, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 35758, "\"", 35774, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 36502, "", 36506, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
");
    ...
    <tr class=""hmChiTietItem"">
        <td>
            ...
            <input type=""hidden"" class=""floating-input"" data-field=""so_id_doi_tuong_cha"" value=""<%- item.so_id_doi_tuong_cha %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 37379, "\"", 37390, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- item.ten %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""hang_muc"" value=""<%- item.hang_muc %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""vu_tt"" value=""<%- item.vu_tt %>"" />
        ...
        <td class=""text-center"">
            <% if(item.dia_chi");
            BeginWriteAttribute("!", " !=", 37865, "", 37868, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.dia_chi");
            BeginWriteAttribute("!", " !=\"", 37889, "\"", 37893, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""dia_chi"" data-val=""<%- item.dia_chi %>"">
                <i class=""far fa-file-alt"" title=""Địa chỉ""></i>
        ...
        <td>
            <input type=""text"" class=""floating-input"" data-field=""cmnd""");
            BeginWriteAttribute("required", " required=\"", 38460, "\"", 38471, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"CMT/CCCD\" value=\"<%- item.cmnd %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input combobox\" data-field=\"muc_do\" onclick=\"chonMucDoChiTietTonThat(this)\" readonly=\"readonly\"");
            BeginWriteAttribute("required", " required=\"", 38696, "\"", 38707, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" data-val=""<%- item.muc_do %>"" value=""<%- item.muc_do_ten %>"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td class=""text-center"">
        ...
        <td>
            <input type=""text"" class=""floating-input number"" readonly=""readonly"" onchange=""tinhTongTienNguoi()"" data-field=""tien_tt"" placeholder=""Tiền tổn thất""");
            BeginWriteAttribute("required", " required=\"", 39353, "\"", 39364, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.tien_tt) %>\" />\r\n        </td>\r\n        <td class=\"text-center\">\r\n            <% if(item.mo_ta");
            BeginWriteAttribute("!", " !=", 39495, "", 39498, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.mo_ta!", " item.mo_ta!=\"", 39506, "\"", 39520, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showMoTa(this)"" data-field=""mo_ta"" data-val=""<%- item.mo_ta %>"">
                <i class=""far fa-file-alt"" title=""Mô tả""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 40052, "", 40055, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 40063, "\"", 40079, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
            <a href=""#"" class=""cursor-pointer combobox"" onclick=""showGhiChu(this)"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(danh_sach.length < 7){
    for(var");
            BeginWriteAttribute("i", " i =", 40807, "", 40811, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - danh_sach.length;i++ ){
    %>
    <tr>
...
<script type=""text/html"" id=""modalThemTNDS_template"">
    ...
    <tr>
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 41873, "\"", 41884, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 42120, "\"", 42131, 0);
            EndWriteAttribute();
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 42643, "\"", 42654, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\" placeholder=\"Tên địa chỉ\"");
            BeginWriteAttribute("required", " required=\"", 42773, "\"", 42784, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number sl\" placeholder=\"Số lượng\"");
            BeginWriteAttribute("required", " required=\"", 42905, "\"", 42916, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input tinh_trang\" onclick=\"chonTinhTrangTNDS(this, \'TAI_SAN\')\" readonly=\"readonly\"");
            BeginWriteAttribute("required", " required=\"", 43080, "\"", 43091, 0);
            EndWriteAttribute();
            WriteLiteral(" placeholder=\"Click chọn\" style=\"text-align:center; cursor:pointer\" />\r\n");
            WriteLiteral("        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\" placeholder=\"Tiền tổn thất\"");
            BeginWriteAttribute("required", " required=\"", 43519, "\"", 43530, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
        <td>
...
<script type=""text/html"" id=""modalThemTNDSNguoi_template"">
    ...
    <tr>
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 44215, "\"", 44226, 0);
            EndWriteAttribute();
            WriteLiteral(" value=\"<%- ESUtil.formatMoney(item.sl) %>\" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\" placeholder=\"Địa chỉ\"");
            BeginWriteAttribute("required", " required=\"", 44384, "\"", 44395, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("required", " required=\"", 44582, "\"", 44593, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" value=""<%- item.tinh_trang_ten %>"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td class=""text-center"">
            <a href=""#"" data-val=""<%- item.thuong_tat %>"" class=""thuong_tat"" onclick=""danhGiaThuongTat(this)"">
                Đánh giá thương tật (<%-");
            BeginWriteAttribute("item.thuong_tat", " item.thuong_tat=", 44902, "", 44919, 0);
            EndWriteAttribute();
            WriteLiteral("=null?0: item.thuong_tat.split(\',\').length %>)\r\n            </a>\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input number tien_tthat\" placeholder=\"Tiền tổn thất\"");
            BeginWriteAttribute("required", " required=\"", 45113, "\"", 45124, 0);
            EndWriteAttribute();
            WriteLiteral(@" value=""<%- ESUtil.formatMoney(item.tien_tthat) %>"" />
        </td>
    ...
    <tr>
        <td>
            <input type=""text"" class=""floating-input ten"" placeholder=""Tên đối tượng""");
            BeginWriteAttribute("required", " required=\"", 45638, "\"", 45649, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" class=\"floating-input number sl\" value=\"1\"");
            BeginWriteAttribute("required", " required=\"", 45730, "\"", 45741, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input dchi\" placeholder=\"Địa chỉ\"");
            BeginWriteAttribute("required", " required=\"", 45856, "\"", 45867, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n        </td>\r\n        <td>\r\n            <input type=\"text\" class=\"floating-input tinh_trang\" onclick=\"chonTinhTrangTNDS(this, \'NGUOI\')\" readonly=\"readonly\"");
            BeginWriteAttribute("required", " required=\"", 46029, "\"", 46040, 0);
            EndWriteAttribute();
            WriteLiteral(@" placeholder=""Click chọn"" style=""text-align:center; cursor:pointer"" />
        </td>
        <td class=""text-center"">
        ...
        <td>
            ...
            BeginWriteAttribute("required", " required=\"", 46408, "\"", 46419, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        </td>
...
<script type=""text/html"" id=""dsBenThamGiaGiamDinhTemplate"">
    ...
    <% if(danh_sach.l");
            ...
            BeginWriteAttribute("i", " i =", 47468, "", 47472, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""divP");
    ...
    <div class=""custom-control custom-checkbox mt-1 div-plhm-mucdo-item"" plhm-div-ma=""<%- item.ma %>"" plhm-mucdo-nv=""<%- item.nv %>"" plhm-mucdo-nhom=""<%- item.nhom %>"">
        ...
        <label class=""custom-control-l");
            ...
            BeginWriteAttribute("!", " !=", 49653, "", 49656, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.children");
            BeginWriteAttribute("!", " !=", 49683, "", 49686, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""tblDanhSachVuTonThatTemplate"">
    ...
    <tr style=""cursor: pointer"" id=""ds_vu_ton_that_<%- item.vu_tt %>"" class=""ds_vu_ton_that"" onclick=""xemChiTietVuTonThat('<%- item.vu_tt %>')"">
        <td>
            <%");
            BeginWriteAttribute("if(item.pham_vi", " if(item.pham_vi =", 54958, "", 54976, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""0""){
            %>
...
<script type=""text/html"" id=""modalCarSearchDsGCNTemplate"">
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 56791, "", 56795, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""danh_gia_hien_truong_template"">
    ...
    <%");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 57204, "", 57219, 0);
            EndWriteAttribute();
            WriteLiteral("= \'RADIO\'){ %>\r\n    <div class=\"col-6 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 57313, "", 57337, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <label class=\"_required\"><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 57526, "", 57542, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
            ...
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 58240, "", 58256, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
                <div class=""form-check form-check-inline ml-3"" style=""margin-right:unset"">
    ...
    <% }else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 58808, "", 58823, 0);
            EndWriteAttribute();
            WriteLiteral("= \'CHECKBOX\'){ %>\r\n    <div class=\"col-6 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 58920, "", 58944, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <label class=\"_required\"><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 59133, "", 59149, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 59686, "\"", 59694, 0);
            EndWriteAttribute();
            WriteLiteral("><%- item.ten_loai %></label>\r\n            <div class=\"row\">\r\n                <% _.forEach(data, function(item1,index1){ %>\r\n                <%");
            BeginWriteAttribute("if(item1.loai", " if(item1.loai =", 59838, "", 59854, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item.loai){ %>
                <div class=""custom-control custom-checkbox ml-3"">
    ...
    <% }else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 60399, "", 60414, 0);
            EndWriteAttribute();
            WriteLiteral("= \'TEXTAREA\'){ %>\r\n    <%");
            BeginWriteAttribute("if(item.kieu_loai", " if(item.kieu_loai =", 60439, "", 60459, 0);
            EndWriteAttribute();
            WriteLiteral("= \'col4\'){ %>\r\n    <div class=\"col-4 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 60552, "", 60576, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
    ...
    <% } else");
            BeginWriteAttribute("if(item.kieu_loai", " if(item.kieu_loai =", 61275, "", 61295, 0);
            EndWriteAttribute();
            WriteLiteral("= \'col12\'){ %>\r\n    <div class=\"col-12 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 61390, "", 61414, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
    ...
    <% } %>
    <% } else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 62126, "", 62141, 0);
            EndWriteAttribute();
            WriteLiteral("= \'TEXT\'){ %>\r\n    <div class=\"col-4 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 62234, "", 62258, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 62615, "\"", 62623, 0);
            EndWriteAttribute();
            WriteLiteral(@"><%- item.ten_loai %></label>
            <div class=""input-group"">
    ...
    <% } else");
            BeginWriteAttribute("if(item.kieu", " if(item.kieu =", 62944, "", 62959, 0);
            EndWriteAttribute();
            WriteLiteral("= \'NUMBER\'){ %>\r\n    <%");
            BeginWriteAttribute("if(item.an_hien", " if(item.an_hien =", 62982, "", 63000, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n    <div class=\"col-12 mb-2\">\r\n        <div class=\"form-group\">\r\n            <%");
            BeginWriteAttribute("if(item.bat_buoc_nhap", " if(item.bat_buoc_nhap =", 63089, "", 63113, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){ %>
            <label class=""_required""><%- item.ten_loai %></label>
            <div class=""input-group"">
            ...
            <% }else{ %>
            <label");
            BeginWriteAttribute("class", " class=\"", 63477, "\"", 63485, 0);
            EndWriteAttribute();
            WriteLiteral(@"><%- item.ten_loai %></label>
            <div class=""input-group"">
...
<script type=""text/html"" id=""danhSachNV_template"">
    ...
    _.forEach(lhnv, function(item,index) { %>");
            ...
            BeginWriteAttribute("if(item.vcx", " if(item.vcx =", 65785, "", 65799, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VCX'){ %>
        <%if(item.ktru==""K""){%>
...
<script type=""text/html"" id=""dsDoiTuongTTTemplate"">
    ...
    <tr class=""item_so_id_doi_tuong"" data-so-id-doi-tuong=""<%- item.so_id_doi_tuong %>""");
        ...
        <td class=""text-cente");
            WriteLiteral("r\">\r\n            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 69523, "", 69526, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " !=\'", 69547, "\'", 69551, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    <% if(data.length < 8){
    for(var");
            BeginWriteAttribute("i", " i =", 70350, "", 70354, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""titleUpdateContractTemplate"">
   ");
            WriteLiteral(" <%");
            BeginWriteAttribute("if(ho_so.so_hs!", " if(ho_so.so_hs!=", 71381, "", 71398, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("ho_so.so_hs.trim()!", " ho_so.so_hs.trim()!= \"", 71406, "\"", 71429, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
...
");
    ...
    <tr data-ma-gara=""<%- bao_gia.gara %>"" data-so-id-doi-tuong=""<%- bao_gia.so_id_doi_tuong %>"" data-bt-gara=""<%- bao_gia.bt_gara %>"">
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.so_id_pa", " if(bao_gia.so_id_pa =", 77368, "", 77390, 0);
            EndWriteAttribute();
            ...
            <%}else");
            BeginWriteAttribute("if(bao_gia.chon_pa_trinh", " if(bao_gia.chon_pa_trinh =", 78050, "", 78077, 0);
            EndWriteAttribute();
        ...
        <td class=""text-center"" style=""width:60px"">
            <%");
            BeginWriteAttribute("if(bao_gia.trang_thai", " if(bao_gia.trang_thai =", 80935, "", 80959, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 81672, "", 81676, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""garaBaoGiaCT_template"">
    ...
    <tr class=""gara_bg_ctiet"" data-search=""<%- ESUtil.xoaKhoangTrangText(bao_gia.ten_hang_muc) %>"">
        ...
        <%}else");
            BeginWriteAttribute("if(bao_gia.loai_hang_muc", " if(bao_gia.loai_hang_muc =", 84739, "", 84766, 0);
            EndWriteAttribute();
            WriteLiteral(@"= ""B""){%>
        <td>
            <input type=""hidden"" name=""loai_hang_muc"" value=""<%- bao_gia.loai_hang_muc %>"" />
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(bao_gia.thay_the_sc", " if(bao_gia.thay_the_sc=", 87466, "", 87490, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""T"") {%>
        ...
        <td class=""text-center"">
            <% if(bao_gia.ghi_chu");
            BeginWriteAttribute("!", " !=", 90511, "", 90514, 0);
            EndWriteAttribute();
            WriteLiteral(" null && bao_gia.ghi_chu");
            BeginWriteAttribute("!", " != \"", 90538, "\"", 90543, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
