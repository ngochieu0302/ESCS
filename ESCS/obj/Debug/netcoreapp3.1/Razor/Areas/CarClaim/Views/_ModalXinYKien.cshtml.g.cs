#pragma checksum "D:\ESCS\ESCS\Areas\CarClaim\Views\_ModalXinYKien.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "14f44b97a5162a7cf4f1928dea2bf10385cc4035"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"14f44b97a5162a7cf4f1928dea2bf10385cc4035", @"/Areas/CarClaim/Views/_ModalXinYKien.cshtml")]
...
<script type=""text/html"" id=""tblDsLanYKienBodyTemplate"">
    ...
    <% if(data.length < 10){
    for(var");
            BeginWriteAttribute("i", " i =", 22998, "", 23002, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""ModalXinYKienNoiDungTemplate"">
    ...
    _.forEach(danh_sach, function(item,index) { %>
    <%");
            BeginWriteAttribute("if(item.trang_thai_cho_yk", " if(item.trang_thai_cho_yk =", 23286, "", 23314, 0);
            EndWriteAttribute();
            WriteLiteral("= \'QUA_HAN\'){ %>\r\n    <p class=\"text-danger mg-0\"><i><%- item.ngay_hthi %> :</i></p>\r\n    <% }else");
            BeginWriteAttribute("if(item.trang_thai_cho_yk", " if(item.trang_thai_cho_yk =", 23412, "", 23440, 0);
            EndWriteAttribute();
