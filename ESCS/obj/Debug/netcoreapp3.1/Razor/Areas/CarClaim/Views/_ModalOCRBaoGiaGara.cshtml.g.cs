#pragma checksum "D:\ESCS\ESCS\Areas\CarClaim\Views\_ModalOCRBaoGiaGara.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c0d09adafb34ab3ccd63e562ac30354eb760bdc8"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c0d09adafb34ab3ccd63e562ac30354eb760bdc8", @"/Areas/CarClaim/Views/_ModalOCRBaoGiaGara.cshtml")]
...
<div id=""modalDocOCRBaoGiaGara"" class=""modal fade"" data-backdrop=""static"" data-keyboard=""false"" role=""dialog"" aria-hidden=""true"">
    <div class=""modal-dialog"" style=""max-width: 98%; margin:10px auto;"">
        <div class=""modal-content"">
            ...
            WriteLiteral(@" class=""modal-title"">
                    Gara sửa chữa
                    <a href=""#"" data-val="""" data-so-id-doi-tuong="""" class=""font-14 ten_gara_sua_chua"" onclick=""showChonGaraBaoGia(this)"">(Chọn gara sửa chữa)</a>
                </h5>
                <button type=""button"" class=""close"" data-dismiss=""modal"" aria-hidden=""true"">×</button>
            </div>
            ...
            WriteLiteral(@" />
                ...
                <div class=""row"">
                    <div class=""col-10 px-1"">
                        <div class=""table-responsive"" style=""max-height:590px;"">
                            <table id=""tableDuLieuOCRBaoGiaGara"" class=""table table-bordered"" style=""width: 100%; border-collapse: separate; border-spacing: 0;"">
 ...
 ");
            WriteLiteral(@"                                       <th rowspan=""2"" style=""width: 50px;"">Tỉ lệ khớp</th>
                                        <th rowspan=""2"" style=""width: 40px;""></th>
                                    </tr>
                                    <tr class=""text-center uppercase"">
                                        <th style=""width: 250px;"">Hạng mục</th>
...
");
            WriteLiteral(@"                        <div class=""card m-0"">
                            <div class=""card-body p-0"">
                                <div class=""border rounded"">
                                    ...
                                    <div class=""container-fluid scrollable p-2"" id=""dsAnhBaoGiaGara"" style=""he");
            WriteLiteral(@"ight: 520px;"">
                        ...
                        <div class=""container-fluid"">
                            <div class=""row text-center"">
                                <div class=""btn-group btn-group-justified"" role=""group"">
                                    ...
                                    <button type=""button"" class=""btn-sm wd");
            WriteLiteral(@"-60 btn-outline-primary"" data-toggle=""tooltip"" title=""In ảnh báo giá"" id=""btnInAnhBaoGia"">
            ...
            <div class=""modal-footer px-1"" style=""display:block"">
                ...
                <button type=""button"" class=""btn btn-primary btn-sm wd-130 f");
            WriteLiteral(@"loat-right"" id=""btnDocOCRBaoGia"">
...
<div id=""modalChonLoaiTien"" class=""modal-drag"" style=""width:250px; z-index:9999999; left: 120px;"">
    ...
    <div class=""modal-drag-footer"" style=""height: 30px; border-top: 1px solid #eaeaea; ma");
            WriteLiteral(@"rgin:0px 0px 10px 0px;"">
...
<div id=""modalBaoGiaChonHangMucTonThat"" class=""modal-drag"" style=""width: 450px; z-index: 9999999; margin-top: 48px; margin-left: 745px;"">
    ...
    <div class=""modal-drag-content"" style=""padding-top:5px;"">
        <ul class=""nav nav-pills d-none"" id=""navHangMucContent"" role=""tablist"" style=""background-color: #f2f2f2;"">
            <li class=""nav-item font-weight-bold p-1"" style=""w");
            WriteLiteral(@"idth: 100%; text-align: center;"">
            ...
            <div class=""tab-pane active p-0"" role=""tabpanel"" id=""tabBaoGiaHangMucGiamDinh"">
                <div class=""card-body p-0"">
                    <div class=""col-12 p-0"">
                        <div class=""input-group"">
                            <input type=""text"" ");
            WriteLiteral("class=\"form-control\" id=\"inputTimKiemHangMucGiamDinh\" autocomplete=\"off\" placeholder=\"Tìm kiếm hạng mục\"");
            BeginWriteAttribute("value", " value=\"", 13964, "\"", 13972, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
   ...
   ");
            ...
            BeginWriteAttribute("value", " value=\"", 15241, "\"", 15249, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
...
<div id=""popoverThemBaoGiaBaoGia"" class=""popover popover-x popover-default"" style=""display: none; width: 450px; max-widt");
    ...
    <div class=""popover-body popover-content"">
        <form name=""frmThemGaraBaoGia"" id=""frmThemGaraBaoGia"" method=""post"">
            ...
            BeginWriteAttribute("value", " value=\"", 16710, "\"", 16718, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" name=\"so_id\"");
            BeginWriteAttribute("value", " value=\"", 16769, "\"", 16777, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" name=\"bt_gara\"");
            ...
            <div class=""row"" style=""margin-top:8px"">
                ...
                <div class=""col-6"">
                    <div class=""form-group"">
                        ...
                        <div class=""input-group"">
                            ");
            WriteLiteral(@"<input type=""text"" class=""form-control datepicker"" autocomplete=""off"" display-format=""date"" value-format=""number"" required name=""ngay_bg"" placeholder=""mm/dd/yyyy"">
                            <div class=""input-group-append"">
...
");
    ...
    <tr class=""dsBaoGiaGaraOCRItem"" data-search=""<%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_ocr) %>"" data-rowindex=""<%- index + 1 %>"">
        ...
        <td>
            <input type=""text"" data-field=""ten_hang_muc"" class=""floating-input hang_muc"" title=""<%- item.ten_hang_muc %>"" data-val=""<%- item.ten_hang_muc %>"" value=""<%- ESUtil.rutGonText(45, item.ten_hang_muc) %>"">
        </td>
        <td class=""text-center"">
        ...
        ");
            ...
            <%}else{%>
            <div class=""custom-control custom-checkbox custom-control-inline mr-2"">
                <input class=""custom-control-input TIEN_VAT_TU_<%- ESUtil");
            WriteLiteral(@".xoaKhoangTrangText(item.ten_hang_muc_he_thong) %> <%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_he_thong) %>"" data-field=""loai_tien"" type=""checkbox"" data-text=""<%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_he_thong) %>"" id=""TIEN_VAT_TU_<%- item.ma_hang_muc_he_thong%>_<%- index + 1%>"" data-val=""TIEN_VAT_TU"" value=""TIEN_VAT_TU"" onclick=""chonLoaiTien(this,'TIEN_VAT_TU', '<%- item.ma_hang_muc_he_thong%>','<%- index + 1%>')"">
                <label class=""custom-control-label"" for=""TIEN_VAT_TU_<%- item.ma_hang_muc_he_thong %>_<%- index + 1%>"">Vật tư</label>
            </div>
            <%}%>
            <%if(item.loai_tien == 'TIEN_NHAN_CONG'){%>
            <div class=""custom-control custom-checkbox custom-control-inline mr-2"">
                <input class=""custom-control-input TIEN_NHAN_CONG_<%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_he_thong) %> <%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_he_thong) %>"" data-field=""loai_tien"" type=""checkbox"" data-text=""<%- ESUtil.xoaKhoangTrangText(item.ten");
            WriteLiteral(@"_hang_muc_he_thong) %>"" id=""TIEN_NHAN_CONG_<%- item.ma_hang_muc_he_thong%>_<%- index + 1%>"" data-val=""TIEN_NHAN_CONG"" value=""TIEN_NHAN_CONG"" onclick=""chonLoaiTien(this,'TIEN_NHAN_CONG', '<%- item.ma_hang_muc_he_thong%>', '<%- index + 1%>')"" checked=""checked"">
                <label class=""custom-control-label"" for=""TIEN_NHAN_CONG_<%- item.ma_hang_muc_he_thong%>_<%- index + 1%>"">Nhân công</label>
            </div>
            <%}else{%>
            <div class=""custom-control custom-checkbox custom-control-inline mr-2"">
                <input class=""custom-control-input TIEN_NHAN_CONG_<%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_he_thong) %> <%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_he_thong) %>"" data-field=""loai_tien"" type=""checkbox"" data-text=""<%- ESUtil.xoaKhoangTrangText(item.ten_hang_muc_he_thong) %>"" id=""TIEN_NHAN_CONG_<%- item.ma_hang_muc_he_thong%>_<%- index + 1%>"" data-val=""TIEN_NHAN_CONG"" value=""TIEN_NHAN_CONG"" onclick=""chonLoaiTien(this,'TIEN_NHAN_CONG', '<%- item.ma_hang_muc_he_thong%");
            ...
            <%}else{%>
   ");
            WriteLiteral(@"         <div class=""custom-control custom-checkbox custom-control-inline mr-2"">
        ...
        <%if(item.mapping == ""1""){%>
        <td class=""text-left"">
            <a class=""combobox cursor-pointer"" onclick=""capNhatThongTinHangMucOCR(this)"" href=""#"" data-field=""ten_hang_muc_he_thong"" title=""<%- item.ten_hang_muc_he_thong %>"" data-ma=""<%- item.ma_hang");
            WriteLiteral(@"_muc_he_thong %>"" data-val=""<%- item.ten_hang_muc_he_thong %>""><%- ESUtil.rutGonText(50, item.ten_hang_muc_he_thong) %></a>
        </td>
        <%}else{%>
        <td class=""text-left"">
        ...
        <td class=""text-right"">
            <input type=""text"" data-field=""tien_duyet"" onchange=""onChangeSoTienDuyet(t");
            WriteLiteral(@"his)"" class=""number floating-input"" data-val=""<%- item.tien_duyet %>"" value=""<%- ESUtil.formatMoney(item.tien_duyet) %>"">
        </td>
        <td class=""text-center"">
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 28612, "", 28616, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""modalDanhSachHangMucGiamDinhTemplate"">
    ...
    <% _.forEach(data, function(item,index) { %>
    <% var");
            BeginWriteAttribute("check", " check =", 29910, "", 29918, 0);
            EndWriteAttribute();
