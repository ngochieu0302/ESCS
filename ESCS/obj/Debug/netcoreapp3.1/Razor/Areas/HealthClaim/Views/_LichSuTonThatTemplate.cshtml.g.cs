#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\_LichSuTonThatTemplate.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dc2afd8fab74c1f3bcd2d2049166e4a1ca51a60f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dc2afd8fab74c1f3bcd2d2049166e4a1ca51a60f", @"/Areas/HealthClaim/Views/_LichSuTonThatTemplate.cshtml")]
...
<script type=""text/html"" id=""tblLichSuTonThatConNguoiGroup_template"">
  ...
  ");
            WriteLiteral("  <% if(arrHoSo.length < 11){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 3817, "", 3821, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 11 - arrHoSo.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n\r\n");
    ...
    <% if(data.length < 4){
    for(var");
            BeginWriteAttribute("i", " i =", 4669, "", 4673, 0);
            EndWriteAttribute();
    ...
    <tr class=""text-center lichSuTonThat"" id=""lichSuTonThat_<%- item.so_id %>_<%- item.lhnv %>"" data-search=""<%- item.nd_tim %>"">
        ...
        <td>
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 5247, "", 5262, 0);
            EndWriteAttribute();
            WriteLiteral("= \'HSTT\'){ %>\r\n            <a href=\"#\" onclick=\"TransReceiveDisplay(\'<%- item.ma_doi_tac%>\',\'<%- item.so_id%>\')\"><%- item.so_hs %></a>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 5431, "", 5446, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'BLVP'){ %>
            <a href=""#"" onclick=""TransHealthguaranteeDisplay('<%- item.ma_doi_tac%>','<%- item.so_id%>')""><%- item.so_hs %></a>
            <%}%>
        ...
        <td class=""text-center"">
            <% if(item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 6401, "", 6404, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.nguyen_nhan");
            BeginWriteAttribute("!", " != \'", 6429, "\'", 6434, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 6455, "", 6458, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
            <a href=""#"" data-field=""nguyen_nhan"" data-val=""<%- item.nguyen_nhan %>"" onclick=""showNguyenNhanGiamTru(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Lý do giảm trừ""></i>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 7061, "", 7064, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " != \'", 7085, "\'", 7090, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 7107, "", 7110, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
            <a href=""#"" data-field=""ghi_chu"" data-val=""<%- item.ghi_chu %>"" onclick=""showGhiChuLSTT(this)"" class=""cursor-pointer combobox"">
                <i class=""far fa-file-alt"" title=""Ghi chú""></i>
    ...
    <% if(arrHoSo.length < 11){
    for(var");
            BeginWriteAttribute("i", " i =", 7680, "", 7684, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 11 - arrHoSo.length;i++ ){
    %>
    <tr>
...
");
    ...
    <% if(arrHoSo.length < 11){
    for(var");
            BeginWriteAttribute("i", " i =", 8822, "", 8826, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 11 - arrHoSo.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n\r\n");
        }
