#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\HealthCompensation\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "66cd2f37cc0e8c4f13c6581262dcb319a39bc5cb"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"66cd2f37cc0e8c4f13c6581262dcb319a39bc5cb", @"/Areas/HealthClaim/Views/HealthCompensation/_Template.cshtml")]
...
");
    ...
    <tr>
        ...
        <td style=""font-");
            ...
            BeginWriteAttribute("pd", " pd =", 15261, "", 15266, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""dsDieuKhoanBoSung_template"">
    <% _.forEach(data, function(item,index) { %>
    <% var");
            BeginWriteAttribute("thu_tu_cha_con", " thu_tu_cha_con =", 16603, "", 16620, 0);
            EndWriteAttribute();
            WriteLiteral(" item.lh_nv.split(\'.\').length - 1 %>\r\n    <%");
            BeginWriteAttribute("if(thu_tu_cha_con", " if(thu_tu_cha_con =", 16664, "", 16684, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
    <tr>
    ...
    <% } else{ %>
    <% var");
            BeginWriteAttribute("pd", " pd =", 17378, "", 17383, 0);
            EndWriteAttribute();
            WriteLiteral(@" thu_tu_cha_con * 15 %>
    <tr>
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 18160, "", 18164, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""dsGhiChuKhac_template"">
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 18769, "", 18773, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 14 - data.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n\r\n");
    ...
    <tr class=""text-center lichSuTonThat"" id=""lichSuTonThat_<%- item.so_id %>_<%- item.lhnv %>"">
        ...
        <td>
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 19262, "", 19277, 0);
            EndWriteAttribute();
            WriteLiteral("= \'HSTT\'){ %>\r\n            <a href=\"#\" onclick=\"TransReceiveDisplay(\'<%- item.ma_doi_tac%>\',\'<%- item.so_id%>\')\"><%- item.so_hs %></a>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 19446, "", 19461, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'BLVP'){ %>
        ...
        <td class=""text-center"">
            <% if(item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 20363, "", 20366, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.nguyen_nhan");
            BeginWriteAttribute("!", " != \'", 20391, "\'", 20396, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 20417, "", 20420, 0);
            EndWriteAttribute();
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 21023, "", 21026, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " != \'", 21047, "\'", 21052, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 21069, "", 21072, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 21642, "", 21646, 0);
            EndWriteAttribute();
...
");
    ...
    <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 22616, "", 22631, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td style=""text-align: center"">
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 26105, "", 26126, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
                ...
                <% }else");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 26423, "", 26444, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'D'){ %>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 26850, "", 26868, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" disabled=""disabled"" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 27169, "\"", 27175, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% }else{ %>\r\n            <%");
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 27253, "", 27270, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"hop_le_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 27473, "\"", 27481, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 27852, "\"", 27860, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label"" for=""hop_le_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 28142, "", 28160, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            ...
            <a href=""#"" data-field=""loai"" data-val=""<%- item.loai %>"" onclick=""chonLoaiHSGT(this)"" id=""loai_hsgt_<%- item.ma_hs %>"">
                <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 28493, "\'", 28498, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 28512, "", 28515, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n                <%- item.loai_ten %>\r\n                <% }else{ %>\r\n                Chọn loại hồ sơ\r\n                <% } %>\r\n            </a>\r\n            <% } %>\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 28717, "", 28738, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""C"")
        {
        if(item.chon==1)
        ...
        <td style=""text-align: center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 31159, "", 31162, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 31183, "", 31186, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
...
");
    ...
    <tr>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("i", " i =", 33236, "", 33240, 0);
            EndWriteAttribute();
...
");
    ...
    <tr>
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("i", " i =", 34848, "", 34852, 0);
            EndWriteAttribute();
...
");
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 36037, "", 36041, 0);
            EndWriteAttribute();
    ...
    for(var");
        ...
        <td>
            ...
            BeginWriteAttribute("!", " !=\'", 39494, "\'", 39498, 0);
            EndWriteAttribute();
            WriteLiteral(@"){%>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 40117, "", 40120, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 40128, "\"", 40144, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 40853, "", 40857, 0);
            EndWriteAttribute();
...
");
            ...
            BeginWriteAttribute("if(index", " if(index =", 42262, "", 42273, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
...
");
            ...
            BeginWriteAttribute("value", " value=\"", 44318, "\"", 44326, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"don_gia\"");
            BeginWriteAttribute("value", " value=\"", 44385, "\"", 44393, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"dvi_tinh\"");
            BeginWriteAttribute("value", " value=\"", 44453, "\"", 44461, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"ghi_chu\"");
            BeginWriteAttribute("value", " value=\"", 44520, "\"", 44528, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 45340, "", 45343, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 45370, "", 45373, 0);
            EndWriteAttribute();
       ...
       ");
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 48465, "", 48468, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 48495, "", 48498, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 49718, "", 49722, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - data.length;i++ ){
    %>
    <tr>
...
");
            ...
            BeginWriteAttribute("value", " value=\"", 50182, "\"", 50190, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"don_gia\"");
            BeginWriteAttribute("value", " value=\"", 50249, "\"", 50257, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"dvi_tinh\"");
            BeginWriteAttribute("value", " value=\"", 50317, "\"", 50325, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma"" value=""<%- item.ma %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma_ct"" value=""<%- item.ma_ct %>"" />
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 51017, "", 51020, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 51571, "", 51574, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 51601, "", 51604, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 52823, "", 52827, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 7 - data.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n\r\n\r\n");
        }
