#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\HealthCompensation\_ModalNguyenNhanGiamTru.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bd5b170ad79d9c100ef94a23a31b7f525b4bd94f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_HealthClaim_Views_HealthCompensation__ModalNguyenNhanGiamTru), @"mvc.1.0.view", @"/Areas/HealthClaim/Views/HealthCompensation/_ModalNguyenNhanGiamTru.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bd5b170ad79d9c100ef94a23a31b7f525b4bd94f", @"/Areas/HealthClaim/Views/HealthCompensation/_ModalNguyenNhanGiamTru.cshtml")]
    public class Areas_HealthClaim_Views_HealthCompensation__ModalNguyenNhanGiamTru : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <div class=""modal-drag-footer"" style=""height: 32px; border-top: 1px solid #eaeaea; margin:0px 0px 10px 0px;"">
        <button type=""button");
            WriteLiteral(@""" class=""btn-outline-primary btn-sm wd-85"" id=""btnBoChonNguyenNhanGiamTru"">
...
<script type=""text/html"" id=""modalChonNguyenNhanGiamTruDanhSachTemplate"">
    ...
    <div class=""custom-control custom-checkbox nngt"" id=""nngt_<%- item.ma %>"">
        <input type=""checkbox"" id=""nguyen_nhan_giam_tru_<%- item.ma %>"" value=""<%- item.ma %>"" class=""custom-control-input modalChonNguyenNhanGiamTruItem single_checked"">
