#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\_HealthClaimCompareData.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cfcd2ca09c2ef2a754e9e7ff0163c230e980072a"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_HealthClaim_Views__HealthClaimCompareData), @"mvc.1.0.view", @"/Areas/HealthClaim/Views/_HealthClaimCompareData.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cfcd2ca09c2ef2a754e9e7ff0163c230e980072a", @"/Areas/HealthClaim/Views/_HealthClaimCompareData.cshtml")]
    public class Areas_HealthClaim_Views__HealthClaimCompareData : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
                ...
                <div class=""row"" style=""margin:0; padding:0"">
                    <div class=""col-9 p-1"">
                        <div class=""card mb-0 modal-main-content"">
                            <div class=""card-bo");
            WriteLiteral(@"dy px-0"" style=""padding-top:0 !important"">
              ...
              ");
            WriteLiteral(@"                                                  <th style=""width: 150px;"">TÊN</th>
                                                    ...
                                                    <table class=""table"">
                                                        <thead>
                                                            <tr class=""text-center"">
                                                                <th style=""width: 200px;"">Tê");
            WriteLiteral(@"n dịch vụ</th>
                            ...
                            <div class=""card-body p-0"">
                                <div class=""border rounded"">
                                    <div class=""modal-tai-lieu"">
                                        <ul class=""nav nav-pills"" id=""navOCRGiayToContent"" role=""tablist"" sty");
            WriteLiteral(@"le=""background-color: #f2f2f2;"">
      ...
      ");
            WriteLiteral(@"                                      </li>
                                        ...
                                        <div class=""tab-content"" style=""border: unset;"">
                                            ...
                                            <div class=""tab-pane active p-0"" role=""tabpanel"" id=""tabThongTinHinhAnhOCR"">
                                                <div class=""t");
            WriteLiteral(@"ext-left p-1 card-title-bg font-weight-bold border-bottom"">
        ...
        ");
            ...
            <div class=""modal-footer"" style=""display: block;padding: 0.25rem !important;"">
                ...
                <button type=""butt");
            WriteLiteral("on\" class=\"btn btn-primary btn-sm wd-190 float-right\" onclick=\"sdDuLieuOCR(this)\">\r\n                    <i class=\"fas fa-adjust mr-2\"></i>Sử dụng dữ liệu OCR\r\n                </button>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n\r\n");
            WriteLiteral(@"<div id=""modalChonLoaiChiPhiOCR"" class=""modal-drag"" style=""width:350px; z-index:9999999;"">
...
");
            WriteLiteral(@"<script type=""text/html"" id=""modalChonLoaiChiPhiDanhSachOCRTemplate"">
...
");
            WriteLiteral(@"<script type=""text/html"" id=""tblDanhSachHinhAnhHoSoGiayToOCR_template"">
    <% if(danh_sach.length > 0){ %>
    <% _.forEach(danh_sach, function(item,index) { %>
    <div style=""display: inline-block;width:100%;"">
        ...
        <ul class=""docs-pictures clearfix"">
            ...
            <li class=""p-1"" style=""width: 108px !important;"">
                ...
                <img onclick=""openModalXe");
            WriteLiteral(@"mHinhAnhHoaDonCTiet('<%- image.ten_file %>','<%- image.bt %>','<%- image.extension %>')"" data-original="""" location-x=""<%- image.x %>"" location-y=""<%- image.y %>"" data-ngay=""<%- image.ngay %>"" data-nsd=""<%- image.nsd%>"" data-id=""<%- image.so_id %>"" data-bt=""<%- image.bt %>"" data-ma-file=""<%- image.ma_file %>"" data-pm=""<%- image.pm %>"" data-cnhanh=""<%- image.ma_chi_nhanh %>"" src=""data:image/png;base64, <%- image.duong_dan %>"" alt=""<%- image.ten_file %>"">
                ...
                <% } else if(_.includes(["".xml""], image.ext");
            WriteLiteral(@"ension)){%>
    ...
    <%");
            WriteLiteral(" })} %>\r\n</script>\r\n");
            WriteLiteral("<script type=\"text/html\" id=\"modalCompareDataOCRGiayToTemplate\">\r\n    <%");
            BeginWriteAttribute("if(data!", " if(data!=", 17497, "", 17507, 0);
            EndWriteAttribute();
            WriteLiteral("=undefined && data!==null && data.length > 0){%>\r\n    <%_.forEach(data, function(item,index) {%>\r\n    <tr class=\"row_item\">\r\n        <%if(item.nd_so_sanh");
            BeginWriteAttribute("!", " !=", 17660, "", 17663, 0);
            EndWriteAttribute();
            WriteLiteral(@" false){%>
        <td><%- item.noi_dung %></td>
        ...
        <td class=""text-center"">
            ...
            <%if(item.benh_vien");
            BeginWriteAttribute("!", " !=", 17921, "", 17924, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.benh_vien");
            BeginWriteAttribute("!", " != \"", 17947, "\"", 17952, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.benh_vien");
            BeginWriteAttribute("!", " !=", 17971, "", 17974, 0);
            EndWriteAttribute();
        ...
        <%}%>
        <td class=""text-center""><% if(item.so_sanh) { %> <i class=""fas fa-");
            WriteLiteral(@"check text-success""></i> <%} else { %><i class=""fas fa-times text-danger""></i> <%}%></td>
...
<script type=""text/html"" id=""modalCompareDataOCRBangKeChiTietTemplate"">
    <%");
            BeginWriteAttribute("if(data!", " if(data!=", 19761, "", 19771, 0);
            EndWriteAttribute();
            WriteLiteral(@"=undefined && data!==null && data.length > 0){%>
    <%_.forEach(data, function(item,index) {%>
    <tr class=""row_item"">
...
");
            WriteLiteral("<script type=\"text/html\" id=\"modalCompareDataOCRHoaDonChiTietTemplate\">\r\n    <%");
            BeginWriteAttribute("if(data!", " if(data!=", 20536, "", 20546, 0);
            EndWriteAttribute();
            WriteLiteral(@"=undefined && data!==null && data.length > 0){%>
    <%_.forEach(data, function(item,index) {%>
    <tr class=""row_item"">
        <td class=""text-left"">
            ...
            <input class=""floating-input form-control"" type=""hidden"" data-field=""loai_chi_");
            WriteLiteral(@"phi"" value=""<%- item.loai_chi_phi %>"" />
        </td>
        ...
        <td class=""text-center"">
            <%");
            BeginWriteAttribute("if(item.thanh_tien", " if(item.thanh_tien =", 22099, "", 22120, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){%>
        ...
        <td class=""text-center"">
            ...
            <%}else{%>
            <a class=""cursor-pointer"" onclick=""capNhatLoaiChiPhi(this)"" href=""#"" data-field=""ma_chi_phi"" data-val=""<%- item.ma_chi_phi");
            WriteLiteral(@"%>"" title=""<%- item.ten_chi_phi %>""><%- ESUtil.rutGonText(50, item.ten_chi_phi) %></a>
            <%}%>
        </td>
    </tr>
    <% })}else{%>
