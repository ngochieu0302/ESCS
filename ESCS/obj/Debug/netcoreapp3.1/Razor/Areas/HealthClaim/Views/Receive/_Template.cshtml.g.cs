#pragma checksum "D:\ESCS\ESCS\Areas\HealthClaim\Views\Receive\_Template.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c910d2ffcbbf9ddd643d5ad5ae81f68c93860d66"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c910d2ffcbbf9ddd643d5ad5ae81f68c93860d66", @"/Areas/HealthClaim/Views/Receive/_Template.cshtml")]
        ...
        <div class=""border mb-2 rounded"">
            ...
            <table class=""table"" id=""HealthGuaranteeCustomer"">
                <tr>
                    ...
                    <td>
                        <%");
            BeginWriteAttribute("if(ho_so.nhom_kh_vip", " if(ho_so.nhom_kh_vip =", 2735, "", 2758, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VIP'){ %>
                        ...
                        <span class=""float-right"">
                            <a href=""#"" onclick=""chonKhachHangVip(this)"">
                                <%");
            BeginWriteAttribute("if(ho_so.nhom_kh_vip", " if(ho_so.nhom_kh_vip =", 3168, "", 3191, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'VIP'){ %>
...
");
    ...
    <% if(data.length < 5){
    for(var");
            BeginWriteAttribute("i", " i =", 15773, "", 15777, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("thu_tu_cha_con", " thu_tu_cha_con =", 16146, "", 16163, 0);
            EndWriteAttribute();
            WriteLiteral(" item.lh_nv.split(\'.\').length - 1 %>\r\n    <%");
            BeginWriteAttribute("if(thu_tu_cha_con", " if(thu_tu_cha_con =", 16207, "", 16227, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
    <tr>
        ...
        <td style=""font-");
            ...
            BeginWriteAttribute("pd", " pd =", 17375, "", 17380, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""dsGhiChuKhac_template"">
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 18998, "", 19002, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""dsDieuKhoanBoSung_template"">
    <% _.forEach(data, function(item,index) { %>
    <% var");
            BeginWriteAttribute("thu_tu_cha_con", " thu_tu_cha_con =", 19269, "", 19286, 0);
            EndWriteAttribute();
            WriteLiteral(" item.lh_nv.split(\'.\').length - 1 %>\r\n    <%");
            BeginWriteAttribute("if(thu_tu_cha_con", " if(thu_tu_cha_con =", 19330, "", 19350, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
    <tr>
        <td class=""text-left"" style=""font-weight: bold"">
    ...
    <% } else{ %>
    <% var");
            BeginWriteAttribute("pd", " pd =", 20044, "", 20049, 0);
            EndWriteAttribute();
            WriteLiteral(@" thu_tu_cha_con * 15 %>
    <tr>
    ...
    <% if(data.length < 14){
    for(var");
            BeginWriteAttribute("i", " i =", 20826, "", 20830, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 14 - data.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td style=\"height:35px;\"></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n        <td></td>\r\n    </tr>\r\n    <% }} %>\r\n</script>\r\n");
    ...
    <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 21586, "", 21601, 0);
            EndWriteAttribute();
    ...
    <tr>
        ...
        <td style=""text-align: center"">
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 25054, "", 25075, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'C'){ %>
                ...
                <% }else");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 25372, "", 25393, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'D'){ %>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 25799, "", 25817, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
                <input type=""checkbox"" disabled=""disabled"" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label""");
            BeginWriteAttribute("for", " for=\"", 26118, "\"", 26124, 0);
            EndWriteAttribute();
            WriteLiteral(">&nbsp;</label>\r\n            </div>\r\n            <% }else{ %>\r\n            <%");
            BeginWriteAttribute("if(item.hop_le", " if(item.hop_le =", 26202, "", 26219, 0);
            EndWriteAttribute();
            WriteLiteral("= 1){ %>\r\n            <div class=\"custom-control custom-checkbox custom-control-inline ml-2\" style=\"margin:unset;\">\r\n                <input type=\"checkbox\" checked=\"checked\" id=\"hop_le_<%- item.ma_hs %>\"");
            BeginWriteAttribute("value", " value=\"", 26422, "\"", 26430, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 26801, "\"", 26809, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""custom-control-input input_chon_hop_le"">
                <label class=""custom-control-label"" for=""hop_le_<%- item.ma_hs %>"">&nbsp;</label>
            </div>
        ...
        <td style=""text-align: center"">
            <%");
            BeginWriteAttribute("if(item.ngay_bs", " if(item.ngay_bs =", 27091, "", 27109, 0);
            EndWriteAttribute();
            WriteLiteral(@"= '' || item.ngay_bs == null){ %>
            ...
            <a href=""#"" data-field=""loai"" data-val=""<%- item.loai %>"" onclick=""chonLoaiHSGT(this)"" id=""loai_hsgt_<%- item.ma_hs %>"">
                <% if(item.loai");
            BeginWriteAttribute("!", " != \'", 27442, "\'", 27447, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.loai");
            BeginWriteAttribute("!", " !=", 27461, "", 27464, 0);
            EndWriteAttribute();
            WriteLiteral(" null){ %>\r\n                <%- item.loai_ten %>\r\n                <% }else{ %>\r\n                Chọn loại hồ sơ\r\n                <% } %>\r\n            </a>\r\n            <% } %>\r\n        </td>\r\n        <%");
            BeginWriteAttribute("if(item.trang_thai", " if(item.trang_thai =", 27666, "", 27687, 0);
            EndWriteAttribute();
            WriteLiteral(@"=""C"")
        {
        if(item.chon==1)
        ...
        <td style=""text-align: center"">
            ...
            BeginWriteAttribute("!", " !=", 30132, "", 30135, 0);
            EndWriteAttribute();
...
");
            ...
            BeginWriteAttribute("if(index", " if(index =", 31515, "", 31526, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 0){ %>
...
");
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 36549, "", 36553, 0);
            EndWriteAttribute();
            WriteLiteral(" 0; i < 2 - thu_huong.length;i++ ){\r\n    %>\r\n    <tr>\r\n        <td>\r\n            <div class=\"tabulator-cell\" role=\"gridcell\" tabulator-field=\"sott\"");
            BeginWriteAttribute("title", " title=\"", 36700, "\"", 36708, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width: 55px; text-align: center; height: 19px;"">&nbsp;<div class=""tabulator-col-resize-handle""></div><div class=""tabulator-col-resize-handle prev""></div></div>
        </td>
        <td></td>
...
");
    ...
    <tr class=""khoanChiItem"">
        ...
        <td class=""text-center"">
            ...
            BeginWriteAttribute("!", " !=", 38142, "", 38145, 0);
            EndWriteAttribute();
            WriteLiteral(" null &&");
            BeginWriteAttribute("item.ghi_chu!", " item.ghi_chu!=\"", 38153, "\"", 38169, 0);
            EndWriteAttribute();
            WriteLiteral(@"){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 38889, "", 38893, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 39333, "\"", 39341, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 39535, "\"", 39543, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 40355, "", 40358, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 40385, "", 40388, 0);
            EndWriteAttribute();
   ...
   ");
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 43486, "", 43489, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 43516, "", 43519, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 44739, "", 44743, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - data.length;i++ ){
    %>
    <tr>
...
");
            ...
            BeginWriteAttribute("value", " value=\"", 45205, "\"", 45213, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"don_gia\"");
            BeginWriteAttribute("value", " value=\"", 45272, "\"", 45280, 0);
            EndWriteAttribute();
            WriteLiteral(" />\r\n            <input type=\"hidden\" data-field=\"dvi_tinh\"");
            BeginWriteAttribute("value", " value=\"", 45340, "\"", 45348, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma"" value=""<%- item.ma %>"" />
            <input type=""hidden"" class=""floating-input"" data-field=""ma_ct"" value=""<%- item.ma_ct %>"" />
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 46040, "", 46043, 0);
            EndWriteAttribute();
            WriteLiteral(@" null){ %>
        ...
        <td class=""text-center"">
            <% if(item.mac_dinh");
            BeginWriteAttribute("!", " !=", 46594, "", 46597, 0);
            EndWriteAttribute();
            WriteLiteral(" undefined && item.mac_dinh");
            BeginWriteAttribute("!", " !=", 46624, "", 46627, 0);
            EndWriteAttribute();
            WriteLiteral(@" null && item.mac_dinh !=""0""){ %>
            <div class=""custom-control custom-checkbox custom-control-inline ml-2"" style=""margin:unset;"">
        ...
        <td class=""text-center""");
            ...
            BeginWriteAttribute("i", " i =", 47846, "", 47850, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 7 - data.length;i++ ){
    %>
    <tr>
...
<script type=""text/html"" id=""modalHealthSearchDsGCNTemplate"">
    ...
    <tr class=""tkiem_gcn"" data_ma_doi_tac=""<%- item.ma_doi_tac %>"" data_ma_doi_tac_ql=""<%- item.ma_doi_tac_ql %>"" data_ma_chi_nhanh=""<%- item.ma_chi_nhanh_ql %>"" data_so_id_hd_d=""<%- item.so_id_hd_d %>"" data_so_id_hd=""<%- item.so_id_hd %>"" data_so_id_gcn=""<%- item.so_id_dt %>"" data_goi_bh=""<%- item.goi_bh %>"" data_so_hd=""<%- item.so_hd %>"" data_hd_cu=""<%- item.hd_cu %>"" data_ten_ndbh=""<%- item.ten_khach %>"" data_ngay_sinh=""<%- item.ngay_sinh %>"" data_gioi_tinh=""<%- item.gioi_tinh %>"" style=""cursor: pointer"" id=""tkiem_gcn_<%- item.so_id_hd %>_<%- item.so_id_dt %>"" onclick=""onChonGCN('<%- item.so_id_hd %>','<%- item.so_id_dt %>','<%- item.gioi_tinh %>','<%- item.ngay_sinh %>");
        ...
        <td class=""text-center""><%- item.ten_dvi_cap_don %></td>");
            WriteLiteral("\n    </tr>\r\n    <%})}%>\r\n    <% if(data.length < 5){\r\n    for(var");
            BeginWriteAttribute("i", " i =", 49963, "", 49967, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < 5 - data.length;i++ ){ %>
...
");
    ...
    <tr class=""text-center lichSuTonThat"" id=""lichSuTonThat_<%- item.so_id %>_<%- item.lhnv %>"">
        ...
        <td>
            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 50682, "", 50697, 0);
            EndWriteAttribute();
            WriteLiteral("= \'HSTT\'){ %>\r\n            <a href=\"#\" onclick=\"TransReceiveDisplay(\'<%- item.ma_doi_tac%>\',\'<%- item.so_id%>\')\"><%- item.so_hs %></a>\r\n            <%}%>\r\n            <%");
            BeginWriteAttribute("if(item.loai", " if(item.loai =", 50866, "", 50881, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 'BLVP'){ %>
        ...
        <td class=""text-center"">
            <% if(item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 51783, "", 51786, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.nguyen_nhan");
            BeginWriteAttribute("!", " != \'", 51811, "\'", 51816, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.nguyen_nhan");
            BeginWriteAttribute("!", " !=", 51837, "", 51840, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
        ...
        <td class=""text-center"">
            <% if(item.ghi_chu");
            BeginWriteAttribute("!", " !=", 52443, "", 52446, 0);
            EndWriteAttribute();
            WriteLiteral(" null && item.ghi_chu");
            BeginWriteAttribute("!", " != \'", 52467, "\'", 52472, 0);
            EndWriteAttribute();
            WriteLiteral(" && item.ghi_chu");
            BeginWriteAttribute("!", " !=", 52489, "", 52492, 0);
            EndWriteAttribute();
            WriteLiteral(@" undefined){ %>
    ...
    for(var");
            BeginWriteAttribute("i", " i =", 53062, "", 53066, 0);
            EndWriteAttribute();
