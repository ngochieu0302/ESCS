...
var _service = new MotoCompensationService();
...
const MAN_HINH = 'BOI_THUONG'; //Giám định
...
var _motoClaimCommonService = new MotoClaimCommonService();
var _commonService = new CommonService();
var _motoClaimCommon = new MotoClaimCommon();
...
var _motoInvestigationService = new MotoInvestigationService();
...
var _navBoiThuong = new NavTabService("navBoiThuong", ["MotoCompensationContentStep1", "MotoCompensationContentStep2", "MotoCompensationContentStep3", "MotoCompensationContentStep4", "MotoCompensationContentStep5"], "quy-trinh");
...
var _frmTimKiem = new FormService("FrmMotoClaimSearch");
...
var _frmMotoCompensationAddInvoice = new FormService("frmMotoCompensationAddInvoice");
var _frmMotoCompensationAddBenefit = new FormService("frmMotoCompensationAddBenefit");
var _frmMotoCompensationAdvance = new FormService("frmMotoCompensationAdvance");
...
var _frmMotoClaimCompareDataGPLX = new FormService("frmMotoClaimCompareDataGPLX");
var _frmMotoClaimCompareDataDangKiem = new FormService("frmMotoClaimCompareDataDangKiem");
...
var _modalThemHMTT = new ModalFullScreenService("modalThemHMTT", "MotoCompensationContentStep2");
...
var _modalMotoCompensationAddInvoice = new ModalService("MotoCompensationAddInvoice");
var _modalMotoCompensationAddBenefit = new ModalService("MotoCompensationAddBenefit");
var _modalMotoCompensationAdvance = new ModalService("MotoCompensationAdvance");
var _modalThemHMTTPHU = new ModalService("modalThemHMTTPHU");
var _modalMap = new ModalMapService("modalMap");
var _modalMotoClaimCompareData = new ModalFullScreenService("modalMotoClaimCompareData", "MotoCompensationContentStep2");
...
var _modalXemHinhAnh = new ModalFullScreenService("modalXemHinhAnh", "MotoCompensationContentStep3");
var _modalXemHinhAnhCTiet = new ModalFullScreenService("modalXemHinhAnhCTiet", "MotoCompensationContentStep3");
var _modalMotoFlowChart = new ModalService("modalMotoFlowChart");
...
var _modalMotoClaimCompareDataGPLX = new ModalFullScreenService("modalMotoClaimCompareDataGPLX", "stepHinhAnhHoSo");
var _modalMotoClaimCompareDataDangKiem = new ModalFullScreenService("modalMotoClaimCompareDataDangKiem", "stepHinhAnhHoSo");
...
var arrNghiepVu = [
    ...
    { ma: "TN", ten: "Tiếp nhận", nv: "XE_MAY" },
    { ma: "BL", ten: "Bảo lãnh", nv: "NG" },
    { ma: "TT", ten: "Tính toán", nv: "NG" }
]

var arrNV_CT = [
    { ma: "NHAN_XET", ten: "Nhận xét của bồi thường viên", nv: "XE_MAY", pm: "BT" },
    { ma: "DE_XUAT", ten: "Đề xuất của bồi thường viên", nv: "XE_MAY", pm: "BT" },
    { ma: "TRINH_DUYET_BT", ten: "Trình phê duyệt", nv: "XE_MAY", pm: "BT" }
]
...
function showModalBoiThuong() {
    $('#MotoCompensationModal .nav-tabs.profile-tab').tabdrop();
    $("#MotoCompensationModal").esmodal("show");
}
function bindDataDienBienTonThat(res) {
    ...
    if (res.data_info.ds_vu_tt.length > 0) {
        ...
        ESUtil.genHTML("MotoCompensationContentStep1Table2_template_none", "MotoCompensationContentStep1Table2", res.data_info);
    }
    ...
    if (res.data_info.ds_lan_gd.length > 0) {
        ...
        ESUtil.genHTML("MotoCompensationContentStep1Table3_template_none", "MotoCompensationContentStep1Table3", res.data_info);
    }
    ...
    ESUtil.genHTML("tblStep1_HoSoGiayTo_template", "MotoCompensationContentStep1HoSoGiayTo", res.data_info);
    //Step 4:Hóa đơn, chứng từ
    initHoaDonChungTu(res);
    //Step 4:Người thụ hưởng
    initNguoiThuHuong(res);
    //Step 4:Hồ sơ giấy tờ
    ESUtil.genHTML("tblStep4_HoSoGiayTo_template", "MotoCompensationContentStep4HoSoGiayTo", res.data_info);
    ...
    ESUtil.genHTML("titleMotoCompensationTemplate", "MotoCompensationModalLabel", { ho_so: ho_so_chi_tiet.data_info.ho_so });
    showModalBoiThuong();
}
...
function nhapChiTietNghiepVu(nhom, loai, lh_nv, so_id_doi_tuong, callback = undefined) {
    ...
    obj.pm = CONSTANT_PM;
    _motoInvestigationService.layHangMucChiTiet(obj).then(res => {
...
function rowClick(data, row) {
    ...
    _service.layThongTinChiTietHoSo(objGetDetail).then(res => {
        showStep("MotoCompensationContentStep1");
        ...
        _frmMotoCompensationAddInvoice.getControl("so_id").setValue(data.so_id);
        _frmMotoCompensationAddBenefit.getControl("so_id").setValue(data.so_id);
        ...
        _motoClaimCommonService.LayLichSuXinYKien({ ma_doi_tac: ho_so_chi_tiet.data_info.ho_so.ma_doi_tac, nghiep_vu: 'XE' }).then(res_yk => {
        ...
        _motoClaimCommonService.danhSachCanhBao(objGetDetail).then(res1 => {
...
function resetTabs() {
    ...
    $('#MotoCompensationContentStep1').addClass("active show");
    //reset tab 1
    $('#MotoCompensationContent1Tab .nav-link').removeClass("active").first().addClass("active");

    $('.tab-pane[id^="MotoCompensationContentStep1Tab"]').removeClass("active");
    $('#MotoCompensationContentStep1Tab1').addClass("active");
    //reset tab 4
    $('#MotoCompensationContent4Tab .nav-link').removeClass("active").first().addClass("active");

    $('.tab-pane[id^="MotoCompensationContentStep4Tab"]').removeClass("active");
    $('#MotoCompensationContentStep4Tab1').addClass("active");
}
...
function chungTuTinhTien() {
    var so_tien = parseInt(_frmMotoCompensationAddInvoice.getControl("tien").getValue());
    var tl_thue = parseInt(_frmMotoCompensationAddInvoice.getControl("tl_thue").getValue());
    var thue = Math.round(so_tien * (tl_thue / 100));
    var tong_cong = so_tien + thue;
    _frmMotoCompensationAddInvoice.getControl("thue").setValue(ESUtil.formatMoney(thue));
    _frmMotoCompensationAddInvoice.getControl("tong_cong").setValue(ESUtil.formatMoney(tong_cong));
}
...
function showStep(step) {
    ...
    if (step === "MotoCompensationContentStep1") {
        $('#MotoCompensationContent1Tab .nav-link').removeClass("active").first().addClass("active");
        $('.tab-pane[id^="MotoCompensationContentStep1Tab"]').removeClass("active");
        $('#MotoCompensationContentStep1Tab1').addClass("active");
    }
    if (step === "MotoCompensationContentStep2") {
        getAnhThumnail();
    }
    if (step == "MotoCompensationContentStep3") {
        anHienTabThongTinChung(false);
    }
    if (step === "MotoCompensationContentStep4") {
...
function kiemTraStep(step) {
    if (step === "MotoCompensationContentStep2" || step === "MotoCompensationContentStep3" || step === "MotoCompensationContentStep4" || step === "MotoCompensationContentStep5") {
...
function bindEditChungTu() {
    $(".edit_chung_tu").click(function () {
        ...
        _frmMotoCompensationAddInvoice.setData(data);
        $('#MotoCompensationAddInvoice').modal("show");
    });
    $(".xoaChungTu").click(function () {
        _notifyService.confirmDelete("Bạn có chắc chắn muốn xóa chứng từ này không?", "", val => {
            ...
            json.so_id = _frmMotoCompensationAddInvoice.getControl("so_id").getValue();
...
function bindEditThuHuong() {
    $(".edit_thu_huong").click(function () {
        var data = JSON.parse($(this).closest('tr').find("input[name='objInfo']").val());
        _frmMotoCompensationAddBenefit.setData(data);
        _frmMotoCompensationAddBenefit.getControl("ma_chi_nhanh").setDataSource(objDanhMuc.chi_nhanh_ngan_hang.where(n => n.ma_ct == data.ma_ngan_hang), "ten", "ma", "Chọn chi nhánh", data.ma_chi_nhanh);
        $('#MotoCompensationAddBenefit').modal("show");
    });
    $(".xoaNguoiThuHuong").click(function () {
        _notifyService.confirmDelete("Bạn có chắc chắn muốn xóa người thụ hưởng này không?", "", val => {
            var json = JSON.parse($(this).closest('tr').find("input[name='objInfo']").val());
            json.so_id = _frmMotoCompensationAddBenefit.getControl("so_id").getValue();
...
function xoaHoSoGiayTo(ma_hs) {
    _notifyService.confirmDelete("Bạn có chắc chắn muốn xóa hồ sơ, giấy tờ này không?", "", val => {
        ...
        _motoClaimCommonService.xoaHoSoGiayTo(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
...
function layLaiDsHoSoGiayTo() {
    ...
    _motoClaimCommon.layDanhSachLoaiHsGiayTo(obj, res => {
        ho_so_chi_tiet.data_info.ho_so_giay_to = res.data_info;
        loadDanhSachHoSoGiayTo();
    });
}
function loadDanhSachHoSoGiayTo() {
    ESUtil.genHTML("tblStep1_HoSoGiayTo_template", "MotoCompensationContentStep1HoSoGiayTo", { ho_so_giay_to: ho_so_chi_tiet.data_info.ho_so_giay_to });
    ESUtil.genHTML("tblStep4_HoSoGiayTo_template", "MotoCompensationContentStep4HoSoGiayTo", { ho_so_giay_to: ho_so_chi_tiet.data_info.ho_so_giay_to });
}
...
function getAnhThumnailView(ma_file, callback = undefined) {
    var _motoInvestigationService = new MotoInvestigationService();
    _motoInvestigationService.layDanhSachFile({
        ma_doi_tac: ho_so_chi_tiet.data_info.ho_so.ma_doi_tac,
        ma_chi_nhanh: ho_so_chi_tiet.data_info.ho_so.ma_chi_nhanh,
        so_id: ho_so_chi_tiet.data_info.ho_so.so_id,
        ma_file: ma_file
...
function doiChieuGPLX(strObjOCR) {
    ...
    if (arrDT !== null && arrDT.length > 0) {
        ...
        if (doi_tuong.length == 1) {
            _frmMotoClaimCompareDataGPLX.getControl("so_id_doi_tuong").setDataSource(doi_tuong, "ten", "ma", "Chọn đối tượng tổn thất", doi_tuong[0].ma);
        } else {
            _frmMotoClaimCompareDataGPLX.getControl("so_id_doi_tuong").setDataSource(doi_tuong, "ten", "ma", "Chọn đối tượng tổn thất", "");
        }
    }
    _frmMotoClaimCompareDataGPLX.getControl("json_ocr").val(strObjOCR);
    _frmMotoClaimCompareDataGPLX.getControl("bt").val(JSON.parse(strObjOCR).bt);
    _frmMotoClaimCompareDataGPLX.getControl("vu_tt").setDataSource(arrHT, "ten", "ma", "Chọn vụ tổn thất", arrHT[0].ma);
    _frmMotoClaimCompareDataGPLX.getControl("vu_tt").trigger("select2:select");
    _modalMotoClaimCompareDataGPLX.show();
...
function doiChieuDangKiem(strObjOCR) {
    ...
    if (arrDT !== null && arrDT.length > 0) {
        ...
        if (doi_tuong.length == 1) {
            _frmMotoClaimCompareDataDangKiem.getControl("so_id_doi_tuong").setDataSource(doi_tuong, "ten", "ma", "Chọn đối tượng tổn thất", doi_tuong[0].ma);
        } else {
            _frmMotoClaimCompareDataDangKiem.getControl("so_id_doi_tuong").setDataSource(doi_tuong, "ten", "ma", "Chọn đối tượng tổn thất", "");
        }
    }
    _frmMotoClaimCompareDataDangKiem.getControl("json_ocr").val(strObjOCR);
    _frmMotoClaimCompareDataDangKiem.getControl("vu_tt").setDataSource(arrHT, "ten", "ma", "Chọn vụ tổn thất", arrHT[0].ma);
    _frmMotoClaimCompareDataDangKiem.getControl("vu_tt").trigger("select2:select");
    _modalMotoClaimCompareDataDangKiem.show();
...
function luuTamUng(callback = undefined) {
    var data = _frmMotoCompensationAdvance.getJsonData();
    if (_frmMotoCompensationAdvance.isValid()) {
        _service.luuTamUng(data).then(res => {
            ...
            loadTamUng();
            _frmMotoCompensationAdvance.getControl("so_id_tu").setValue(res.out_value.so_id_tu);
            _notifyService.success("Lưu thông tin thành công");
            if (callback) {
                callback(res);
            }
...
function xemCtietTamUng(so_id_tu) {
    ...
    _service.xemCtietTamUng(obj).then(res => {
        ...
        _frmMotoCompensationAdvance.resetForm();
        _frmMotoCompensationAdvance.clearErrorMessage();
        _frmMotoCompensationAdvance.setData(res.data_info.tam_ung);
        _frmMotoCompensationAdvance.getControl("ma_nh").trigger("select2:select");
        _frmMotoCompensationAdvance.getControl("ma_cnhanh_nh").setValue(res.data_info.tam_ung.ma_cnhanh_nh);
        _modalMotoCompensationAdvance.show();
    });
}
...
function layThongTinTienTrinh() {
    ...
    _motoClaimCommon.layDSThongTinTienTrinh(obj, res => {
...
function TransInvestigationDisplay() {
    ...
    window.open("/motoclaim/motocompensation/TransInvestigationDisplay?ma_doi_tac=" + data.ma_doi_tac + "&so_id=" + data.so_id + "&hanh_dong=" + data.hanh_dong + "&url_redirect=" + notify_url, '_self');
}
...
function capNhatUocTonThatBT(el) {
    ...
    _motoClaimCommon.showUocTonThat(obj, el);
}
function bindThongTinDonViThamGia(ma_chi_phi) {
    ...
    _motoClaimCommonService.lietKeThongTinDonVi(obj).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function getPagingChiPhiKhac(trang, callback = undefined) {
    ...
    _motoClaimCommonService.getPagingChiPhiKhac(objTimKiem).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function suaChiPhiKhac(so_id, ma_chi_phi, bt) {
    ...
    _motoClaimCommonService.getDetailChiPhiKhac(obj).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function chonPhuongAn(el) {
    if ($(el).is(":checked")) {
        ...
        objData.so_id_pa = $(el).attr("data-val");
        objData.chon = 'C';
        _service.chonPhuongAn(objData).then(res1 => {
...
function loadDuLieuFormNhanXet(el, obj) {
    _motoClaimCommonService.layDanhSachNoiDung(obj).then(res => {
...
function getPagingDanhSachNoiDung(trang, callback = undefined) {
    ...
    objTKiem.so_dong = 7;
    _motoClaimCommonService.lietKePhanTrangNoiDung(objTKiem).then(res => {
        var data = res.data_info.data;
...
function xemThongTinGiayChungNhanMotoCompensation() {
    var obj = {
        ma_doi_tac: ho_so_chi_tiet.data_info.ho_so.ma_doi_tac,
    ...
    _motoInvestigationService.layThongTinTinhTrangThanhToan(obj).then(res_tt => {
...
function xemThongTinBoiThuongVienDanhGiaHoSoBoiThuong(el) {
    ...
    _service.xemthongTinChiTietBTVDanhGiaHSBT(obj).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function luuThongTinBTVDanhGiaHoSoBoiThuong(callback = undefined) {
    ...
    if (obj != undefined && obj != null) {
        _service.luuThongTinBTVDanhGiaHSBT(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
...
function onDragHM(event, loai) {
    //Nếu là hạng mục độc lập, không cho di chuyển
    var index_drag = $(event.target).parent().parent().data("rowindex").toString();
    var bt = parseInt(index_drag) + 1;
    ...
    if (loai == "NHAN_CONG") {
        if ((item.ten_hang_muc_vtu == undefined || item.ten_hang_muc_vtu == null || item.ten_hang_muc_vtu.trim() == "") &&
            ...
            _notifyService.error("Không thể hoán đổi chi phí độc lập");
            return;
        }
    }
    if (loai == "SON") {
    ...
    event.dataTransfer.setData("index_drag", index_drag);
    event.dataTransfer.setData("loai_drag_drop", loai);
}
...
function luuTinhToanCPKhac(callback) {
    ...
    _motoClaimCommonService.luuTinhToanCPKhac(obj).then(res => {
        if (res !== undefined && res !== null && res.state_info.status === "NotOK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function loadThongTinOCRHoaDonChungTu(obj) {
    _motoClaimCommonService.soSanhThongTinOCRHoaDon(obj).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function sdOCRHoaDon(el) {
    ...
    _notifyService.confirm("Bạn có chắc chắn muốn sử dụng dữ liệu để cập nhật cho hóa đơn chứng từ ?", "", () => {
        _motoClaimCommonService.capNhatThongTinHoaDon(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
...
function openModalXemHinhAnhHoaDonCTiet(val, bt, extension) {
    if (extension == ".pdf") {
        _motoInvestigationService.layAnhChiTiet({ so_id: ho_so_chi_tiet.data_info.ho_so.so_id, bt: bt }).then(res => {
            callBackViewFile(res);
        });
    } else {
...
function layDuLieuOCRGPLX() {
    var otArr = [];
    $("#modalMotoClaimCompareDataGPLX_SoSanh tr.row_item").each(function (e) {
        var json = {};
        x = $(this).children();
        x.each(function (i) {
            $(this).find("input").each(function (el) {
...
function sdOCR(nhom, vu_tt = '') {
    ...
    var bt = '';
    if (nhom == "GPLX") {
        so_id_doi_tuong = _frmMotoClaimCompareDataGPLX.getControl("so_id_doi_tuong").val();
        vu_tt = _frmMotoClaimCompareDataGPLX.getControl("vu_tt").val();
        bt = _frmMotoClaimCompareDataGPLX.getControl("bt").val();
    }
    ...
    _notifyService.confirm("Bạn có chắc chắn muốn sử dụng dữ liệu để cập nhật cho hợp đồng và hồ sơ", "", () => {
        ...
        _motoInvestigationService.capNhatThongTinOCR(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
...
function capNhapDSGiaTuDong() {
    ...
    _motoClaimCommonService.xemGiaGoiY(obj).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function nhapThuongTat(bt, vu_tt, lh_nv, hang_muc, so_id_doi_tuong, showModal = true) {
    ...
    _motoInvestigationService.layDsThuongTat(obj).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function xoaTLThuongTat(bt, vu_tt, lh_nv, so_id_doi_tuong, ma_thuong_tat, pm) {
    _notifyService.confirm("Bạn có chắc chắn muốn xóa mức độ thương tật này không?", "", () => {
        ...
        _motoInvestigationService.xoaThuongTat(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
...
function xemVideoHs(bt) {
    ...
    _motoClaimCommonService.xemVideoHs(obj).then(res => {
        if (res.state_info.status !== "OK") {
            _notifyService.error(res.state_info.message_body);
            return;
        }
...
function onXemHangMucDGRR(hang_muc) {
    ...
    var so_id = ho_so_chi_tiet.data_info.ho_so.so_id;
    _modalSoSanhDGRR.show(ma_doi_tac, so_id, hang_muc, "XE_MAY");
}
...
$(document).bind('fscreenchange', function (e, state, elem) {
    if ($.fullscreen.isFullScreen()) {
        $('#MotoCompensationContentStep4Tab1').append($('.popover-x'));
        $('#MotoCompensationModalLabel_fullsreen').find('i').removeClass('fa-expand-arrows-alt').addClass('fa-compress-arrows-alt');
        ...
        e.preventDefault();
        $('#MotoCompensationModalLabel_fullsreen').find('i').removeClass('fa-compress-arrows-alt').addClass('fa-expand-arrows-alt');
...
$(document).ready(function () {
    ...
    $("#MotoCommonInfoMotoSearch").hide();
    $("#MotoCommonInfoCustomerInfo").hide();
    $("#MotoCommonInfoCustomerInfo1").hide();
    ...
    if (storageDonViHanhChinh === undefined || storageDonViHanhChinh === null || storageDonViHanhChinh === "null") {
        _service.base.all([
            ...
            _commonService.layControl({ nv: "XE_MAY" }),//1
            _partnerListService.layDsDoiTac(),//2
            _branchListService.layDsChiNhanh(),//3
            _businessCodeService.layDsLHNV("XE_MAY"),//4
            _categoryvehicleListService.layDsHangMucXe({ nv: "XE_MAY" }),//5
            ...
            _statusListService.layDsTrangThai({ nv: "XE_MAY" }),//10
            _motoInvestigationService.layDanhSachTyLeThuongTat(),//11
            _unitService.Tkiem({ nhom: "TSHH" }),//12
            _commonService.layTatCaDonViHanhChinh(),//13
            _carManufacturerListService.layDsHangXe({ nv: "XE_MAY" }),//14
            _hieuXeService.layDsHieuXe({ nv: "XE_MAY" }),//15
            _rangeVehicleService.layDsLoaiXe({ nv: "XE_MAY" }),//16,
            _motoClaimCommonService.lietKeDanhSachGiayToOCR({ ma_doi_tac: ESCS_MA_DOI_TAC }),//17
            ...
            objDanhMuc.hang_xe = arrRes[14].data_info.where(n => n.nv == 'XE_MAY');
            objDanhMuc.hieu_xe = arrRes[15].data_info.where(n => n.nv == 'XE_MAY');
            objDanhMuc.loai_xe = arrRes[16].data_info.where(n => n.nv == 'XE_MAY');
            ...
            _frmMotoCompensationAddInvoice.getControl("tl_thue").setDataSource(_common.danhMucChung.tl_thue, "ten", "ma", "Chọn mức tỷ lệ thuế", "");
            _frmMotoCompensationAddBenefit.getControl("ma_ngan_hang").setDataSource(objDanhMuc.ngan_hang, "ten", "ma", "Chọn ngân hàng", "");
            _frmAddChiPhiKhac.getControl("ngan_hang").setDataSource(objDanhMuc.ngan_hang, "ten", "ma", "Chọn ngân hàng", "");
            _frmMotoCompensationAdvance.getControl("ma_nh").setDataSource(objDanhMuc.ngan_hang, "ten", "ma", "Chọn ngân hàng", "");
            _frmMotoCompensationAdvance.getControl("ma_cnhanh_nh").setDataSource([], "ten", "ma", "Chọn chi nhánh", "");
            ...
            _motoClaimCommon.loadDmucLoaiHsGiayTo(objDanhMuc.hang_muc_tai_lieu);
            hienThiHoSoNofify();
            getPaging(1);
        });
    } else {
        ...
        _service.base.all([
            ...
            _unitService.Tkiem({ nhom: "TSHH" }),//12
            //_commonService.layTatCaDonViHanhChinh(),//13
            _carManufacturerListService.layDsHangXe({ nv: "XE_MAY" }),//13
            _hieuXeService.layDsHieuXe({ nv: "XE_MAY" }),//14
            _rangeVehicleService.layDsLoaiXe({ nv: "XE_MAY" }),//15
            _motoClaimCommonService.lietKeDanhSachGiayToOCR({ ma_doi_tac: ESCS_MA_DOI_TAC }), //16
            ...
            objDanhMuc.ds_tltt = chuanHoaDuLieuTreeTLTT(arrRes[11].data_info);
            objDanhMuc.dvi_tinh = arrRes[12].data_info;
            objDanhMuc.hang_xe = arrRes[13].data_info.where(n => n.nv == 'XE_MAY');
            objDanhMuc.hieu_xe = arrRes[14].data_info.where(n => n.nv == 'XE_MAY');
            objDanhMuc.loai_xe = arrRes[15].data_info.where(n => n.nv == 'XE_MAY');
    ...
    _frmMotoCompensationAddInvoice.getControl("dvi_ph").addEventChange(val => {
        var data = _frmTinhToanBoiThuong.getJsonData();
        data.loai = val;
        _service.layThongTinDoiTacChungTu(data).then(res => {
            ...
            _frmMotoCompensationAddInvoice.getControl("ten_dvi_phat_hanh").setValue(res.ten);
            _frmMotoCompensationAddInvoice.getControl("mst_dvi_phat_hanh").setValue(res.mst);
            _frmMotoCompensationAddInvoice.getControl("dchi_dvi_phat_hanh").setValue(res.dia_chi);
            _frmMotoCompensationAddInvoice.getControl("ten_dvi_nhan").setValue(res.ten_dvi_nhan);
            _frmMotoCompensationAddInvoice.getControl("dchi_dvi_nhan").setValue(res.dchi_dvi_nhan);
            _frmMotoCompensationAddInvoice.getControl("mst_dvi_nhan").setValue(res.mst_dvi_nhan);
            _frmMotoCompensationAddInvoice.getControl("mau_hdon").setValue(res.mau_hdon);
            _frmMotoCompensationAddInvoice.getControl("ky_hieu_hdon").setValue(res.ky_hieu_hdon);
            _frmMotoCompensationAddInvoice.getControl("tien").setValue(res.tien);
            _frmMotoCompensationAddInvoice.getControl("thue").setValue(ESUtil.formatMoney(res.thue));
            _frmMotoCompensationAddInvoice.getControl("tl_thue").setValue(res.tl_thue);
            _frmMotoCompensationAddInvoice.getControl("website_tra_cuu").setValue(res.website_tra_cuu);
            _frmMotoCompensationAddInvoice.getControl("ma_tra_cuu").setValue(res.ma_tra_cuu);
            _frmMotoCompensationAddInvoice.getControl("tong_cong").setValue(tong_cong);
        });

    });
    _frmMotoCompensationAddInvoice.getControl("tl_thue").addEventChange(val => {
        chungTuTinhTien();
    });
    _frmBaoGiaGara.getControl("gara").addEventChange(val => {
        layBaoGiaTuGara(val);
    });
    _frmMotoCompensationAddBenefit.getControl("dvi_th").addEventChange(val => {
        var data = {
            ma_doi_tac: ho_so_chi_tiet.data_info.ho_so.ma_doi_tac,
            so_id: ho_so_chi_tiet.data_info.ho_so.so_id,
            loai: val
        ...
        _service.layThongTinDoiTac(data).then(res => {
            ...
            _frmMotoCompensationAddBenefit.getControl("ten").setValue(resData.ten);
            _frmMotoCompensationAddBenefit.getControl("tk_cmt").setValue(resData.tai_khoan);
            _frmMotoCompensationAddBenefit.getControl("tien_chua_vat").setValue(resData.tien_chua_vat);
            _frmMotoCompensationAddBenefit.getControl("tien_thue").setValue(resData.tien_thue);
            _frmMotoCompensationAddBenefit.getControl("tien").setValue(resData.tien);
            _frmMotoCompensationAddBenefit.getControl("dien_giai").setValue(resData.dien_giai_1);
        });
    });
    _frmMotoCompensationAddBenefit.getControl("ma_ngan_hang").addEventChange(val => {
        _frmMotoCompensationAddBenefit.getControl("ma_chi_nhanh").setDataSource(objDanhMuc.chi_nhanh_ngan_hang.where(n => n.ma_ct == val), "ten", "ma", "Chọn chi nhánh", "");
    });
    _frmMotoCompensationAdvance.getControl("ma_nh").addEventChange(val => {
        _frmMotoCompensationAdvance.getControl("ma_cnhanh_nh").setDataSource(objDanhMuc.chi_nhanh_ngan_hang.where(n => n.ma_ct == val), "ten", "ma", "Chọn chi nhánh", "");
    });
    ...
    _frmMotoCompensationAddBenefit.getControl("tien_chua_vat").change(function () {
        var tien_chua_vat = parseFloat(_frmMotoCompensationAddBenefit.getControl("tien_chua_vat").val().replace(/[^0-9]+/g, ''));
        var tien_thue = parseFloat(_frmMotoCompensationAddBenefit.getControl("tien_thue").val().replace(/[^0-9]+/g, ''));
        ...
        _frmMotoCompensationAddBenefit.getControl("tien").setValue(ESUtil.formatMoney(tien));
    });
    _frmMotoCompensationAddBenefit.getControl("tien_thue").change(function () {
        var tien_chua_vat = parseFloat(_frmMotoCompensationAddBenefit.getControl("tien_chua_vat").val().replace(/[^0-9]+/g, ''));
        var tien_thue = parseFloat(_frmMotoCompensationAddBenefit.getControl("tien_thue").val().replace(/[^0-9]+/g, ''));
        if (tien_chua_vat == undefined || tien_chua_vat == null || tien_chua_vat == "") {
            tien_chua_vat = 0;
    ...
    _frmMotoClaimCompareDataGPLX.getControl("vu_tt").addEventChange(val => {
        var vu_tt_model = ho_so_chi_tiet.data_info.ds_vu_tt.where(n => n.ma == val).firstOrDefault();
        var json_ocr = JSON.parse(_frmMotoClaimCompareDataGPLX.getControl("json_ocr").val());
        var arr = [];
        var ho_ten = {
            ma_nd: "HO_TEN",
        ...
        ESUtil.genHTML("modalMotoClaimCompareDataGPLX_SoSanh_Template", "modalMotoClaimCompareDataGPLX_SoSanh", { data: arr });
    });
    ...
    $("#vu_tt").change(function () {
        ...
        ESUtil.genHTML("MotoCompensationContentStep1Table2_template", "MotoCompensationContentStep1Table2", val[0]);
    });
    $("#lan_gd").change(function () {
        var maLanGiamDinh = $(this).val();
        var json = ho_so_chi_tiet.data_info;
        var val = json.ds_lan_gd.where(n => n.ma == maLanGiamDinh);
        ESUtil.genHTML("MotoCompensationContentStep1Table3_template", "MotoCompensationContentStep1Table3", val[0]);
        //lấy danh sách người tham gia giám định
        var data = {
            "arrNguoiGiamDinh": json.ds_nguoi_tham_gia.where(n => n.lan_gd == maLanGiamDinh)
        };
        ESUtil.genHTML("MotoCompensationContentStep1Table4_template", "MotoCompensationContentStep1Table4", data);
    });
    ...
    $('#MotoCompensationEbill').on('show.bs.modal', function (e) {
        loadGaraBaoGia(resCT => {
            $("#garaBaoGia tr td.layBaoGiaCT")[0].click();
        });
    });
    $('#btnMotoCompensationContentStep4_save').click(function () {
        $(".inputSearchHangMucTinhToan").val("");
    ...
    $('#btnMotoCompensationContentStep4_luuVaTrinh').click(function () {
        $(".inputSearchHangMucTinhToan").val("");
        $(".inputSearchHangMucTinhToan").trigger("keyup");
        luuTinhToanBoiThuong(res => {
            _notifyService.success("Lưu tính toán bồi thường thành công");
            $('#btnMotoCompensationContentStep4_FwdApproval').trigger('click');
        });
    });
    ...
    $('#MotoCompensationModalLabel_fullsreen').on('click', function () {
        if ($.fullscreen.isFullScreen()) {
            $.fullscreen.exit();
        } else {
            $('#MotoCompensationContentStep4Tab1 select.select2').select2({
                dropdownParent: $('#MotoCompensationContentStep4Tab1')
            });
            $('#MotoCompensationContentStep4Tab1').fullscreen();
        }
    });
    $("#frmMotoCompensationAddInvoice input[name='tien']").change(function () {
        chungTuTinhTien();
    });
    $("#frmMotoCompensationAddInvoice input[name='thue']").change(function () {
        var so_tien = parseInt(_frmMotoCompensationAddInvoice.getControl("tien").getValue());
        var thue = parseInt(_frmMotoCompensationAddInvoice.getControl("thue").getValue());
        var tong_cong = so_tien + thue;
        _frmMotoCompensationAddInvoice.getControl("tong_cong").setValue(ESUtil.formatMoney(tong_cong));
    });
    $("#btnMotoCompensationAddInvoice_save").click(function () {
        var data = _frmMotoCompensationAddInvoice.getJsonData();
        if (_frmMotoCompensationAddInvoice.isValid()) {
            _service.nhapChungTuBoiThuong(data).then(res => {
                ...
                loadChungTuThuHuong();
                _frmMotoCompensationAddInvoice.getControl("bt").setValue(res.out_value.bt);
                _notifyService.success("Lưu chứng từ thành công");
            });
        }
    });
    $("#btnMotoCompensationAddInvoice_save_close").click(function () {
        var data = _frmMotoCompensationAddInvoice.getJsonData();
        if (_frmMotoCompensationAddInvoice.isValid()) {
            _service.nhapChungTuBoiThuong(data).then(res => {
                if (res.state_info.status !== "OK") {
                ...
                loadChungTuThuHuong();
                $("#MotoCompensationAddInvoice").modal("hide");
                _notifyService.success("Lưu chứng từ thành công");
            });
        }
    });
    $("#btnMotoCompensationAddBenefit_save").click(function () {
        var data = _frmMotoCompensationAddBenefit.getJsonData();
        if (_frmMotoCompensationAddBenefit.isValid()) {
            data.loai = "TH";
            _service.nhapThongTinNguoiThuHuong(data).then(res => {
                ...
                loadChungTuThuHuong();
                _frmMotoCompensationAddBenefit.getControl("bt").setValue(res.out_value.bt);
                _notifyService.success("Lưu thông tin thụ hưởng thành công");
            });
        }
    });
    $("#btnMotoCompensationAddBenefit_save_close").click(function () {
        var data = _frmMotoCompensationAddBenefit.getJsonData();
        if (_frmMotoCompensationAddBenefit.isValid()) {
            data.loai = "TH";
            _service.nhapThongTinNguoiThuHuong(data).then(res => {
                ...
                loadChungTuThuHuong();
                $("#MotoCompensationAddBenefit").modal("hide");
                _frmMotoCompensationAddBenefit.getControl("bt").setValue(res.out_value.bt);
                _notifyService.success("Lưu thông tin thụ hưởng thành công");
            });
        }
    });
    $("#btnMotoCompensationAdvance_save").click(function () {
        luuTamUng();
    });
    $("#btnMotoCompensationAdvance_save_close").click(function () {
        luuTamUng(res => {
            _modalMotoCompensationAdvance.hide();
        });
    });
    $("#btnMotoCompensationContentStep3_FwdApproval_1, #btnTrinhPAVCX").click(function () {
        var obj = {
            ...
            so_id: _frmTinhToanBoiThuong.getControl("so_id").getValue(),
            loai_trinh: "XE_MAY_TRINH_DUYET_DUYET_GIA",
            nghiep_vu: "XE_MAY",
            pm: CONSTANT_PM,
            remove_file: "ESCS_TO_TRINH_PHUONG_AN_SUA_CHUA_XE_MOTO",
            create_file: "ESCS_TO_TRINH_PHUONG_AN_SUA_CHUA_XE_MOTO",
        }
    ...
    $("#btnMotoCompensationContentStep4_Guarantee").click(function () {
        var obj = {
            ma_doi_tac: _frmTinhToanBoiThuong.getControl("ma_doi_tac").getValue(),
            ma_doi_tac_ql: ho_so_chi_tiet.data_info.ho_so.ma_doi_tac_ql,
            so_id: _frmTinhToanBoiThuong.getControl("so_id").getValue(),
            loai_trinh: "XE_MAY_TRINH_DUYET_BAO_LANH",
            nghiep_vu: "XE_MAY",
            ma_mau_in: "ESCS_TO_TRINH_BAO_LANH_XE_MOTO",
            pm: CONSTANT_PM
        }
        obj.ma = "TEMPLATE_EMAIL_TRINH_BAO_LANH";
        _modalTrinhDuyetService.show(obj);
    });
    $("#btnMotoCompensationContentStep4_FwdApproval").click(function () {
        ...
        var obj = {
            ...
            ma_doi_tac_ql: ho_so_chi_tiet.data_info.ho_so.ma_doi_tac_ql,
            so_id: _frmTinhToanBoiThuong.getControl("so_id").getValue(),
            loai_trinh: "XE_MAY_TRINH_DUYET_BOI_THUONG",
            nghiep_vu: "XE_MAY",
            remove_file: "ESCS_TO_TRINH_BOI_THUONG_XE_MOTO",
            create_file: "ESCS_TO_TRINH_BOI_THUONG_XE_MOTO",
    ...
    $("#btnLuuAddHoSoGiayTo").click(function () {
        _motoClaimCommon.luuBoSungHoSoGiayTo(ho_so_chi_tiet.data_info.ho_so.so_id, CONSTANT_PM, res => {
            layLaiDsHoSoGiayTo();
        });
    });
    ...
    $('#btnMotoCompensationContentStep3_print, #btnMotoCompensationContentStep4_print').bind("click", function () {
        var sourceMauIn = [
            { ma: "ESCS_TO_TRINH_PHUONG_AN_SUA_CHUA_XE_MOTO", ten: "Tờ trình phương án sửa chữa" },
            { ma: "ESCS_TB_DUYET_PHUONG_AN_XE_MOTO", ten: "Thông báo duyệt phương án" },
            { ma: "ESCS_TO_TRINH_BOI_THUONG_XE_MOTO", ten: "Tờ trình bồi thường" },
            { ma: "ESCS_THONG_BAO_DUYET_BAO_LANH_XE_MOTO", ten: "Thông báo duyệt bảo lãnh" },
            { ma: "ESCS_THONG_BAO_BOI_THUONG_XE_MOTO", ten: "Thông báo bồi thường" },
            { ma: "ESCS_GIAY_DE_NGHI_CHUYEN_TIEN", ten: "Giấy đề nghị chuyển tiền" },
            { ma: "ESCS_TO_TRINH_TU_CHOI_BT_XE_MOTO", ten: "Tờ trình từ chối bồi thường" },
            { ma: "ESCS_TB_TU_CHOI_TB_XE_MOTO", ten: "Thông báo từ chối bồi thường" }
        ];
        ...
        _modalDocumentService.show("ESCS_TO_TRINH_PHUONG_AN_SUA_CHUA_XE_MOTO");
    });
    ...
    $("#btnMotoCompensationQuotation").click(function () {
        $("#inputTimKiemHangMucBaoGia").val("");
        ...
        loadGaraBaoGia(res => {
            ...
            $("#MotoCompensationQuotation").modal("show");
        });
    });
    ...
    $("#btnThemHoaDonChungTu").click(function () {
        _frmMotoCompensationAddInvoice.resetForm();
        _frmMotoCompensationAddInvoice.clearErrorMessage();
        _frmMotoCompensationAddInvoice.getControl("so_id").val(ho_so_chi_tiet.data_info.ho_so.so_id);
        _modalMotoCompensationAddInvoice.show();
    });
    $("#btnThemNguoiThuHuong").click(function () {
        _frmMotoCompensationAddBenefit.resetForm();
        _frmMotoCompensationAddBenefit.clearErrorMessage();
        _frmMotoCompensationAddBenefit.getControl("so_id").val(ho_so_chi_tiet.data_info.ho_so.so_id);
        _frmMotoCompensationAddBenefit.getControl("ma_chi_nhanh").setDataSource([], "ten", "ma", "Chọn chi nhánh", "");
        _modalMotoCompensationAddBenefit.show();
    });
    $("#btnThemTamUng").click(function () {
        ...
        _frmMotoCompensationAdvance.resetForm();
        _frmMotoCompensationAdvance.clearErrorMessage();
        _frmMotoCompensationAdvance.getControl("so_id").val(ho_so_chi_tiet.data_info.ho_so.so_id);
        _frmMotoCompensationAdvance.getControl("ma_chi_nhanh").setDataSource([], "ten", "ma", "Chọn chi nhánh", "");
        _frmMotoCompensationAdvance.getControl("ngay_yc").setValue(dateNow);
        _modalMotoCompensationAdvance.show();
    });
    ...
    $("#btnSoSanhDuLieu").click(function () {
        ...
        var _motoInvestigationService = new MotoInvestigationService();
        _motoInvestigationService.soSanhDuLieuOCR(obj).then(res => {
            ESUtil.genHTML("modalMotoClaimCompareDataTable_Template", "modalMotoClaimCompareDataTable", { data: res.data_info });
            ESUtil.genHTML("modalMotoClaimCompareData_GPLX_Template", "modalMotoClaimCompareData_GPLX", res.data_info);
            _modalMotoClaimCompareData.show();
        });
    });
    $("#btnLuuYeuCauBsGiayTo").click(function () {
        ...
        $("#MotoCompensationContentStep4HoSoGiayTo input.input_chon_hsgt_bs:checked").each(function (el) {
            var ma_hs = $(this).val();
        ...
        $("#MotoCompensationContentStep4HoSoGiayTo a[data-field=trang_thai][data-val=D]").each(function (el) {
        ...
        $("#MotoCompensationContentStep4HoSoGiayTo input.input_chon_gara_thu_ho:checked").each(function (el) {
            var ma_hs = $(this).closest('tr').find('input.input_chon_hsgt_bs').val();
            var ten = $(this).closest('tr').find('a[data-field=ten]').attr('data-val');
            var so_id_doi_tuong = $(this).closest('tr').find('a[data-field=so_id_doi_tuong]').attr('data-val');
            var loai = $(this).closest('tr').find('a[data-field=loai]').attr('data-val');
        ...
        _motoClaimCommonService.luuBsHoSoGiayToBoSung(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
        ...
        if (_frmDocHoaDonDT.isValid()) {
            ...
            _commonService.docHoaDon(formData).then(res => {
                if (res != undefined) {
                    ...
                    _frmMotoCompensationAddInvoice.getControl('dvi_ph').setValue(obj.dvi_phat_hanh);
                    _frmMotoCompensationAddInvoice.setData(obj);
                }
            });
        }
    });
    ...
    $('#btnAnhHopDong').click(function () {
        if ($(this).find('i.fas').hasClass('fa-file-contract')) {
            ...
            getAnhThumnailHopDong(() => {
                $(this).find('i.fas').removeClass('fa-file-contract').addClass('fa-motorcycle');
                $(this).find('i.fas').attr('title', 'Click để xem ảnh bồi thường xe');
            });
        } else if ($(this).find('i.fas').hasClass('fa-motorcycle')) {
            $("a.btnXemVideo").removeClass("d-none");
            $("a.btnXemVideoDGRRHD").removeClass("d-none");
            $("a.btnXemVideoDGRRHD").addClass("d-none");
            getAnhThumnail(() => {
                $(this).find('i.fas').removeClass('fa-motorcycle').addClass('fa-file-contract');
    ...
    $("#btnXemTienTrinhGiaiQuyet").click(function () {
        ...
        _motoClaimCommonService.xemThongTinSLA(obj).then(res => {
            if (res !== undefined && res !== null && res.state_info.status === "NotOK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
    ...
    $('#btnMotoCompensationAdvance_processing').click(function () {
        var obj = {
            ma_doi_tac: ho_so_chi_tiet.data_info.ho_so.ma_doi_tac,
            so_id: _frmMotoCompensationAdvance.getControl('so_id_tu').getValue(),
            so_id_hd: ho_so_chi_tiet.data_info.ho_so.so_id_hd,
            so_id_dt: ho_so_chi_tiet.data_info.ho_so.so_id_dt
        }
        _service.danhSachQuaTrinhXuLy(obj).then(res => {
            ...
            _service.ketThucBaoGia(obj).then(res => {
                ...
                _service.layThongTinChiTietHoSo(objGetDetail).then(resDetail => {
                    ...
                    if (type == "KET_THUC_BG_LAP_PA") {
                        $("#MotoCompensationQuotation").modal("hide");
    ...
    $("#btnLuuAddChiPhiKhac").click(function () {
        if (_frmAddChiPhiKhac.isValid()) {
            ...
            obj.pm = "BT";
            _motoClaimCommonService.luuThongTinChiPhiKhac(obj).then(res => {
                if (res.state_info.status !== "OK") {
                    _notifyService.error(res.state_info.message_body);
                    return;
                }
    ...
    $("#btnXoaAddChiPhiKhac").click(function () {
        ...
        _notifyService.confirmDelete("Bạn có chắc muốn xóa thông tin chi phí này không?", "", val => {
            _motoClaimCommonService.xoaThongTinChiPhiKhac(obj).then(res => {
                if (res.state_info.status === "OK") {
                    _notifyService.success("Xóa thông tin thành công");
                    getPagingChiPhiKhac(1, res => {
                        tinhTongTienHoSoChiPhiKhac(res.data_info.data);
    ...
    $("#btnLuuNoiDung").click(function () {
        if (_frmTaoNoiDung.isValid()) {
            ...
            _motoClaimCommonService.taoNhanXet(formData).then(res => {
                if (res.state_info.status === "OK") {
                    _notifyService.success("Lưu thông tin thành công.");
    ...
    $("#btnXoaNoiDung").click(function () {
        ...
        _notifyService.confirmDelete("Bạn có chắc muốn xóa thông tin này không?", "", val => {
            _motoClaimCommonService.xoaThongTinNoiDung(formData).then(res => {
                if (res.state_info.status === "OK") {
                    _notifyService.success("Xóa thông tin thành công");
                    getPagingDanhSachNoiDung(1);
                    $("#modalTaoNoiDungFormLietKe").removeClass("d-none");
    ...
    $("#btnLuuGCN").click(function () {
        ...
        if (_frmSuaGCN_BT.isValid()) {
            ...
            _motoClaimCommonService.suaGCN(objData).then(res => {
                if (res.state_info.status === "OK") {
                    _notifyService.success("Lưu thông tin thành công.");
                    _modalSuaGCN.hide();
                }
    ...
    $("#btnThemNoiDungTraoDoiXeOTo").click(function () {
        if (_frmNoiDungTraoDoiXeOTo.isValid()) {
            ...
            _motoClaimCommonService.nhapNoiDungTraoDoi(obj).then(res => {
                if (res.state_info.status !== "OK") {
                    _notifyService.error(res.state_info.message_body);
                    return;
                }
    ...
    $("#btnThemVaDongCanBoTraoDoiXeOTo").click(function () {
        if (_frmThemCanBoTraoDoiXeOTo.isValid()) {
            ...
            _motoClaimCommonService.themCanBoTraoDoi(formData).then(res => {
                if (res.state_info.status === "OK") {
    ...
    $("#btnTinhToanCPKhac").click(function () {
        ...
        _motoClaimCommonService.chiPhiKhacHS(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
    ...
    $("#btnDocOCRBaoGia").click(function () {
        ...
        _motoClaimCommonService.docOCRBaoGia(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
    ...
    $("#btnDocOCRHoaDonChungTu").click(function () {
        ...
        _motoClaimCommonService.docOCR(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
    ...
    $("#btnChapNhanTachNghiepVu").click(function () {
        ...
        _notifyService.confirm("Bạn có chắc chắn muốn tách nghiệp vụ hồ sơ này không?", "", val => {
            ...
            _service.tachNghiepVuHs(data).then(res => {
                ...
                window.open("/motoclaim/motoinvestigation/TransCompensationDisplay?ma_doi_tac=" + data.ma_doi_tac + "&so_id=" + data.so_id + "&hanh_dong=" + data.hanh_dong + "&url_redirect=" + notify_url, '_self');
            });
        });
    });
    //Tự động giá đề xuất
    ...
    $("#btnLuuTLThuongTat").click(function () {
        ...
        _motoInvestigationService.nhapThuongTat(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
    ...
    $("a.btnXemVideo").click(function () {
        ...
        _motoClaimCommonService.getListVideo(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
    ...
    $("#inputModalVideoUpload").on("change", function (e) {
        ...
        formData.append("ma_doi_tac", ho_so_chi_tiet.data_info.ho_so.ma_doi_tac);
        formData.append("so_id", ho_so_chi_tiet.data_info.ho_so.so_id);
        _motoClaimCommonService.uploadVideo(formData).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
    ...
    $("#luuNhapTenFile").click(function () {
        ...
        _motoClaimCommonService.suaTenVideo(obj).then(res => {
            if (res.state_info.status !== "OK") {
                _notifyService.error(res.state_info.message_body);
                return;
            }
