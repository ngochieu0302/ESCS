...
namespace ESCS.Areas.MotoClaim.Controllers
{
    [Area("MotoClaim")]
    [SystemAuthen]
    public class MotoClaimCommonController : BaseController
    {
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_HO_SO_GIAY_TO_LUU, json, "/api/motoclaim/document");
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_CHI_PHI_KHAC_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_CHI_PHI_KHAC_LKE_CT, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_CHI_PHI_KHAC_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_CHI_PHI_KHAC_HS_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_CHI_PHI_KHAC_HS_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_CHI_PHI_KHAC_X, json);
            return Ok(data);
        }
        /// <summary>
        /// Lưu ước tổn thất
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_UOC_TON_THAT_NH, json);
            return Ok(data);
        }
        ///DÙNG CHUNG
        /// <summary>
        ...
        public async Task<IActionResult> xemVideoHs()
        {
            ...
            if (data != null && data.data_info != null && data.data_info.bt != null && data.data_info.bt != 0)
            {
                ...
                data.data_info.duong_dan = "/motoclaim/motoclaimcommon/video?hashVideo=" + hashVideo;
            }
            return Ok(data);
        }
