...
namespace ESCS.Areas.MotoClaim.Controllers
{
    [Area("MotoClaim")]
    [SystemAuthen]
    public class MotoCompensationController : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        public MotoCompensationController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> paging()
        {
            ...
            var data = await Request.GetRespone(StoredProcedure.PBH_BT_XE_MAY_HS_LKE, (object)rq);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var rq = Request.GetDataRequest(GetUser());
            var data = await Request.GetRespone(StoredProcedure.PBH_BT_XE_MAY_HS_LKE_CT, (object)rq);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NHAN_HS, json);
            return Ok(data);
        }
        /// <summary>
        /// tra nhận hồ sơ 
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_CHUYEN_BT_HUY, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_PHAN_HANG_PHU_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_PHAN_HANG_PHU_XOA, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_LKE, json);
            return Ok(data);
        }
        /// <summary>
        /// Thêm gara báo giá
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_THEM, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_LKE_CT, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_NH, json);
            return Ok(data);
        }
        ...
        public async Task<IActionResult> duyetGaraBaoGiaCT()
        {
            ...
            BaseResponse<object, out_value_phe_duyet> data = await Request.GetResponeNew<object, out_value_phe_duyet>(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_DUYET, json);
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew<object, out_value_phe_duyet>(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_DUYET_XOA, json);
            if (data != null && data.state_info != null && data.state_info.status == STATUS_OK)
            {
                var defineInfo = Request.GetDefineInfo();
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_TINH_TOAN, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_NV_TINH_TOAN, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BANG_TINH_TOAN_PA_CTIET, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_CHUNG_TU_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_CHUNG_TU_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_CHUNG_TU_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_THONG_TIN_DOI_TAC_XE_MAY, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_THONG_TIN_DOI_TAC_CHUNG_TU_XE_MAY, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_THU_HUONG_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_THU_HUONG_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_CHON, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_THU_HOI_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_THU_HOI_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_THU_HOI_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_THU_DOI_NTBA_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_THU_DOI_NTBA_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_THU_DOI_NTBA_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_DKBS_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_GIAM_TRU_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_DKBS_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Lưu NNGT theo hạng mục
        /// </summary>
        /// <returns></returns>
        [AjaxOnly]
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_NNGT_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Lưu ghi chú
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_GHI_CHU_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_TAM_UNG_LKE, json);
            return Ok(data);
        }
        /// <summary>
        /// Lấy danh sách tạm ứng của hồ sơ
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_TAM_UNG_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Xóa tạm ứng
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_TAM_UNG_XOA, json);
            return Ok(data);
        }
        /// <summary>
        /// Xóa tạm ứng
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_TAM_UNG_LKE_CT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_GARA_LKE_CT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_CT_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_CT_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_TKIEM, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PHAN_HANG_MUC, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_TON_THAT_TOAN_BO, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_TON_THAT_TOAN_BO_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_NV_CT_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_X, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_CHON, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_BO_CHON, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_NV_TONG_HOP_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_GIA_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_GIA_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_KTRU_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_CT_KTRU_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_GIA_KTRU_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_CT_GIA_KTRU_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_KT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_HUY_KT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_CT_GIA_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_CT_GIA_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BANG_TINH_TOAN_CTIET, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_LKE_CT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_CHUYEN_THANH_TOAN, json, "/api/motoclaim/transfer-payment");
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_HUY_CHUYEN_THANH_TOAN, json, "/api/motoclaim/un-transfer-payment");
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_THUE_LKE, json);
            return Ok(data);
        }
        /// <summary>
        /// Luu thông tin thuế
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_NV_THUE_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_CT_THUE_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_CT_THUE_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_DANH_GIA_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_DANH_GIA_BTV_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Luu thông tin BTV DANH GIA HSBT
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_DANH_GIA_BTV_LKE_CT, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_DANH_GIA_LKE_CT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_HUY, json, "/api/motoclaim/destroy");
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_GO_HUY, json, "/api/motoclaim/undestroy");
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_BAO_GIA_SO_SANH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_LHNV_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_PA_BANG_VIEW, json);
            return Ok(data);
        }
    }
}