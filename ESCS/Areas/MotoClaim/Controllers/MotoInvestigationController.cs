...
namespace ESCS.Areas.MotoClaim.Controllers
{
    ...
    [Area("MotoClaim")]
    [SystemAuthen]
    public class MotoInvestigationController : BaseController
    {
        private TemplateServiceConfiguration config;
        public static IRazorEngineService _service = null;
        private readonly IWebHostEnvironment _env;
        public MotoInvestigationController(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_LKE_CT, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_LKE_CT_RELOAD, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NOTIFY_LKE_CT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NHAN_HS, json);
            return Ok(data);
        }
        /// [DÙNG -CHUNG] - ĐÃ XỬ LÝ 
        /// <summary>
        ...
        /// <returns></returns>
        [AjaxOnly]
        public async Task<IActionResult> GetPagingSearchMoto()
        {
            var json = Request.GetDataRequestNew(GetUser());
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NH, json, "api/motoclaim/receive");
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_TT_KH_UPDATE, json);
            return Ok(data);
        }
        /// ĐÃ XỬ LÝ
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_VU_TT_NH, json);
            return Ok(data);
        }
        /// ĐÃ XỬ LÝ
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_VU_TT_XOA, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_LAN_GD_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_NGUOI_LIEN_QUAN_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_NGUOI_LIEN_QUAN_XOA, json);
            return Ok(data);
        }
        /// <summary>
        /// Xóa lần giám định
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_LAN_GD_XOA, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_CHUYEN_XL, json);
            return Ok(data);
        }
        /// <summary>
        /// Hủy hồ sơ
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_HUY, json, "/api/motoclaim/destroy");
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_GO_HUY, json, "/api/motoclaim/undestroy");
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_GDTT_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_BD_GD, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_KT_GD, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew<int?, out_value_phe_duyet>(StoredProcedure.PBH_BT_XE_MAY_GD_DUYET_BCGD, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew<int?, out_value_phe_duyet>(StoredProcedure.PBH_BT_XE_MAY_GD_DUYET_GD, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew<int?, out_value_phe_duyet>(StoredProcedure.PBH_BT_XE_MAY_GD_HUY_DUYET_BCGD, json);
            return Ok(data);
        }
        /// <summary>
        /// Hủy duyệt
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew<int?, out_value_phe_duyet>(StoredProcedure.PBH_BT_XE_MAY_GD_HUY_DUYET_GD, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_KT_GD_HUY, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew<int?, out_value_phe_duyet>(StoredProcedure.PBH_BT_XE_MAY_GD_CHUYEN_BT, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_PHAN_HANG_MUC, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_HANG_MUC_SUA, json);
            var defineInfo = Request.GetDefineInfo();
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_HANG_MUC_XOA, json);
            return Ok(data);
        }
        /// <summary>
        /// Download zip file
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_LKE, json);
            return Ok(data);
        }
        //ĐÃ XỬ LÝ
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_VU_TT_UPDATE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_GDVHT_LKE, json);
            return Ok(data);
        }
        /// <summary>
        /// Lấy chi phí tự động
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_CT_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_TNDS_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Nhập chi tiết hạng mục TNDS
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_LAN_GD_KTHUC, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_LAN_GD_HUY_KTHUC, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_KTRA_XU_LY, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_DGHT_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Lưu thông tin đánh giá hiện trường
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_DGHT_LKE_CT, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_CT_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Chuyển hướng trang
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_DOI_TUONG_TON_THAT_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_DOI_TUONG_TON_THAT_NH, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_DOI_TUONG_TON_THAT_XOA, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_LAN_GD_CHI_PHI_LKE, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_LAN_GD_CHI_PHI_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Lưu thông tin chi phí lần giám định
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_LAN_GD_CHI_PHI_XOA, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_BCGD_LKE_CT, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_BCGD_NH, json);
            return Ok(data);
        }
        // ĐÃ LÀM
        /// <summary>
        ...
        public async Task<IActionResult> laySoHoSo()
        {
            ...
            {
                var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_CAP_NHAT_SO_HS, json, "/api/motoclaim/get-number-claim");
                return Ok(data);
            }
            return Ok(await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_CAP_NHAT_SO_HS, json));
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_THUONG_TAT_LKE, json);
            return Ok(data);
        }
        /// <summary>
        /// Nhập thương tật
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_THUONG_TAT_NH, json);
            return Ok(data);
        }
        /// <summary>
        /// Xóa thương tật
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_THUONG_TAT_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_BAO_GIA_THEM, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_BAO_GIA_XOA, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_PA_CHON, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_BAO_GIA_LKE, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_BAO_GIA_LKE_CT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_BAO_GIA_NH, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_BAO_GIA_KT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_HS_MOBILE_BAO_GIA_HUY_KT, json);
            return Ok(data);
        }
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_HS_XE_MAY_GD_LHNV, json);
            return Ok(data);
        }
        /// <summary>
        ...
        {
            var json = Request.GetDataRequestNew(GetUser());
            var data = await Request.GetResponeNew(StoredProcedure.PBH_BT_XE_MAY_GD_NV_DGTT_LKE_CT, json);
            return Ok(data);
        }
    }
}
