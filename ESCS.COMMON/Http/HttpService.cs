...
namespace ESCS.COMMON.Http
{
    public interface IHttpService
    {
        ...
        Task<HttpResponseMessage> PostFormDataAsync(string action, string accessToken, object model, DefineInfo defineInfo = null, IFormFileCollection files = null, string url = "/api/esmartclaim/upload-file");
    ...
    public class HttpService : IHttpService
    {
        ...
        public async Task<HttpResponseMessage> PostFormDataAsync(string action, string accessToken, object model, DefineInfo defineInfo = null, IFormFileCollection files = null, string url = "/api/esmartclaim/upload-file")
        {
            BaseRequestEscs rqBase = new BaseRequestEscs(model);
            rqBase.define_info = defineInfo;
            service.DefaultRequestHeaders.Add("eAuthToken", accessToken);
